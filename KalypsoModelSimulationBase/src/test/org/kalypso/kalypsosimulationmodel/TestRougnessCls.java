...
public class TestRougnessCls extends TestCase
{
  public void testWorkspaceLoad( )
  {
    ...
    try
    {
      workspace = GmlSerializer.createGMLWorkspace( TestWorkspaces.URL_ROUGHNESS_CLS, null );
    }
    catch( Throwable th )
    {
    ...
    RoughnessCls roughnessCls = (RoughnessCls) rFeature;
    /*
  ...
  public void testCreation( )
  {
    ...
    try
    {
      ...
      RoughnessCls r = (RoughnessCls) root;
