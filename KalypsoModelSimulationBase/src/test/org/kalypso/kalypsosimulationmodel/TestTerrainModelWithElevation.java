 ...
 * 
 */
public class TestTerrainModelWithElevation extends TestCase
{
  public void testWorkspaceLoad( )
  {
    ...
    try
    {
      workspace = GmlSerializer.createGMLWorkspace( TestWorkspaces.URL_TEM_EMPTY_TER_MODEL, null );
