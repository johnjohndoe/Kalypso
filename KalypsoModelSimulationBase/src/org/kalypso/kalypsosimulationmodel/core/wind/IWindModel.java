 ...
 * @author ig
 */
public interface IWindModel extends IModel
{
  public final static QName QNAME_WIND_MODEL = new QName( UrlCatalogModelSimulationBase.SIM_MODEL_NS, "WindModel" ); //$NON-NLS-1$
