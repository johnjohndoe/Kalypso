...
{
  public WindModel( final Object parent, final IRelationType parentRelation, final IFeatureType ft, final String id, final Object[] propValues )
  {
    super( parent, parentRelation, ft, id, propValues );
  }

  private final IFeatureBindingCollection<IWindDataModelSystem> m_windSystems = new FeatureBindingCollection<>( this, IWindDataModelSystem.class, KalypsoModelSimulationBaseConsts.SIM_BASE_PROP_WIND_ELE_SYS );
