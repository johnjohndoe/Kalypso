 ...
 *
 */
public interface IWindDataWrapper
{
  /**
   * @return the {@link URL} pointing to the file representing actual grid
   */
  public URL getDataFileURL();
  
  /**
   * @return {@link java.util.Date} the date of this wind step
   */
  public Date getDateStep();
  
  
  /**
   * @return true if the wind data is saved as regular grid.
   */
  public boolean isRegularGrid( );
  
  /**
   * To get the coordinate system of this wind data provider
   * 
