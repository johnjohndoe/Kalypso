 ...
 * performs it. A extending class can change the behavior of the
 * the response by overriding the modifyModel() and the modifySettings()
 * methods.
 *
 * <p>---------------------------------------------------------------------</p>
 *
...
public class InfoListener extends AbstractMapListener {
     ...
     * if a feature info action/event occurs.
     */
