...
public class ModelModifier {
     ...
     * boundingbox that is $zoomlevel$ % larger ( zoomLevel > 0 ) or 
     * $zoomlevel$ smaller ( zoomLevel < 0 ) than the current bounding box.
     *
     * @param model 
     * @param center 
     * @param zoomLevel 
     ...
     */
    public synchronized static WMSGetMapRequest modify( WMSGetMapRequest model, 
                                                        GM_Point center, 
                                                        double zoomLevel ) {
     ...
     *
     * @param model old <tt>WMSGetMapRequest</tt>
