...
public class General implements Marshallable {
    ...
    public General( String title, String abstract_, Rectangle window, 
                    ContactInformation contactInformation, GM_Point[] boundingBox, 
    ...
    public String exportAsXML() {
        ...
        sb.append( "<General>" );
        if ( window != null ) {
            sb.append( "<Window width='" ).append( window.width )
              .append( "' height='" ).append( window.height ).append( "'/>" );
        }
        try {
            sb.append( "<BoundingBox SRS='" ).append( boundingBox[0].getCoordinateSystem().getName() )
              .append( "' minx='" ).append( boundingBox[0].getX() )
              .append( "' miny='" ).append( boundingBox[0].getY() )
              .append( "' maxx='" ).append( boundingBox[1].getX() )
              .append( "' maxy='" ).append( boundingBox[1].getY() ).append( "'/>" );
        } catch (Exception e) {}
        ...
        if ( logoURL != null ) {
            sb.append( "<LogoURL width='" ).append( logoURL.getWidth() )
              .append( "' height='" ).append( logoURL.getHeight() )
              .append( "' format='" ).append( logoURL.getFormat() ).append( "'>" );
            sb.append( "<OnlineResource  xlink:type='simple' xlink:href='" )
              .append( NetWorker.url2String( logoURL.getOnlineResource() ) )
              .append( "'/>" );
            sb.append( "</LogoURL>" );
        }
        if ( descriptionURL != null ) {
            sb.append( "<DescriptionURL format='" ).append( descriptionURL.getFormat() )
              .append( "'>" );
            sb.append( "<OnlineResource  xlink:type='simple' xlink:href='" )
              .append( NetWorker.url2String( descriptionURL.getOnlineResource() ) )
              .append( "'/>" );
