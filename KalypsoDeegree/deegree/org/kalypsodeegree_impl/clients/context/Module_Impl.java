...
/**
 * this class encapsulates the basic informations of a module that is part of an
 * area of the GUI. Other classes may extent this class by adding special
...
public class Module_Impl implements Module, Marshallable
{
   ...
   *          name of the module
   * @param content
   *          the name of the page/class/file etc. containing the content of the
   *          module
   * @param hidden
