 ...
 * access data metadata (ISO 19115).
 * <p>
 ...
 * the fields of a HTML-form but it can be any other form (e.g.
 * swing-application)
 * </p>
 * <p>
 * --------------------------------------------------------------------
...
public class ISO19115RequestFactory
{
   ...
   * Service Catalog Profil and GDI NRW catalog specifications from a RPC
   * struct.
   * 
   * @param struct
  ...
  /**
   * takes RequestModel and builds a String result out of it. The result should
   * be OGC FilterEncoding conformant.
   */
  private static String createFilterEncoding() throws CatalogClientException
  {
    ...
    if( filterIDs.length > 0 )
    {
      ...
      {
        expCounter++;
        Operation op = createOperation( OperationDefines.PROPERTYISLIKE, "OBJ_ID", filterIDs[i] );
        sb.append( op.toXML() );
      }
      sb.append( "</ogc:Or>" );
    }
  ...
  /**
   * Build OGC Filterencoding fragment: use <code>WCASRequestmodel</code>
   * field <b>fileIdentifier </b> to create Comparison Operation.
   */
  ...
  /**
   * Build OGC Filterencoding fragment: use <code>WCASRequestmodel</code>
   * field <b>parentIdentifier </b> to create Comparison Operation.
   */
  ...
  /**
   * Spread <code>WCASRequestmodel</code> field <b>terms </b> to several
   * Comparison Operations with pre-defined Property names.
   */
  ...
  /**
   * Build OGC Filterencoding fragment: for <code>WCASRequestmodel</code>
   * field <b>topiccategory </b>.
   */
  ...
  /**
   * Build OGC Filterencoding fragment: Spread <code>WCASRequestmodel</code>
   * field <b>keywords </b> to one Comparison Operations.
   */
  private static String handleKeywords() throws CatalogClientException
  {
    ...
    if( ( tc != null ) && ( tc.length > 0 ) )
    {
      ...
      for( i = 0; i < tc.length; i++ )
      {
        ...
        {
          Operation op1 = createOperation( OperationDefines.PROPERTYISEQUALTO, cf[0], tc[i] );
          sb.append( op1.toXML() );
        }
      }
  ...
  /**
   * Build OGC Filterencoding fragment: use <code>WCASRequestmodel</code>
   * fields <b>dateFrom </b> to create Comparison Operation.
   */
  ...
  /**
   * Build OGC Filterencoding fragment: use <code>WCASRequestmodel</code>
   * field <b>geographicBox </b> to create Comparison Operation.
   */
  private static String handleBbox() throws CatalogClientException
  {
    ...
    if( struct.getMember( Constants.RPC_BBOX ) != null )
    {
      ...
      try
      {
        ...
        String srs = CSWClientConfiguration.getInstance().getWMSClientConfiguration()
            .getInitialGetMapRequest().getSrs();
  ...
  private static Operation createOperation( int opId, String prop, Object value )
  {
    ...
    case OperationDefines.PROPERTYISEQUALTO:
      op = new PropertyIsCOMPOperation( OperationDefines.PROPERTYISEQUALTO,
          new PropertyName( prop ), new Literal( (String)value ) );
      break;
    case OperationDefines.PROPERTYISLIKE:
      ...
      op = new PropertyIsLikeOperation( new PropertyName( prop ), new Literal( lit ), wildCard,
    ...
    case OperationDefines.BBOX:
      op = new SpatialOperation( OperationDefines.BBOX, new PropertyName( prop ), (GMLBox)value );
      break;
   ...
   * @tn: holds typeName value, if no value available get one using the
   *      model-accessor
   */
