...
public class DeleteServiceListener extends AbstractSecuredListener
{
  ...
  public void performPrivilegedOperation( FormEvent event )
  {
    ...
    try
    {
      ...
      getRequest().setAttribute( "MESSAGE",
          "Der Service mit der ID '" + serviceId + "' wurde entfernt." );
    }
    catch( Exception e )
    {
      ...
      SAXException, XMLParsingException
  {
    ...
    // build WCAS-request
    String deleteRequest = "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>"
        + "<Transaction xmlns:ogc=\"http://www.opengis.net/ogc\">" + "<Delete type=\"ISO19119\">"
