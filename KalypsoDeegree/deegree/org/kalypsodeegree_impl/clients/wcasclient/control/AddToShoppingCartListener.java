...
/**
 * adds an entray to the selection/shoppingcard of a user. the required
 * informations are contained in the RPCWebEvent passed to the actionPerformed
 * method.
 * 
...
public class AddToShoppingCartListener extends AbstractListener
{
  ...
  public void actionPerformed( FormEvent e )
  {
    ...
    getRequest().setAttribute( Constants.MESSAGE,
        "Der Datensatz wurde der Auswahl hinzugef&uuml;gt" );
