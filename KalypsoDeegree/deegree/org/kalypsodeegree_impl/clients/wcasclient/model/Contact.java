...
/**
 * This class encapsulates the contact information that will be preented to a
 * user in the detailed metadata view of the catalog. It shouldn't be mistaken
...
public class Contact
{
   ...
   *          name of the person
   * @param facsimile
   *          facsimile address of the person
   * @param phone
   *          phone number of the person
   * @param street
   *          street where the person can be reached
   * @param city
   *          city where the person can be reached
   * @param postalCode
  ...
  public Contact( String name, String facsimile, String phone, String street, String city,
      String postalCode, String country, String email, String role, String organisation,
