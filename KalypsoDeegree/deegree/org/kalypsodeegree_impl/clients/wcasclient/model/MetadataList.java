...
public class MetadataList extends ModelList
{
   ...
   * 
   * @param bbox
   *          boundingbox that had limited the spatial extent of the request the
   *          list bases on
   * @param catalog
  ...
  /**
   * returns an entry (MD_Metadata object) identified by the passed
   * fileIdentifier
   * 
  ...
  /**
   * returns the boundingbox that had limited the spatial extent of the request
   * the list bases on
   * 
   * @return boundingbox that had limited the spatial extent of the request the
   *         list bases on
   */
