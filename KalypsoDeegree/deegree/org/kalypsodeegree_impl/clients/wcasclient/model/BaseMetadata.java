...
public class BaseMetadata {
     ...
     *
     * @param title title of the metadata set
     */
     ...
     *
     * @param fileIdentifier fileIdentifier(ID) of the metadata set
     */
     ...
     *
     * @param dateStamp date stamp of the metadata set
     */
     ...
     *
     * @param metadataStandardName  metadata standard name 
     */
