...
public class SelectionEntry {
    ...
    /**
     * Creates a new SelectionEntry object. For default the entry is set to
     * 'not selected'
     *
     * @param id unique identifier of a catalog entry
     * @param title title of the catalog entry
     * @param catalog name of the catalog the entry belongs to
     * @param bbox bbox that bases the request the entry was find at
     */
