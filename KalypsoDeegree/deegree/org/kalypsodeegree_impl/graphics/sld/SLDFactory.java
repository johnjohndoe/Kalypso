 ...
 * <p>
 * TODO: Default values for omitted elements (such as fill color) should
 *        better not be used in the construction of the corresponding objects
 *        (Fill), but marked as left out (to make it possible to differentiate
 *        between explicitly given values and default values).
 * <p>
...
public class SLDFactory {
     ...
     * XML-representation.
     * <p>
     * @param s contains the XML document
    ...
    /**
     * Creates a <tt>TextSymbolizer</tt>-instance according to the contents
     * of the DOM-subtree starting at the given
     * 'TextSymbolizer'-<tt>Element</tt>.
     * <p>
     * @param element the 'TextSymbolizer'-<tt>Element</tt>
     * @param min scale-constraint to be used
     * @param max scale-constraint to be used
     * @throws XMLParsingException if a syntactic or semantic error
     ...
     * 'StyledLayerDescriptor'-<tt>Element</tt>.
     * <p>
     * @param element the 'StyledLayerDescriptor'-<tt>Element</tt>
     * @throws XMLParsingException if a syntactic or semantic error
     *         in the DOM-subtree is encountered
     * @return the constructed <tt>StyledLayerDescriptor</tt>-instance
     */
    ...
    /** 
     * Creates a <tt>NamedStyle</tt>-instance according to the contents of
     * the DOM-subtree starting at the given 'NamedStyle'-<tt>Element</tt>.
     * <p>
     * @param element the 'NamedStyle'-<tt>Element</tt>
     * @throws XMLParsingException if a syntactic or semantic error
     *         in the DOM-subtree is encountered
    ...
    /**
     * Creates a <tt>RemoteOWS</tt>-instance according to the contents of
     * the DOM-subtree starting at the given 'RemoteOWS'-<tt>Element</tt>.
     * <p>
     * @param element the 'RemoteOWS'-<tt>Element</tt>
     * @throws XMLParsingException if a syntactic or semantic error
     *         in the DOM-subtree is encountered
    ...
    private static RemoteOWS createRemoteOWS( Element element ) throws XMLParsingException {
        ...
        Element onlineResourceElement = 
        	XMLTools.getRequiredChildByName( "OnlineResource", sldNS, element );
    ...
    /**
     * Creates a <tt>NamedLayer</tt>-instance according to the contents of
     * the DOM-subtree starting at the given 'UserLayer'-<tt>Element</tt>.
     * <p>
     * @param element the 'NamedLayer'-<tt>Element</tt>
     * @throws XMLParsingException if a syntactic or semantic error
     *         in the DOM-subtree is encountered
    ...
    public static NamedLayer createNamedLayer( String name, 
                                        ...
                                        Style[] styles ) throws XMLParsingException {
        return new NamedLayer_Impl( name, layerFeatureConstraints, styles );
    }

    /**
     * Creates a <tt>UserLayer</tt>-instance according to the contents of
     * the DOM-subtree starting at the given 'UserLayer'-<tt>Element</tt>.
     * <p>
     * @param element the 'UserLayer'-<tt>Element</tt>
     * @throws XMLParsingException if a syntactic or semantic error
     *         in the DOM-subtree is encountered
    ...
    private static UserLayer createUserLayer( Element element ) throws XMLParsingException {
        ...
        LayerFeatureConstraints lfc = null;
        Element lfcElement = XMLTools.getRequiredChildByName( "LayerFeatureConstraints", sldNS, 
                                                              element );
        lfc = createLayerFeatureConstraints( lfcElement );
     ...
     * contents of the DOM-subtree starting at the given
     * 'FeatureTypeConstraint'-<tt>Element</tt>.
     * <p>
     * @param element the 'FeatureTypeConstraint'-<tt>Element</tt>
     * @throws XMLParsingException if a syntactic or semantic error
     *         in the DOM-subtree is encountered
     ...
     * <p>
     * @param element the 'LayerFeatureConstraints'-<tt>Element</tt>
     * @throws XMLParsingException if a syntactic or semantic error
     *         in the DOM-subtree is encountered
    ...
    public static LayerFeatureConstraints createLayerFeatureConstraints( Element element )
        ...
        ElementList nodelist = XMLTools.getChildElementsByName( "FeatureTypeConstraint", sldNS, element );
    ...
    /**
     * Creates a <tt>UserStyle</tt>-instance according to the contents of
     * the DOM-subtree starting at the given 'UserStyle'-<tt>Element</tt>.
     * <p>
     * @param element the 'UserStyle'-<tt>Element</tt>
     * @throws XMLParsingException if a syntactic or semantic error
     *         in the DOM-subtree is encountered
    ...
    /**
     * Creates a <tt>FeatureTypeStyle</tt>-instance according to the contents of
     * the DOM-subtree starting at the given
     * 'FeatureTypeStyle'-<tt>Element</tt>.
     * <p>
     * TODO: The ElseFilter currently does not work correctly with
     *       FeatureFilters.
     * <p>
     * @param element the 'FeatureTypeStyle'-<tt>Element</tt>
     * @throws XMLParsingException if a syntactic or semantic error
     *         in the DOM-subtree is encountered
    ...
    public static FeatureTypeStyle createFeatureTypeStyle( Element element ) throws XMLParsingException {
        ...
        String[] typeIdentifiers = (String[])typeIdentifierList.toArray( 
                                             new String[typeIdentifierList.size()] );
    ...
    /**
     * Creates a <tt>Rule</tt>-instance according to the contents of
     * the DOM-subtree starting at the given 'Rule'-<tt>Element</tt>.
     * <p>
     * @param element the 'Rule'-<tt>Element</tt>
     * @throws XMLParsingException if a syntactic or semantic error
     *         in the DOM-subtree is encountered
    ...
    private static Rule createRule( Element element ) throws XMLParsingException {
        ...
        Symbolizer[] symbolizers = (Symbolizer[])symbolizerList.toArray( 
                                             new Symbolizer[symbolizerList.size()] );
     ...
     * <p>
     * @param element the 'PointSymbolizer'-<tt>Element</tt>
     * @param min scale-constraint to be used
     * @param max scale-constraint to be used
     * @throws XMLParsingException if a syntactic or semantic error
     *         in the DOM-subtree is encountered
     ...
     */
    private static PointSymbolizer createPointSymbolizer( Element element,
        double min, double max ) throws XMLParsingException {
     ...
     * <p>
     * @param element the 'LineSymbolizer'-<tt>Element</tt>
     * @param min scale-constraint to be used
     * @param max scale-constraint to be used
     * @throws XMLParsingException if a syntactic or semantic error
     *         in the DOM-subtree is encountered
     ...
     * <p>
     * @param element the 'PolygonSymbolizer'-<tt>Element</tt>
     * @param min scale-constraint to be used
     * @param max scale-constraint to be used
     * @throws XMLParsingException if a syntactic or semantic error
     *         in the DOM-subtree is encountered
    ...
    /**
     * Creates a <tt>Geometry</tt>-instance according to the contents of
     * the DOM-subtree starting at the given 'Geometry'-<tt>Element</tt>.
     * <p>
     * FIXME: Add support for 'Function'-Elements.
     * <p>
     * @param element the 'Geometry'-<tt>Element</tt>
     * @throws XMLParsingException if a syntactic or semantic error
     *         in the DOM-subtree is encountered
    ...
    private static Geometry createGeometry( Element element ) throws XMLParsingException {
        ...
        Element propertyNameElement = XMLTools.getRequiredChildByName( "PropertyName", ogcNS, 
                                                                       element );
     ...
     * <p>
     * @param element the 'LegendGraphic'-<tt>Element</tt>
     * @throws XMLParsingException if a syntactic or semantic error
     *         in the DOM-subtree is encountered
    ...
    private static Graphic createGraphic( Element element ) throws XMLParsingException {
        ...
        Object[] marksAndExtGraphics = marksAndExtGraphicsList.toArray( 
