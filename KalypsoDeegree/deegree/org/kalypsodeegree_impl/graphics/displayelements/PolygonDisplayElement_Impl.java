 ...
 */
public class PolygonDisplayElement_Impl extends GeometryDisplayElement_Impl
    implements PolygonDisplayElement, Serializable {
    ...
    /**
     * calculates the Area (image or screen coordinates) where to draw
     * the surface.
     */
    ...
    /**
     * renders one surface to the submitted graphic context considering
        ...
        if ( stroke != null ) {
            ...
            if ( opacity > 0.01 ) {
                ...
                if ( ( dash == null ) || ( dash.length < 2 ) ) {
                    ...
                    bs2 = new BasicStroke( w, stroke.getLineCap( feature ), 
