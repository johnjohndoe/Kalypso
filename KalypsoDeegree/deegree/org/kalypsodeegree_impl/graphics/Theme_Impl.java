...
/**
 * A Theme is for usual a homogenious collection of Features coupled with a
 * portrayal model for their graphical representation. Considering the OGC
 ...
 * <p>
 * </p>
 * From a theoretical point of view this isn't very satisfying. But it will be
 * supported by the <tt>Theme</tt> class.
 * <p>
 * </p>
 ...
 * <li>a event listener that handles event occuring on a theme that's for usual
 * part of a map.
 * </ul>
 * 
 * <p>
...
class Theme_Impl implements Theme
{
  ...
  /**
   * this ArrayList contains all DisplayElements (and so the features) that are
   * marked as selected.
   */
