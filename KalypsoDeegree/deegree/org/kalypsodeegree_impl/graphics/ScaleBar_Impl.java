...
public class ScaleBar_Impl implements ScaleBar {
    ...
    public ScaleBar_Impl() {
        this( L_SCALEDENOMINATOR, L_SCALE, 40000, 100, "Meter", Color.GREEN, 
              Color.BLUE, Color.BLACK, "default",  new Font( "default", Font.PLAIN, 12 ) );
    }
    ...
    public void paint( Graphics g ) { //throws Exception {
        ...
        switch ( bottomLabel ) {
            ...
            case 0:
                laenge = g.getFontMetrics().stringWidth( scale + " " + unit );
                g.drawString( scale + " " + unit, ( width - laenge ) / 2, 
