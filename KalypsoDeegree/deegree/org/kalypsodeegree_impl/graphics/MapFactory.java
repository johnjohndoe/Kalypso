...
public class MapFactory {
     ...
     */
    public static synchronized Layer createRasterLayer( String name, 
     ...
     */
    public static synchronized Theme createTheme( String name, Layer layer ) {
        return new Theme_Impl( name, layer, new UserStyle[] { null }  );
    }
     ...
     */
    public static synchronized MapView createMapView( String name, GM_Envelope boundingbox, 
                                                      CS_CoordinateSystem crs, Theme[] themes )
                                              throws Exception {
     ...
     */
    public static synchronized MapView createMapView( String name, GM_Envelope boundingbox, 
                                                      CS_CoordinateSystem crs, Layer[] layers )
                                              throws Exception {
        MapView mv = new MapView_Impl( name, boundingbox, crs );
