...
public class GMLProperty_Impl implements GMLProperty {
    ...
    private boolean isGeometryProperty() {
        ...
        if ( name.equals( "pointProperty" ) || name.equals( "lineStringProperty" ) || 
                 ...
                 name.equals( "multiLineStringProperty" ) || 
     ...
     * describing schema.</p>
     * <p>At the moment only String-type and geometry types are
     * supported. Complex types like feature or feature collections
     * aren't supported yet.</p>
     */
    ...
    /**
     * performs the mapping of the gml geoType (String) to
     * its int representation for more simple handling.
     */
    ...
    /**
     * @see org.deegree_impl.gml.GMLProperty_Impl#getPropertyValue()<p>
     ...
     * <p>Notice: if the old value has been removed this may change
     * the properties type. At a future release a validation against
     * the schema of the document has to be performed.</p>
     */
 ...
 * no message
 *
 * Revision 1.5  2003/09/22 09:58:05  poth
 * no message
 *
 * Revision 1.4  2003/06/03 15:56:39  poth
 * no message
 *
 * Revision 1.3  2003/05/15 09:37:40  poth
 * no message
 *
 ...
 * no message
 *
 * Revision 1.6  2002/07/31 06:26:06  ap
 * no message
 *
 * Revision 1.5  2002/07/19 14:47:08  ap
 * no message
 *
 *
 */
