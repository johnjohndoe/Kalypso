...
public class GML_Transformer
{
   ...
   */
  public GMLPolygon transformPolygon( GMLPolygon gmlgeo, String target_srs ) throws Exception
  {
  ...
  //        transformationfactory = new TransformationFactory();
  //        MathTransform transform = transformationfactory.getTransform(src_srs,
  // target_srs);
  //        
  ...
  //        Element ls_elem = ls_doc.createElementNS("http://www.opengis.net/gml",
  // "gml:LineString");
  ...
  //        Element box_elem = box_doc.createElementNS("http://www.opengis.net/gml",
  // "gml:Box");
