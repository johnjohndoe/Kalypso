...
/**
 * <p>As an alternative to the sequence of &lt;coords&gt;, coordinates can also be
 ...
 * localized coordinates list wherever a <coordinates> element is expected; such a subtype
 * could employ other delimiters to reflect local usage.
 * <p>It is expected that a specialized client application will extract and validate string
 ...
 * Initial revision
 *
 * Revision 1.5  2004/03/01 07:45:47  poth
 * no message
 *
 * Revision 1.4  2004/02/23 07:47:48  poth
 * no message
 *
 * Revision 1.3  2004/01/03 13:46:45  poth
 * no message
 *
