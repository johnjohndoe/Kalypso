 ...
 * @author thuel
 */
public class GMLSchemaUtils
{

  /**
   * 
   * @param schema
   * @return all featuretypes that are defined by the schema and defined by imported schemas 
   */
  public static FeatureType[] getAllFeatureTypesFromSchema( GMLSchema schema )
  {
    CollectFeatureTypesSchemaVisitor visitor = new CollectFeatureTypesSchemaVisitor();
    schema.accept( visitor );
    return visitor.getFeatureTypes();
  }
}