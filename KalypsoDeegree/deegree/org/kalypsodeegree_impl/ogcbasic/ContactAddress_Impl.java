    ...
    */
    ...
    public String exportAsXML() {
        ...
        sb.append ("<ContactAddress>")       
          .append ("<AddressType>")
          .append (XMLTools.validateCDATA (addressType))
          .append ("</AddressType>")
          .append ("<Address>")
          .append (XMLTools.validateCDATA (address))
          .append ("</Address>")
          .append ("<City>")
          .append (XMLTools.validateCDATA (city))
          .append ("</City>")
          .append ("<StateOrProvince>")
          .append (XMLTools.validateCDATA (stateOrProvince))
          .append ("</StateOrProvince>")
          .append ("<Postcode>")
          .append (XMLTools.validateCDATA (postCode))
          .append ("</Postcode>")
          .append ("<Country>")
          .append (XMLTools.validateCDATA (country))
          .append ("</Country>")
