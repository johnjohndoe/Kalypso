...
public class WMServicePool extends ObjectPool {
     ...
     * @param capabilities the capabilities the pool objects must conform to
     */
    ...
    synchronized public static WMServicePool getInstance (WMSCapabilities capabilities) 
        ...
        if (instance == null) instance = new WMServicePool (capabilities);
        Debug.debugMethodEnd ();
        return instance;
    }
    ...
    /** 
     * This method will be called when the submitted object is removed from
     * the pool. FIXME!!!
