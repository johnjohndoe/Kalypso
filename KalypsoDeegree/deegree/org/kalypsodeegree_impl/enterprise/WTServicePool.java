...
public class WTServicePool extends ObjectPool {
     ...
     * @param configurationURL URL to the capabilies for the pools objects 
     */
     ...
     */    
    synchronized public static WTServicePool getInstance (URL capabilitiesURL) 
        throws Exception {
        Debug.debugMethodBegin ("WTServicePool", "getInstance");
        if (instance == null) instance = new WTServicePool (capabilitiesURL);
        Debug.debugMethodEnd ();
        return instance;
    }
    
    /**
     * Clears the pool. Objects in use while the method has been called won't
     * be put back to the pool if released back through the 
     * <tt>releaseObject</tt> method afterwards.
     */
    public void destroy () {
        clear ();
        instance = null;
     ...
     * @param noOfInstances number of instances to create
     */
    ...
    /** 
     * This method will be called when the passed object is removed from
     * the pool. 
