...
public class GMLAdapter {
     ...
     *
     * @param linestring a GMLLineString
     */
     ...
     *
     * @param multipoint GMLMultiPoint
     */
     ...
     *
     * @param multilinestring a GMLMultiLineString
     */
    ...
    private static GM_Surface wrap( GMLBox gmlBox ) throws GM_Exception {
        ...
        return GeometryFactory.createGM_Surface( exteriorRing, null, new GM_SurfaceInterpolation_Impl(), 
                                         crs );
    }
}