...
public class SDEAdapter
{
   ...
   * @return
   */
  public static SeShape export( GM_Object geom, SeCoordinateReference crs ) throws GM_Exception,
      SeException
  {
    Debug.debugMethodBegin();
  ...
  private static SeShape export( GM_Point point, SeCoordinateReference crs ) throws SeException
  {
    ...
    shp.generatePoint( 1, new SDEPoint[]
    { pt } );
   ...
   *         GM_Exception
   */
  private static SeShape export( GM_Curve cur, SeCoordinateReference crs ) throws GM_Exception,
      SeException
  {
    Debug.debugMethodBegin();
   ...
   *         GM_Exception
   */
  private static SeShape export( GM_MultiCurve mc, SeCoordinateReference crs ) throws GM_Exception,
      SeException
  {
    Debug.debugMethodBegin();
  ...
  private static GM_Surface wrapSurface( SeShape shape ) throws GM_Exception, SeException
  {
    ...
    {
      gmPolygonExteriorRing[pt] = GeometryFactory.createGM_Position( points[pt].getX(), points[pt]
          .getY() );
    }
    ...
    GM_Surface sur = GeometryFactory.createGM_Surface( gmPolygonExteriorRing,
  ...
  private static GM_MultiCurve wrapMultiCurve( SeShape shape ) throws GM_Exception, SeException
  {
    ...
    for( int partNo = 0; partNo < numParts; partNo++ )
    {
      ...
      {
        //System.out.println("X: " + points[pt].getX() + "\tY: " +
        // points[pt].getY() );
    ...
    for( int partNo = 0, partEnd = 0; partNo < partOffset.length; partNo++ )
    {
      ...
      for( ; ( pointNo < points.length ) && ( pointNo < partEnd ); pointNo++ )
      {
        ...
        else
        {
          ...
          // and assign the size of the second dimension of
      ...
      gmMultiPolygonSurface[partNo] = GeometryFactory.createGM_Surface( gmMultiPolygonExteriorRing,
          gmMultiPolygonInteriorRings, new GM_SurfaceInterpolation_Impl(), null );
    } // End for
