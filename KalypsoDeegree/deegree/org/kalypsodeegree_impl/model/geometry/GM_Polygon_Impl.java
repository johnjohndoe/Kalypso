...
class GM_Polygon_Impl extends GM_SurfacePatch_Impl implements GM_Polygon, Serializable {
    ...
    public GM_Polygon_Impl( GM_SurfaceInterpolation interpolation, GM_Position[] exteriorRing, 
                            GM_Position[][] interiorRings, CS_CoordinateSystem crs )
                    throws GM_Exception {
     ...
     * GM_SurfacePatch represented as a collection of GM_Curves organized
     * as a GM_SurfaceBoundary, consisting of GM_Curve instances along the
     * boundary of the aggregate GM_Surface, and interior to the GM_Surface
     * where GM_SurfacePatches are adjacent.
     */
    ...
    public Object clone() {
        ...
        try {
            p = new GM_Polygon_Impl( 
                        new GM_SurfaceInterpolation_Impl( getInterpolation().getValue() ), 
