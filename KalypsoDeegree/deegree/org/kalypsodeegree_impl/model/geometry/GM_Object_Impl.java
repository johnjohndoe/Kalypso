 ...
 * package deegree.model. The implementation is abstract because
 * only the management of the spatial reference system is unique
 * for all geometries.
 * <p>
...
public abstract class GM_Object_Impl implements GM_Object, Serializable {
    ...
    /**
     * returns a shallow copy of the geometry. this isn't realized
     * at this level so a CloneNotSupportedException will be thrown.
     */
     ...
     * convex hull of this GM_Object.<p></p>
     * dummy implementation
     */
     ...
     * <p>
     * @param that the GM_Object to test (whether is is contained)
     ...
     * <p>
     * @param position GM_Position to test (whether is is contained)
     * @return true if the given object is contained, else false
	 */
     ...
     * <p>
     * @param that the GM_Object to intersect with
     ...
     * <p>
     * @param that the GM_Object to unify
     ...
     * of this <tt>GM_Object</tt> and the passed <tt>GM_Object</tt>.
     * <p>
     * @param that the GM_Object to intersect with
     ...
     * <p>
     * @param that the GM_Object to calculate the difference with
     ...
     * <p>
     * @param that the GM_Object to test for equality
    ...
    */
    ...
    /**
     * returns true if the calculated parameters of the GM_Object are valid
