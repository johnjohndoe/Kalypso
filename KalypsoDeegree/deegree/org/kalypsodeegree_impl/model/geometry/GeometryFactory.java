...
//    }
     ...
     *
     * @param points array of GM_Point
     ...
     * @param crs geometries coordinate reference system
     */
     ...
     *
     * @param segment GM_CurveSegments     
     */
     ...
     *
     * @param segments array of GM_CurveSegments     
     */
     ...
     * @param crs spatial reference system of the surface patch
     */
    ...
    /**
     * creates a GM_Surface composed of one GM_SurfacePatch from array(s)
     * of GM_Position
     *
     * @param exteriorRing exterior ring of the patch
     * @param interiorRings interior rings of the patch
    ...
    public static GM_Surface createGM_Surface( GM_Position[] exteriorRing, GM_Position[][] interiorRings, 
                                        GM_SurfaceInterpolation si, CS_CoordinateSystem crs )
                                throws GM_Exception {
    ...
    public static GM_Surface createGM_Surface( byte[] wkb, CS_CoordinateSystem crs, 
        ...
        GM_SurfacePatch patch = createGM_SurfacePatch( externalBoundary, internalBoundaries, si, 
                                                       crs );
    ...
    public static GM_Surface createGM_Surface (GM_Envelope bbox, CS_CoordinateSystem crs)
        ...
        return createGM_Surface (exteriorRing, null,
     ...
     *
     * @param points array of GM_Points
     *
     */
    ...
    public static GM_MultiPoint createGM_MultiPoint( byte[] wkb, CS_CoordinateSystem crs )
        ...
        for ( int i = 0; i < numPoints; i++ ) {
            ...
            if ( wkbType != 1 ) {
                throw new GM_Exception( "Invalid byte stream for GM_Point as " + 
