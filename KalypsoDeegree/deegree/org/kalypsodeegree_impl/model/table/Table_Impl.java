...
public class Table_Impl implements Table {
     ...
     */
    public Table_Impl(String tableName, String[] columnNames, String[] columnTypes,
    										Object[][] data) throws TableException {
    ...
    public void setColumnType(int col, String type) throws TableException {
        ...
        try {
            ...
            throw new TableException( "column type can not be changed to " +
                                      type + " because: " + e );
        }
    }
     ...
     * The instance will be created using the <tt>javax.swing.table.DefaultTableModel</tt>
     */
