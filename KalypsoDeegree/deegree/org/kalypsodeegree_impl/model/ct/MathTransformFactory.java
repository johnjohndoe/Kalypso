...
public class MathTransformFactory
{
  ...
  private static boolean areInverse( final MathTransform tr1, final MathTransform tr2 )
  {
    if( tr2 instanceof AbstractMathTransform.Inverse )
    {
      ...
      // TODO: we could make this test more general (just compare with
      // tr2.inverse(),
      ...
      final MathTransform transform )
  {
    ...
    matrix.setElement( dimOutput, dimTarget, 1 ); // Affine transform has one
    // more row/column than
    // dimension.
   ...
   * </tr>
   * <tr>
   * <td><code>Num_row</code></td>
   * <td>Number of rows in matrix</td>
   * </tr>
   * <tr>
   * <td><code>Num_col</code></td>
   * <td>Number of columns in matrix</td>
   * </tr>
   * <tr>
   * <td><code>elt_&lt;r&gt;_&lt;c&gt;</code></td>
