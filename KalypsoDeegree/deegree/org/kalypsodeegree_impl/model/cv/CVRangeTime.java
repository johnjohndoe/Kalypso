...
public class CVRangeTime extends CVRange
{
	 ...
	 *
	 * @param param   the  TimeExtent to be compared against this CVRangeTime
	 *
	...
	public boolean match(RangeParam param)
	{
		...
		if(_te.isPeriodic())
		{
			if(date.equals(_te.getStartDate()) ||
			   date.equals(_te.getEndDate()))
				return true;
			
			if(date.after(_te.getStartDate()) &&
			   date.before(_te.getEndDate()))
				return true;
		}
