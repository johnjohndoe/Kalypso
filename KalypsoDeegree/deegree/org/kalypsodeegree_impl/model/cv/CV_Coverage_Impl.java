...
public class CV_Coverage_Impl implements CV_Coverage, Serializable
{
     ...
     * @param descriptor containing a description of the coverage
     */
     ...
     * @param crs coordinate reference system of the coverage
     */
     ...
     * @param sampleDimensions Sample dimensions for the coverage
     */
     ...
     */
    protected static Tile[] getTiles(Level level, GM_Envelope boundingBox, double scale) throws CoverageCreationException
    {
