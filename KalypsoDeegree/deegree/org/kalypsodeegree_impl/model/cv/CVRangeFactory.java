...
//			return new CVRangeXXXX(name, value, level, subranges);
	...
	/**
	 * Replaces rangeparam tokens with proper string
	 * FIXME Maybe this is the wrong place for this method
	 *
	 * @param   rangeParams The instantiated request range paramenters
	 * @param 	usedRanges  The List of selected CVRanges
	 * @param   tileUrl     The tile URL containing tokens to be replaces
	 *
