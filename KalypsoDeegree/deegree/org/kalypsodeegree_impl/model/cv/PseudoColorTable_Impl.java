...
/**
 * PseudoColorTable lists indexed color values, expressed as
...
class PseudoColorTable_Impl implements PseudoColorTable
{
  ...
  private PseudoColorTableEntry[] pseudoColorTableEntries = null;

  PseudoColorTable_Impl( PseudoColorTableEntry[] pseudoColorTableEntries )
  {
    this.pseudoColorTableEntries = pseudoColorTableEntries;
  }
  ...
  {
    return pseudoColorTableEntries;
  }
