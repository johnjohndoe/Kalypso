...
class FeatureCollection_Impl extends Feature_Impl implements FeatureCollection, Serializable  {
    ...
    FeatureCollection_Impl(String id,  FeatureType featureType, 
        ...
        ftp[0] = FeatureFactory.createFeatureTypeProperty( "features", 
														   ...
														   true );
        ft = FeatureFactory.createFeatureType( null, null, 
        									   "feature collection", ftp );
    }
    
    /**
     * constructor for initializing a featur collection with an id
     * and a initial capacity.
     */
     ...
     * submitted value for <tt>index</tt> is smaller 0 and larger then the number
     * features within the featurecollection-1 an exeption will be thrown.
     */
	...
	*/
     ...
     * for <tt>index</tt> is smaller 0 and larger then the number features within
     * the featurecollection-1 an exeption will be thrown.
     */
     ...
     * matches the feature type defined for all features within the collection
