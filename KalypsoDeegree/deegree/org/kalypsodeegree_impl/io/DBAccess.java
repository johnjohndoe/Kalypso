...
import org.deegree.model.table.*;
import org.deegree_impl.model.table.*;
...
public class DBAccess {
     ...
     * @param logon logon (database address, additional parameters) 
     * @param user 
     * @param password
     * @throws SQLException
     * @throws Exception
     ...
     * @throws Exception
     */
    public DBAccess(final String driver, final String logon,
    final Properties properties) throws SQLException, Exception {
     ...
     */
    public DBAccess(final String driver, final String logon,
    final Properties properties, final boolean autoCommit)
    ...
    /**
     * perfomrs a general query against a database. The calling
     * class (method) has to know the type of the returned object
     * to cast it to a more specialized class.
     *
     * @param query the query parameter contains the query to perform.
     * @return result of the query. if the query failed null will be
     *		  returned.
     * @exception SQLException will be thrown if the submitted query
     ...
     *
     * @param query the query parameter contains the query to perform.
     * @param startFeature index of the feature the query starts
     * @param maxFeatures the maximum amount of features that should be
     *		  returned by the request. if <tt>maxFeatures</tt> is <= 0 all
    ...
    public Object performQuery(String query, int startFeature, int maxFeatures) 
        ...
        if ( startFeature < 0 ) startFeature = 0;
    ...
    protected String mapTypes(final int type) {
        ...
        switch (type) {
            ...
            case Types.CHAR: clname = "java.lang.String"; break;
            case Types.VARCHAR: clname = "java.lang.String"; break;
            case Types.LONGVARCHAR: clname = "java.lang.String"; break;
            case Types.DATE: clname = "java.sql.Date"; break;
            case Types.FLOAT: clname = "java.lang.Float"; break;
            case Types.DOUBLE: clname = "java.lang.Double"; break;
            case Types.INTEGER: clname = "java.lang.Integer"; break;
            case Types.SMALLINT: clname = "java.lang.Short"; break;
            case Types.TINYINT: clname = "java.lang.Byte"; break;
            case Types.NUMERIC: clname = "java.math.BigDecimal"; break;
            case Types.STRUCT: clname = "java.io.ByteArrayOutputStream"; break;
            case Types.ARRAY: clname = "java.sql.Array"; break;
            case Types.BLOB: clname = "java.io.InputStream"; break;
            case Types.CLOB: clname = "java.io.InputStream"; break;
            default: clname = "java.lang.Object"; break;
    ...
    /**
     * commits the perfomerd queries, inserts and updates if
     ...
     *		  are expressed in capital letters.
     */
    public Table performTableQuery(final String query, final int startFeature,
     ...
     * @param update sql-statement that should be performed
     */
     ...
     * @throws SQLException if the SQL was erroneus or a general database
     *         error occured
     */
     ...
     * @param insert sql-statement that should be performed
     */
    ...
    /**
     * returns a HashMap that maps a column to a data type. if
     * null is submitted for columns all columns are considered.
     */
