 ...
 * @author doemming
 */
public class XSDStringTypeHandler extends AbstractXSDSimpleTypeHandler
{

  public XSDStringTypeHandler(  )
  {
    super( String.class, new QName[] { new QName( XMLHelper.XMLSCHEMA_NS, "string" ) } );
  }
