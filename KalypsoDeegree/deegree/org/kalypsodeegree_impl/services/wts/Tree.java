...
public class Tree extends Group
{
  ...
  public Tree( float x, float y, float size, float base, float height, String textureSource )
  {
  ...
  public Group addObject( float x, float z, float size, float base, float height )
  {
    ...
    Sphere crown = new Sphere( size, Box.GENERATE_NORMALS | Box.GENERATE_TEXTURE_COORDS, crownAp );
