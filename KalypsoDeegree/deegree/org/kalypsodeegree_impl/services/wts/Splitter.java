...
/**
* class for calculating and splitting a views footprint into
...
class Splitter implements OGCWebServiceClient {
    ...
    Splitter( WTSGetViewRequest request, ViewPoint vp ) throws Exception {
        ...
        GM_Envelope bbox = GeometryFactory.createGM_Envelope( ob.x - 2, ob.z - 2, ob.x + 2, 
                                                              ob.z + 2 );
        WTSConfiguration conf = WTSConfiguration_Impl.getInstance();
        String layer = request.getElevationModels()[0];
        WCSGetCoverageRequest wcsReq = WCSProtocolFactory.createWCSGetCoverageRequest( "1.0.0", 
                                                                                       this.toString(), 
                                                                                       null, layer, 
                                                                                       request.getSrs(), 
                                                                                       request.getSrs(), 
     ...
     */
    public GM_Surface[] makeStripes( int count ) throws InvalidArcException, GM_Exception, 
                                                        Exception {
