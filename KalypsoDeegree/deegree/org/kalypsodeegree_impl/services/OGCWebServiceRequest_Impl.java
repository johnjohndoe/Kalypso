...
public class OGCWebServiceRequest_Impl implements OGCWebServiceRequest
{
  ...
  /**
   * sets the REQUEST parameter indicating which service operation is being
   * invoked. The value shall be the name of one of the operations offered by
   * the OGC Web Service Instance.
   */
  ...
  /**
   * sets the required SERVICE parameter indicating which of the available
   * service types at a particular service instance is being invoked.
   */
