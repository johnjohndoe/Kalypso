 ...
 * @author $author$
 */
class WFSGDescribeFeatureTypeRequest_Impl extends WFSDescribeFeatureTypeRequest_Impl implements
    WFSGDescribeFeatureTypeRequest
{
  ...
  {
    super( version, id, vendorSpecificParameter, native_, outputFormat, typeNames );
  }
}