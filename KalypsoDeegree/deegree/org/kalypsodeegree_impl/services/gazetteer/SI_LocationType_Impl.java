...
public class SI_LocationType_Impl implements SI_LocationType {
     ...
     *
     */
    public SI_LocationType_Impl(String name, String theme, String identifier,
                                String definition, CitedResponsibleParty owner,
                                SI_LocationType[] parent, SI_LocationType[] child,
