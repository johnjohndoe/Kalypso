...
public class WFSUpdate_Impl implements WFSUpdate
{
   ...
   * 
   * @param typeName
   *          value of the typeName-Attribute (FeatureType-name)
   * @param properties
   *          name/value-pairs of fields to be changed
   * @param filter
   *          wfs:Filter-Expression to be applied
   */
  protected WFSUpdate_Impl( String typeName, HashMap properties, Filter filter )
  {
  ...
  /**
   * The typeName attribute is used to indicate the name of the feature type be
   * updated.
   * <p>
   * 
