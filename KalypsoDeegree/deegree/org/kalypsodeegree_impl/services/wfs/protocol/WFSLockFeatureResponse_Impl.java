...
class WFSLockFeatureResponse_Impl extends WFSBasicResponse_Impl implements WFSLockFeatureResponse
{
  ...
  WFSLockFeatureResponse_Impl( OGCWebServiceRequest request, Document exception,
      String[] affectedFeatureTypes, String lockId, String[] featuresLocked,
  ...
  /**
   * sets the id of the locking action. the may be used to identify the request
   * that locks a feature.
   */
 ...
 * doemming *** empty log message *** Revision 1.3 2004/03/12 15:56:49 poth no
 * message
 * 
