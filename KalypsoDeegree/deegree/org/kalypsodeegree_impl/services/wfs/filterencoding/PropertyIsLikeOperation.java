...
public class PropertyIsLikeOperation extends ComparisonOperation {
    ...
    public static Operation buildFromDOM (Element element)
        ...
        if (wildCard == null || wildCard.length () == 0) throw new FilterConstructionException ("wildCard-Attribute is unspecified!");
        ...
        if (singleChar == null || singleChar.length () == 0) throw new FilterConstructionException ("singleChar-Attribute is unspecified!");
        ...
        if (escapeChar == null || escapeChar.length () == 0) escapeChar = element.getAttribute ("escapeChar"); 
        if (escapeChar == null || escapeChar.length () == 0) throw new FilterConstructionException ("escape-Attribute is unspecified!");
