 ...
 * geometries as GML geometries considering the deegree WFS assumptions about
 * naming the required columns. FIXME: - complete configurability of the Builder -
...
public class GMLDBSQLBuilder extends AbstractSQLBuilder
{
  ...
  public StringBuffer spatialOperation2SQL( SpatialOperation operation ) throws Exception
  {
    ...
    case OperationDefines.BBOX:
    {
      ...
      //                String field = ft.getDatastoreField(
      // operation.getPropertyName().getValue() )[0];
