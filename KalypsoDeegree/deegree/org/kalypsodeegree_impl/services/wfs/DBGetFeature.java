...
abstract public class DBGetFeature extends AbstractGetFeature
{
  ...
  /**
   * creates the relations resp. the complext data schema by replacing the
   * foreign key of the master table(s) with the related data.
   */
            ...
            if( depth < 3 )
            {
              ...
              for( int k = 0; k < table.getRowCount(); k++ )
              {
                ...
                try
                {
                  ...
                  con = pool.acuireConnection( connect.getDriver(), connect.getLogon(), connect
                      .getUser(), connect.getPassword() );
                  ...
                  {
                    HashMap ctt = osa.getColumnTypes( tt, new String[]
                    { tf } );
                ...
                catch( Exception e )
                {
                  ...
                  pool.releaseConnection( con, connect.getDriver(), connect.getLogon(), connect
                      .getUser(), connect.getPassword() );
                ...
                else
                {
                  ...
                  if( colIdx < 0 )
                  {
                    ...
                    table.addColumn( ref[z].getTargetTable(), "org.deegree.model.table.Table" );
