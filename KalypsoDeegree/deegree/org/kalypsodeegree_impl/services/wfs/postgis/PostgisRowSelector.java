...
public class PostgisRowSelector extends RowSelector
{
  ...
  public PostgisRowSelector( TableDescription table, String keyfield, Set keys, DBAccess osa,
  ...
  public RowSelector[] getReferencedRows() throws SQLException
  {
    ...
    for( int i = 0; i < refs.length; i++ )
    {
      ...
      // referenced table
      rowSelectors[i] = new PostgisRowSelector( targetTable, targetField, fKeys, osa, ft );
    }
    return rowSelectors;
  }
