 ...
 */
public class WFSCapabilities_Impl extends OGCWebServiceCapabilities_Impl implements WFSCapabilities
{
   ...
   */
  protected WFSCapabilities_Impl( Capability capability, FeatureTypeList featureTypeList,
      String version, String updateSequence, Service service )
  {
   ...
   * DTD fragment must be supplied at the start of the XML capabilities
   * document, after the reference to the general WFS_Capabilities DTD.
   */
  ...
  public String exportAsXML()
  {
    ...
    try
    {
      ...
      if( http.getGetOnlineResources() != null )
      {
        ...
        {
          sb.append( "<Get onlineResource=\"" + http.getGetOnlineResources()[i].getProtocol()
      ...
      if( http.getPostOnlineResources() != null )
      {
        ...
        {
          sb.append( "<Post onlineResource=\"" + http.getPostOnlineResources()[i].getProtocol()
        ...
        if( meta != null )
        {
          for( int j = 0; j < meta.length; j++ )
          {
            ...
            sb.append( meta[j].getOnlineResource().getProtocol() + "://"
                ...
                + meta[j].getOnlineResource().getPort() + meta[j].getOnlineResource().getPath() );
