...
public class StatusCode_Impl implements StatusCode {
    ...
    /** Creates a new instance of StatusCode_Impl */
    public StatusCode_Impl(String progresscode) {
        setProgressCode(progresscode);
    }
    
    /** gets the attribute "progressCode".
     * available values are:
     * <ul><li>historicalArchive
     *     <li>obsolete
     *     <li>onGoing
     *     <li>planned
     *     <li>required
     *     <li>underdevelopment</ul>
     *
     */
