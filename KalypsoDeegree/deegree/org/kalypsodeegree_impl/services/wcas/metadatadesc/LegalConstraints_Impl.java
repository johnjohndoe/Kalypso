...
public class LegalConstraints_Impl implements LegalConstraints {
    ...
    public LegalConstraints_Impl(String[] otherconstraints,
    ...
    public PropertyRightsCode[] getPropertyRightsCode() {
        return (PropertyRightsCode[])propertyrightscode.toArray( new PropertyRightsCode[propertyrightscode.size()] );
    }
    ...
    public UseConstraintsCode[] getUseConstraintsCode() {
        return (UseConstraintsCode[])useconstraintscode.toArray( new UseConstraintsCode[useconstraintscode.size()] );
    }
