...
public final class WCASCapabilitiesFactory {
    ...
    /**
     * factory method for creating a <tt>WCASCapabilities</tt> object from
     * a file that contains XML capabilities document
     */ 
    public static synchronized WCASCapabilities createCapabilities(URL url)
     ...
     * a OGC WFS 1.0.0 conform XML capabilities document
     */
    public static synchronized WCASCapabilities createCapabilities(Document doc)
                                                                throws Exception {
        Debug.debugMethodBegin( "WCASCapabilitiesFactory", "createCapabilities" );
        ...
        WCASCapabilities capabilities =
            new WCASCapabilities_Impl( version, updateSequence, iso19119, capability,   
                                       schemaLocations );
    ...
    private static Capability getCapability(Element capElement) throws Exception {
        ...
        Capability capability = 
            new Capability_Impl( taxonomyTypeList, request, recordTypeList, 
                                 presentOptions, queryLanguages, federatedCatalogs, 
                                 exceptions, vendor );
    ...
    private static TaxonomyTypeList getTaxonomyTypeList(Element element) throws Exception
    {
        ...
        for (int i = 0; i < nl.getLength(); i++) {
            ...
            String name = 
                XMLTools.getNamedChild( elem,  namespace, "Name").getFirstChild().getNodeValue(); 
...
//    }
    ...
    private static RecordType[] getRecordTypes(NodeList nl) throws Exception
    {
        ...
        for (int i = 0; i < nl.getLength(); i++) {
            ...
            GM_Envelope bb = null;
            Element el = 
                (Element)elem.getElementsByTagNameNS( iso19115ns, "LatLonBoundingBox" ).item(0);            
            if ( el != null ) {
            ...
            RecordType rt = new RecordType_Impl( name, title, abstract_, crs,
                                                 bb, null, keywords, operations, 
                                                 metadataURLs, null, null );
            recordTypes[i] = rt;
        }
    ...
    private static FederatedCatalog[] getFederatedCatalogs(NodeList nl ) throws Exception
    {
        ...
        for (int i = 0; i < nl.getLength(); i++) {
            ...
            // get name of the record type
            String name = 
                XMLTools.getNamedChild( el,  namespace, "Name").getFirstChild().getNodeValue();
            // get title of the record type
    ...
    private static CException getExceptions(Element element )
    {
        ...
        CException exception = new CException_Impl( new String[] { s } );
