...
/**
 * This section defines the list of record types (and operations on each record type)
 * that are available from a web record server. Additional information, such as
 * SRS, about each record type is also provided.<p>
...
public class RecordTypeList_Impl implements RecordTypeList {
    ...
    /**
     * <ul>
     * <li>INSERT:  The <InsertRecord> element is used to indicate
     *				that the WFS is capable of creating new instances of
     *				a record type.
     * <li>UPDATE:  The <UpdateRecord> element indicates that the WFS can change the
     *				existing state of a record.
     * <li DELETE:  The <DeleteRecord> element indicates that the WFS can delete or
     * 				remove instances of a record type from the datastore.
     ...
     * </ul><p>
     * Operations can be defined globally for all record types or locally for
     * each specific record type. Local <Operations> specifications take
 ...
 * Initial revision
 *
 * Revision 1.1.1.1  2002/09/25 16:01:29  poth
 * no message
 *
