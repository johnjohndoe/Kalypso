...
/**
 * Factory class for creating WCTS_Protocol classes from a XML document
 * that's conform to the WCTS-specification.
 *
 * <p>----------------------------------------------------------------------</p>
 *
...
public final class WCTS_ProtocolFactory {
    ...
    public static synchronized GetCapabilitiesRequest createGetCapabilitiesRequest( String id, 
        ...
        GetCapabilitiesRequest createGetCapabilitiesRequest = 
        	createGetCapabilitiesRequest( id, vendorSpecificParameter );
    ...
    /**
     * factory method for creating a <tt>Transformable</tt> object from
     * a file that contains a WCTS-specification conform XML
     * transformable-request document.
     */
    ...
    /**
     * factory method for creating a <tt>Transformable</tt> object from
     * a WCTS-specification conform XML transformable-request document
     */
    public static synchronized IsTransformableRequest createIsTransformableRequest( String id, 
                                                                                    HashMap vendorSpecificParameter, 
                                                                                    Document doc )
        ...
        IsTransformableRequest istransformableRequest = new IsTransformableRequest_Impl( version, 
                                                                                         id, 
                                                                                         vendorSpecificParameter, 
                                                                                         sourceCRS, 
                                                                                         destinationCRS );
     ...
     */
    public static CS_CoordinateSystem getSourceCRS( Element element )
     ...
     * factory method for creating a <tt>Transformable</tt> object from
     * a file that contains a WCTS-specification conform XML
     * transformable-response document.
     */
    public static synchronized IsTransformableResponse createIsTransformableResponse( OGCWebServiceRequest request, 
                                                                                      OGCWebServiceException exception, 
    ...
    /**
     * factory method for creating a <tt>Transform</tt> object from
     * a file that contains a WCTS-specification conform XML
     * transform-request document.
     */
    public static synchronized TransformRequest createTransformRequest( String id, 
        ...
        Document doc = XMLTools.parse( reader );
        TransformRequest transformrequest = createTransformRequest( id, vendorSpecificParameter, 
                                                                    doc );
    ...
    /**
     * factory method for creating a <tt>Transform</tt> object from
     * a WCTS-specification conform XML transform-request document
     */
    public static synchronized TransformRequest createTransformRequest( String id, 
                                                                        HashMap vendorSpecificParameter, 
                                                                        Document doc )
        ...
        element = XMLTools.getNamedChild(root, "TransformationSequence");
        TransformationSequence[] transformationSequence = null;
        if (element != null)  {
                transformationSequence = getTransformationSequence(element);
        }
         */
     ...
     * factory method for creating a <tt>Transform</tt> object from
     * a file that contains a WCTS-specification conform XML
     * transform-response document.
     */
    public static synchronized TransformResponse createTransformResponse( OGCWebServiceRequest request, 
                                                                          OGCWebServiceException exception, 
                                                                          GMLGeometry[] data ) {
     ...
     */
    public static synchronized DescribeTransformationRequest createDescribeTransformationRequest( String id, 
                                                                                                  HashMap vendorSpecificParameter, 
                                                                                                  Reader reader )
        throws Exception {
    ...
    /**
     * factory method for creating a <tt>DescribeTransformationRequest</tt> object from
     * a WCTS-specification conform XML describetransformation-request document
     */
    public static synchronized DescribeTransformationRequest createDescribeTransformationRequest( String id, 
                                                                                                  HashMap vendorSpecificParameter, 
                                                                                                  Document doc )
        ...
        DescribeTransformationRequest createDescribeTransformationRequest = 
                new DescribeTransformationRequest_Impl( version, id, vendorSpecificParameter, 
                                                        format, sourceCS, destinationCRS );
     ...
     */
    public static synchronized DescribeTransformationResponse createDescribeTransformationResponse( OGCWebServiceRequest request, 
                                                                                                    OGCWebServiceException exception, 
        ...
        DescribeTransformationResponse createDescribeTransformationResponse = 
                new DescribeTransformationResponse_Impl( request, doc, parameterizedTransformation, 
    ...
    /**
     * replaces occurences of a string fragment within a string by
     * a new string.
     ...
     * @param all    if it's true all occurences of the string to be replaced
