...
/**
 * This class handles the GetCapabilities-request and creates the response which
 * includes the Capabilities of the service.
 * 
 * <p>
 * --------------------------------------------------------------------
 * </p>
  ...
  public void handleRequest( OGCWebServiceEvent request )
  {
    ...
    else
    {
      try
      {
        ...
        // responseobjekt erzeugen
        response = WCTS_ProtocolFactory.createGetCapabilitiesResponse( req, null, capabilities );
      }
      catch( Exception ex )
      {
