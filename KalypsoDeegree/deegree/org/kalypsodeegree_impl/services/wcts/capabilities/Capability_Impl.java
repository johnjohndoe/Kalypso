...
/**
 * This section of the Capabilities-document describes the operations
 * made available by the CTS. Apart from the operations defined as mandatory
...
public class Capability_Impl implements Capability {
    ...
    */
    ...
    /**
     * <p>In many cases, it is possible to perform a transformation
     * of coordinates from one reference system into another in different
     * (mathematical) kinds. Under normal conditions the CTS selects a 
     * suitable procedure on the basis the source and the target reference system
     * and accomplishes the transformation. For different reasons it can make sense
     * for a user to specify the transformation steps themselves.
     *
     * <p>default="false"
     */
    ...
    /**
     * A Coordinate transformation service (CTS) acts as
     * Web service, which knows the four different Requests
     */
    ...
    /**
     * <p>Each CTS must know at least one transformation-type. These
     * concern fundamental methods for the transformation of coordinates
     * out of a reference system into another. It <b>doesn't</b> concern
     * concrete transformations between two determined references system.
     * <p>Examples of kinds of transformation are: Longitude rotation,
     * Abridged Molodenski, Geocentric_to_Ellipsoid etc...
     */
    public KnownTransformationType[] getKnownTransformationTypes() {
        return (KnownTransformationType[])knownTransformationTypes.toArray( 
                         new KnownTransformationType[knownTransformationTypes.size()] );
    }
    ...
    */
    ...
    /**
     * Each CTS must know at least <b>two</b> spatial reference-System,
     * so that at least one transformation is possible.
     */
    public KnownCoordinateReferenceSystem[] getKnownCoordinateReferenceSystems() {
        return (KnownCoordinateReferenceSystem[])knownCoordinateReferenceSystems.toArray( 
                         new KnownCoordinateReferenceSystem[knownCoordinateReferenceSystems.size()] );
    }
    ...
    */
    ...
    /**
     * With the &lt;VendorSpecificCapabilities&gt; element,
     * it is possible to define additional Capabilities.
     */
    public String[] getVendorSpecificCapabilities() {
        return (String[])vendorSpecificCapabilities.toArray( 
                         new String[vendorSpecificCapabilities.size()] );
    }
