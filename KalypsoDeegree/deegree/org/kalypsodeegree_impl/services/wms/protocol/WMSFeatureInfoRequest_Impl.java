...
*/
public class WMSFeatureInfoRequest_Impl extends OGCWebServiceRequest_Impl
    implements WMSFeatureInfoRequest, Marshallable {
    ...
    WMSFeatureInfoRequest_Impl( String version, String id, String[] queryLayers, 
                                WMSGetMapRequest getMapRequestCopy, String infoFormat, 
                                int featureCount, Point clickPoint, String exceptions, 
                                StyledLayerDescriptor sld, HashMap vendorSpecificParameter ) {
    ...
    */
     ...
     * layers than the original GetMap request.<p></p>
    ...
    */
     ...
     * entire MIME type string in <Format> is used as the value of the INFO_FORMAT
     * parameter. In an HTTP environment, the MIME type shall be set on the
     * returned object using the Content-type entity header.<p></p>
    ...
    * HTTP GET-Request or a part of it will be transformed into a valid SLD.
    * For convenience it is asumed that the SLD names just a single layer to
