...
/**
 * The interface <Request> describes the acces to the available WMS operations. GetMap
...
class Request_Impl implements Request, Marshallable {
     ...
     * WMS doesn't support the desired operation <tt>null</tt> will
     * be returned.
     */
     ...
     * If the WMS doesn't support the desired operation <tt>null</tt> will
     * be returned.
     */
