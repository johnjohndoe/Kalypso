 ...
 * @version $Revision$
 */
public class WMSCapabilities_Impl extends OGCWebServiceCapabilities_Impl implements WMSCapabilities,
                                                                                    Marshallable {
    ...
    /**
     * The <Capability> element of the Capabilities XML names the actual
     * operations that are supported by the service instance, the output formats
     * offered for those operations, and the URL prefix for each operation.
     */
    ...
    public String exportAsXML() {
        ...
        sb.append( "<WMT_MS_Capabilities " )
          ...
          .append( "version=\"1.1.1\" updateSequence=\"1.1.0\">" );        

        if ( deegreeParam != null ) {
            sb.append( ( (Marshallable)deegreeParam ).exportAsXML() );
        }

        sb.append( ( (Marshallable)getService() ).exportAsXML() )
          .append( ( (Marshallable)capability ).exportAsXML() );
