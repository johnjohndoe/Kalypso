...
class UserDefinedSymbolization_Impl implements UserDefinedSymbolization, Marshallable {
    ...
    */
    UserDefinedSymbolization_Impl( boolean sldSupported, boolean userLayer, 
    ...
    /**
     * returns true if layer and/or style definition conform to SLD 
     * are supported.
     */
    ...
    */
    ...
    /**
     * returns true if the WMS enables the use of a remote (user defined)
     * WFS.
     */
    ...
    */
    ...
    public String exportAsXML() {
        ...
        sb.append( "<UserDefinedSymbolization" ).append( sldSupported ? " SupportSLD=\"1\"" : "" )
          .append( userLayer ? " UserLayer=\"1\"" : "" )
          .append( userStyle ? " UserStyle=\"1\"" : "" )
