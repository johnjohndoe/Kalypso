 ...
 * @version $Revision$
 */
public class DataURL_Impl extends BaseURL_Impl implements DataURL, Marshallable
{
  ...
  public String exportAsXML()
  {
    ...
    sb.append( "<DataURL>" ).append( "<Format>" ).append( XMLTools.validateCDATA( getFormat() ) )
        .append( "</Format>" ).append( "<OnlineResource " ).append(
            ...
            NetWorker.url2String( getOnlineResource() ) ).append( "\"/>" ).append( "</DataURL>" );
