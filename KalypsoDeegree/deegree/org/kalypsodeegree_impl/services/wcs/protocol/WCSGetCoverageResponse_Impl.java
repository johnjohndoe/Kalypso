...
/**
 * the class implements the response to a GetCoverage request against
 * a WCS.
 * <p>--------------------------------------------------------------------</p>
 * @author <a href="mailto:poth@lat-lon.de">Andreas Poth</a>
 * @version 2002-03-01
 */
class WCSGetCoverageResponse_Impl extends OGCWebServiceResponse_Impl
     ...
     * @param coverage 
     */
    WCSGetCoverageResponse_Impl(OGCWebServiceRequest request, Object coverage) {
        super(request, null);
        this.coverage = coverage;
    }

    /** returns the result (image) of a GetCoverage request serialized as byte
     * array.
     *
     */
