...
public class WCSCapabilitiesFactory {
    ...
    /**
     * factory method for creating a <tt>WCSCapabilities</tt> object from
     * a file that contains a OGC WCS 0.7 conform XML capabilities document
     */
    public static synchronized WCSCapabilities createCapabilities(URL url)
    ...
    /**
     * factory method for creating a <tt>WCSCapabilities</tt> object from
     * a OGC WCS 0.7 conform XML capabilities document
     */
    public static synchronized WCSCapabilities createCapabilities(Document doc) throws Exception {
        ...
        WCSCapabilities capabilities =
            new WCSCapabilities_Impl( version, updateSequence, service, cv);
    ...
    private static Service createService(Element serviceElement) {
        ...
        Service service = new Service_Impl(name, title, abstract_, keywords,
                                           onlineResource, null, fees, accessConstraints);
