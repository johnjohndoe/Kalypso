 ...
 * are defined at present: the value 'TC211' refers to [ISO 19115]; the value
 * 'FGDC' refers to [FGDC-STD-001-1988]. The MetadataURL element shall not be
 * used to reference metadata in a non-standardized metadata format
 * <p>
 * ----------------------------------------------------------------------
 * </p>
 * 
...
public class MetadataURL_Impl extends BaseURL_Impl implements MetadataURL, Marshallable
{
  ...
  public String exportAsXML()
  {
    ...
    sb.append( "<MetadataURL type=\"" ).append( type ).append( "\">" ).append( "<Format>" ).append(
        ...
        .append( "xmlns:xlink=\"http://www.w3.org/1999/xlink\" " ).append(
            ...
            NetWorker.url2String( getOnlineResource() ) ).append( "\"/>" )
        .append( "</MetadataURL>" );
