...
public class TileImageTree {
    ...
    public TileImageTree( String imageSource, String targetDir, String targetFormat, 
                          double[] targetResolutions, int startIndex, float quality, String crs )
                  throws Exception {
    ...
    public TileImageTree( String imageSource, String targetDir, String targetFormat, 
                          ...
                          String crs, double minx, double miny, double maxx, double maxy )
                  throws Exception {
        this.targetDir = targetDir;
        this.targetFormat = targetFormat.toLowerCase();
        this.quality = quality;
    ...
    */
    ...
    public void createTileImageTree() throws Exception {
        ...
        addGridCoverageLayer( root, tmp, tmp, crs, xmin, ymin, xmax, ymax, xmin, ymin, xmax, ymax, 
    ...
    */
    private void readBBoxFromGeoTIFF(RenderedOp rop) throws Exception {
        ...
        /*for (int i=0; i < tifDir.getFields().length; i++) {
            System.out.println(" tiff-tag: " + tifDir.getFields()[i].getTag() +
                " type: " + tifDir.getFields()[i].getType());
        }*/
        ...
        if ( (resx == 0.0 || resy == 0.0) || (val1 == 0.0 && val2 == 0.0 && 
            val4 == 0.0 && val5 == 0.0) ) {
...
System.out.println(yOrigin);            
    ...
    private static void printHelp() {        
        ...
        System.out.println( "-f: output format (gif, bmp, jpg, png, tif) default = jpg; " );
