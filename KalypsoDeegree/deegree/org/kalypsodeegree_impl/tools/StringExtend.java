...
/**
 * this is a collection of some methods that extends the functionallity
 * of the sun-java string class.
 */
public class StringExtend {
     ...
     * @param deleteDoubles if it's true all string that are already
    ...
    /**
     * transforms a string array to one string. the array fields are
     * seperated by the submitted delimiter:
     *
     * @param s stringarray to transform
     * @param delimiter
     */
    ...
    /**
     * transforms a double array to one string. the array fields are
     * seperated by the submitted delimiter:
     *
     * @param s stringarray to transform
     * @param delimiter
    ...
    /**
     * transforms a int array to one string. the array fields are
     * seperated by the submitted delimiter:
     *
     * @param s stringarray to transform
     * @param delimiter
    ...
    /**
     * clears the begin and end of a string from the strings
     * sumitted
     *
     * @param s string to validate
     * @param mark string to remove from begin and end of <code>s</code>
     */
     ...
     *
     * @param target array where to remove the submitted string
    ...
    /**
     * Extract all the string that begin with "start" and end with "end" and store it into
     * an array of String
     *
     * @param target 
     * @param startString 
    ...
    /**
     * extract a string contained between startDel and endDel, you can remove t
     * he delimiters if set true the parameters delStart and delEnd
     *
     * @param target 
     * @param startDel 
     * @param endDel 
