 ...
 * setting up on a web map context. this is a deegree specific form of
 * description. beside the name of the central controlling element an
 * implementing class enables access to fife areas the GUI is splitted in.
 * 
 * @version $Revision$
...
public interface Frontend
{
  ...
  /**
   * returns the name of the central controller of the front end. depending on
   * the implementation this may be the name of a HTML/JSP-page a java class or
   * something else.
   * 
   * @return
   */
  ...
  /**
   * sets the name of the central controller of the front end. depending on the
   * implementation this may be the name of a HTML/JSP-page a java class or
   * something else.
   * 
   * @param controller
   */
