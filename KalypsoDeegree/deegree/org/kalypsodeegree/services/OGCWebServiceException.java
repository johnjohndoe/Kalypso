...
/**
 * <p>A web feature server has to handle two classes of errors; exceptions 
 ...
 * WFS request (such as a transaction failure). This section deals with 
 * exceptions generated during the processing of a WFS request.
 * <p>Exceptions encountered during request execution are dealt with in subsequent 
 ...
 * error has occurred.
 * <p>The &lt;WFS_Exception&gt; tag can delimit one or more exception.details.
 ...
 * exist or is not defined, then the web feature server can attempt to
 ...
 * Initial revision
 *
 * Revision 1.4  2004/01/26 08:15:37  poth
 * no message
 *
 * Revision 1.3  2003/06/10 07:52:02  poth
 * no message
 *
 * Revision 1.2  2003/05/26 07:16:06  poth
 * no message
 *
 * Revision 1.1.1.1  2002/09/25 16:01:50  poth
 * no message
 *
 * Revision 1.2  2002/08/19 15:57:23  ap
 * no message
 *
 * Revision 1.1  2002/05/17 15:58:45  ap
 * no message
 *
 * Revision 1.4  2002/05/14 14:40:42  ap
 * no message
 *
