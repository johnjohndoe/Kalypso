 ...
 * the deegree frame work. I just defines one method for notifying a service that
 * it should perform its work.<p>
 * The event object submitted to <tt>doService</tt> shall contain informations
 * about the calling class and the request the should be performed by the service.
 * <p>--------------------------------------------------------------------</p>
...
public interface OGCWebService {
     ...
     * OGCWebServiceEvent in an new own Thread. The receiver of the response
     * to the request must implement the OGCWebServiceClient interface
     *
