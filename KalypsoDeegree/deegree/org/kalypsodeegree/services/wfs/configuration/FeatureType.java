...
public interface FeatureType
{
  ...
  /**
   * returns the names of the property a datastore field (alias) will be mapped
   * to
   */
  ...
  /**
   * returns the type of a named datastore fields The types are encoded like
   * defined at <tt>java.sql.types</tt>
   */
  int getDatastoreFieldType( String datastoreField );

  /**
   * Checks if a Property (XPath-expression or mapping) is known to the
   * datastore. XPath expressions (e.g. "/TABLE/FIELD") are only valid, if no
   * mappings are defined at all. Properties may be used if they are explicitly
   * defined in the datastore configuration.
   * <p>
   * 
   * @param property
