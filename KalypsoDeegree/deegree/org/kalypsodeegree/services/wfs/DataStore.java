...
/**
 * Interface describing the access to a data store that encapsulates
 * the access to concrete data sources like databases or files:
 *
 * <p>---------------------------------------------------------------------</p>
 *
...
public interface DataStore extends Handler {
   ...
   /**
    * registers a feature type to the data store. So the data shall be able 
    * to handle operations on the feature type.
    */	
