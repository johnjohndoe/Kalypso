...
public interface Tile
{
  ...
  /**
   * if the tiles are ordered at a quad tree or something like this an instance of <tt>Tile</tt> will contain one or
   * more <tt>Tile</tt> instances with a smaller bounding box.
   */
  Tile[] getTiles();
