...
public interface UserStyle extends Style{
   ...
   /**
    * Sets the Abstract.
    * @param abstract_ the abstract of the User-Style
    */
    ...
    * @param featureTypeStyles the FeatureTypeStyles of a User-Style
    */
    ...
    * @param featureTypeStyle a FeatureTypeStyle to remove
    */
