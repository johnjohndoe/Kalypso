...
public interface CT_CoordinateTransformationFactory extends Remote
{
   ...
   * systems is found, using the normal failing behavior of the DCP (e.g.
   ...
   */
  CT_CoordinateTransformation createFromCoordinateSystems( CS_CoordinateSystem sourceCS,
      CS_CoordinateSystem targetCS ) throws RemoteException;
}