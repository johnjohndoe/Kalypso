 ...
 * 
 * The math transform will transform positions in the source coordinate system
 * into positions in the target coordinate system.
 * 
 * @version 1.01
 * @since 1.00
 * @author Martin Daly
...
public interface CT_CoordinateTransformation extends Remote
{
  ...
  /**
   * Authority which defined transformation and parameter values. An Authority
   * is an organization that maintains definitions of Authority Codes. For
   * example the European Petroleum Survey Group (EPSG) maintains a database of
   * coordinate systems, and other spatial referencing objects, where each
  ...
  /**
   * Code used by authority to identify transformation. The AuthorityCode is a
  ...
  /**
   * Semantic type of transform. For example, a datum transformation or a
