...
public interface GC_ParameterInfo
{
  ...
  /**
   * Parameter type. The enumeration contains standard parameter types for
   * integer, string, floating-point numbers, objects, etc.
   */
  GC_ParameterType getType();

  /**
   * Default value for parameter. The type {@link Object}can be any type
   * including a {@link Number}or a {@link String}. For example, a filtering
   * operation could have a default kernel size of 3. If there is no default
   * value, defaultValue will be null.
   */
  Object getDefaultValue();

  /**
   * Minimum parameter value. For example, a filtering operation could have a
   * minimum kernel size of 3.
   */
  double getMinimumValue();

  /**
   * Maximum parameter value. For example, a filtering operation could have a
   * maximum kernel size of 9.
   */
