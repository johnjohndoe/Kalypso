...
public interface CS_CoordinateSystemFactory extends Remote
{
   ...
   *           if a remote method call failed.
   */
  CS_Ellipsoid createFlattenedSphere( String name, double semiMajorAxis, double inverseFlattening,
      CS_LinearUnit linearUnit ) throws RemoteException;
   ...
   *          Name to give new object.
   * @param angularUnit
   *          Angular units for created GCS.
   * @param horizontalDatum
   *          Horizontal datum for created GCS.
   * @param primeMeridian
   *          Prime Meridian for created GCS.
   * @param axis0
   *          Details of 0th ordinates in returned GCS coordinates.
   * @param axis1
