...
public interface CS_HorizontalDatum extends CS_Datum
{
   ...
   * arc-seconds, and scaling in parts-per-million. This method will always fail
   * for horizontal datums with type CS_HD_Other. This method may also fail if
   * no suitable transformation is available. Failures are indicated using the
   * normal failing behavior of the DCP (e.g. throwing an exception).
   * 
   * @throws RemoteException
   *           if a remote method call failed.
   */
