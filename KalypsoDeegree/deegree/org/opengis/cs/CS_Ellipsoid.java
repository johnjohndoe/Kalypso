...
public interface CS_Ellipsoid extends CS_Info
{
   ...
   * equatorial/polar radius by the formula <code>ivf=r<sub>e</sub>/(r<sub>e</sub>-r<sub>p</sub>)</code>. For
   * perfect spheres, this formula breaks down, and a special IVF value of zero is used.
   * 
   * @throws RemoteException
   *           if a remote method call failed.
   */
