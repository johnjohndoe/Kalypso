...
/**
 * A coordinate system based on latitude and longitude. Some geographic coordinate systems are Lat/Lon, and some are
 * Lon/Lat. You can find out which this is by examining the axes. You should also check the angular units, since not all
 * geographic coordinate systems use degrees.
 * 
 * @version 1.01
 * @since 1.00
 * @author Martin Daly
...
{
  /**
   * Returns the AngularUnit. The angular unit must be the same as the {@link CS_CoordinateSystem}units.
   * 
  ...
  /**
   * Gets details on a conversion to WGS84. Some geographic coordinate systems provide several transformations into
   * WGS84, which are designed to provide good accuracy in different areas of interest. The first conversion (with
   * index=0) should provide acceptable accuracy over the largest possible area of interest.
   * 
   * @param index
