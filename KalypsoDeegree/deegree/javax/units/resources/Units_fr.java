...
/**
 * Noms d'unités en langue française. Les unités qui n'apparaissent pas dans cette ressources ne seront pas localisées.
 * 
 * @version 1.0
...
{
  /**
   * Liste des unités en français. Les clés sont les symboles standards (sauf exception) des unités. Les valeurs sont
  ...
  static final String[] contents =
  {
      ...
      "unité astronomique",
      "inch",
      "pouce", // Symbole non-standard
      "foot",
      "pied", // Symbole non-standard
      "yard",
      "yard", // Symbole non-standard
      "fathom",
      "brasse anglaise", // Symbole non-standard
      "brasse",
      "brasse française", // Symbole non-standard
      "mile",
      "mille", // Symbole non-standard
      "nmile",
      "mille marin", // Symbole non-standard
      "knot",
      "noeud", // Symbole non-standard
      "are",
      "are",
      "ha",
      "hectare",
