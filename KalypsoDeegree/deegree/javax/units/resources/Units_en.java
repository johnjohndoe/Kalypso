...
/**
 * Noms d'unités en langue anglaise. Les unités qui n'apparaissent pas dans
...
{
  /**
   * Liste des unités en anglais. Les clés sont les symboles standards (sauf
   * exception) des unités. Les valeurs sont les noms en anglais de ces unités.
   */
  static final String[] contents =
  { "m", "metre", "g", "gram", "s", "second", "A", "ampere", "K", "kelvin", "mol", "mole", "cd",
      "candela", "rad", "radian", "sr", "steradian", "Hz", "hertz", "N", "newton", "Pa", "pascal",
      "J", "joule", "W", "watt", "C", "coulomb", "V", "volt", "F", "farad", "\u03A9", "Ohm", "S",
      "siemmens", "T", "tesla", "Wb", "weber", "lx", "lux", "Bq", "becquerel", "Gy", "gray", "Sv",
      "sievert", "H", "henry", "lm", "lumen", "min", "minute", "h", "hour", "d", "day", "°",
      "degree of angle", "'", "minute of angle", "\"", "seconde of angle", "l", "litre", "L",
      "litre", "t", "metric ton", "eV", "electronvolt", "u", "unified atomic mass unit", "ua",
      "astronomical unit", "inch", "inch", // Symbole non-standard
      ...
      "rem", "Jy", "jansky", "Torr", "torr", "atm", "standard atmosphere", "pound", "pound", // Symbole
      // non-standard
      "onze", "onze", // Symbole non-standard
      "°C", "Celcius degree", "°F", "fahrenheit" // Symbole non-standard
  };
