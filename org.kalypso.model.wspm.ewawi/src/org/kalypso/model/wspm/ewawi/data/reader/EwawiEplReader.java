...
public class EwawiEplReader extends AbstractEwawiReader
{
  ...
  protected void readTabs( final String[] tabs ) throws ParseException
  {
    ...
    // e Punktnummer bleibt leer bei Einzelpunkten (Punktnummer von Einzelpunkten ist in Feld q enthalten). Die Punktnummerierung hat innerhalb der Längsstruktur aufsteigend von der Mündung zur Quelle
    // mit jeweils eindeutigen Punktnummern zu erfolgen. Für die Stützpunkte von Längsstrukturen kann wenn nötig auch eine größere Feldlänge verwendet werden.
    ...
    // q Objektnummer (beliebige, eindeutige, von der Mündung zur Quelle aufsteigende Ganzzahl) Jeder Einzelpunkt erhält eine individuelle bis zu fünfstellige Objektnummer; Punkte, die einer
    // Längsstruktur angehören erhalten eine gemeinsame Objektnummer.
