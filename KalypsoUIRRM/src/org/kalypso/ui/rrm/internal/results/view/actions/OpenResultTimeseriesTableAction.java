 ...
 * @author Dirk Kuch
 */
public class OpenResultTimeseriesTableAction extends Action
{
  ...
  {
    m_url = url;
    setText( "÷ffne Tabellenansicht" );
    setToolTipText( "÷ffne Zeitreihen-Tabellenansicht" );
  ...
  public void runWithEvent( final Event event )
  {
    ...
    try
    {
      final ShowTimeseriesDialog dialog = new ShowTimeseriesDialog( shell, new MultipleUrlSourceElement( m_url ), context );
      dialog.open();
    }
