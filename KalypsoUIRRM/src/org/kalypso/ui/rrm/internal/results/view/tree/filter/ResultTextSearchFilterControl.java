 ...
 * @author Dirk Kuch
 */
public class ResultTextSearchFilterControl extends Composite
{

  static final RGB YELLOW = new RGB( 255, 255, 230 );

  private final ResultTextSearchFilter m_filter;
  ...
  public ResultTextSearchFilterControl( final Composite parent, final FormToolkit toolkit )
  {
    ...
    m_filter = new ResultTextSearchFilter( StringUtils.EMPTY );
  ...
  private void createSearchStringField( final Composite parent, final FormToolkit toolkit )
  {
    ...
    final IObservableValue model = PojoObservables.observeValue( m_filter, ResultTextSearchFilter.PROPERTY_STRING );
