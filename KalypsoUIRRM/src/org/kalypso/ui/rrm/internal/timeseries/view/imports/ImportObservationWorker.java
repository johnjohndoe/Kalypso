...
public class ImportObservationWorker implements ICoreRunnableWithProgress
{
  ...
  public ImportObservationWorker( final ImportObservationData data, final File fileSource )
  {
    m_data = data;
  ...
  public IStatus execute( final IProgressMonitor monitor ) throws CoreException
  {
    try
    {
      ...
      final IStatus status = nativeAdapter.doImport( m_fileSource, timezone, parameterType, false );
      m_observation = nativeAdapter.getObservation();
