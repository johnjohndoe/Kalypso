...
public class ConverterData
{
  ...
  void saveModel( final String path, final Feature model ) throws IOException, GmlSerializeException
  {
    /* REMARK: We assume that all files are 'UTF-8'. */
    GmlSerializer.serializeWorkspace( new File( m_baseDir, path ), model.getWorkspace(), "UTF-8" ); //$NON-NLS-1$
  }
}