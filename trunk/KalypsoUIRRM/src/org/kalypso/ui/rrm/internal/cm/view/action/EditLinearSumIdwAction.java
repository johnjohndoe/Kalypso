  ...
  public void runWithEvent( final Event event )
  {
    ...
    try
    {
      ...
      else
      {
        ...
        final String message = String.format( Messages.getString("EditLinearSumIdwAction.0"), status.getMessage() ); //$NON-NLS-1$
    ...
    {
      ex.printStackTrace();
      ErrorDialog.openError( shell, getText(), Messages.getString("EditLinearSumIdwAction.1"), ex.getStatus() ); //$NON-NLS-1$
    }
  }
}