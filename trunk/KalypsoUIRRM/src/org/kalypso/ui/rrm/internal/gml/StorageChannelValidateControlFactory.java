 ...
 */
public class StorageChannelValidateControlFactory implements IExtensionsFeatureControlFactory2
{
  @Override
  ...
  {
    return new StorageChannelValidateFeatureControl( feature, pt );
  }
}