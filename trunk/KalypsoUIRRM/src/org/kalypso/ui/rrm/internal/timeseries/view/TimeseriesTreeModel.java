...
public class TimeseriesTreeModel implements ITimeseriesTreeModel
{
  ...
  public TimeseriesNode[] getRootElements( )
  {
    if( m_nodes == null )
    {
      ...
      final TimeseriesNode rootNode = new StationsByStationsStrategy( this, m_stations ).buildNodes();
  ...
  public void refreshTree( final Object treeDataToSelect )
  {
    ...
    final TimeseriesNode nodeToSelect = new TimeseriesNode( this, null, null, treeDataToSelect );
