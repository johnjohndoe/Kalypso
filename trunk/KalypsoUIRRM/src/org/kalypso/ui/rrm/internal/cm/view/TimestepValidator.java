...
/**
 * The timestep validator.
 * 
 * @author Holger Albert
 */
public class TimestepValidator implements IValidator
{
  /**
   * The feature bean.
   */
   ...
   *          The feature bean.
   */
  public TimestepValidator( final FeatureBean<ILinearSumGenerator> featureBean )
  {
  ...
  {
    /* Get the timestep. */
    final Integer timestep = (Integer) value;
