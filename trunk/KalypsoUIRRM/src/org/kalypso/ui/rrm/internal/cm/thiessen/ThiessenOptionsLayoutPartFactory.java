 ...
 */
public class ThiessenOptionsLayoutPartFactory implements ILayoutPartFactory
{
  /**
   * @see org.kalypso.core.layoutwizard.ILayoutPartFactory#createLayoutPart(java.lang.String,
   *      org.kalypso.core.layoutwizard.ILayoutPageContext)
   */
  @Override
  public ILayoutPart createLayoutPart( final String id, final ILayoutPageContext context )
  {
    return new ThiessenOptionsLayoutPart( id, context );
  }
}