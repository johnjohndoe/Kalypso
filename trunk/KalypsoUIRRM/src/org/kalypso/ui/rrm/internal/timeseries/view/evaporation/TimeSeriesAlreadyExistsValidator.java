...
public class TimeSeriesAlreadyExistsValidator extends TypedValidator<String>
{
  ...
  {
    super( String.class, IStatus.ERROR, "Verdunstungszeitreihe mit gleicher Qualit‰t existiert bereits." );
    m_station = station;
    m_data = data;
  }
  ...
  protected IStatus doValidate( final String value ) throws CoreException
  {
    ...
    {
      if( type.isTypeOf( timeseries.getParameterType() ) )
        if( value.equalsIgnoreCase( timeseries.getQuality() ) )
          fail();
    }
