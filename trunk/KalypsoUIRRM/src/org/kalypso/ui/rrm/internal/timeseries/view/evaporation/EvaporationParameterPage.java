...
public class EvaporationParameterPage extends WizardPage implements IUpdateable
{
  ...
  private void renderWaterBased( final Composite page )
  {
    ...
    addTextControl( group, "Faktor Umrechnung j/cm² in W/m²", CalculateEvaporationData.PROPERTY_FACTOR_CONVERSION_JW, new StringAsDoubleValidator( IStatus.ERROR, "Umrechnungsfaktor ist kein gültiger Zahlenwert." ) );
    addTextControl( group, "Emissionskoeffizient", CalculateEvaporationData.PROPERTY_COEFFICIENT_EMISSION, new StringAsDoubleValidator( IStatus.ERROR, "Emissionskoeffizient ist kein gültiger Zahlenwert." ) );
    addTextControl( group, "Boltzmann Konstante (Wasser)", CalculateEvaporationData.PROPERTY_BOLTZMANN_WATER_CONSTANT, new StringAsDoubleValidator( IStatus.ERROR, "Boltzmann Konstante ist kein gültiger Zahlenwert." ) );
    addTextControl( group, "Albedo Wasserfläche", CalculateEvaporationData.PROPERTY_ALBEDO_WATER, new StringAsDoubleValidator( IStatus.ERROR, "Albedo ist kein gültiger Zahlenwert." ) );
