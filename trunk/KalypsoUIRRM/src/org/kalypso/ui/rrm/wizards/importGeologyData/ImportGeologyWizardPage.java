...
public class ImportGeologyWizardPage extends WizardPage implements SelectionListener, ModifyListener
{
  ...
  {
    super( Messages.get( "org.kalypso.ui.rrm.wizards.importGeologyData.ImportGeologyWizardPage.0" ), "", ImageProvider.IMAGE_UTIL_BERICHT_WIZ ); //$NON-NLS-1$ //$NON-NLS-2$
    setTitle( Messages.get( "org.kalypso.ui.rrm.wizards.importGeologyData.ImportGeologyWizardPage.2" ) ); //$NON-NLS-1$
    setDescription( Messages.get( "org.kalypso.ui.rrm.wizards.importGeologyData.ImportGeologyWizardPage.3" ) ); //$NON-NLS-1$
  ...
  public void createControl( final Composite parent )
  {
    ...
    new Label( container, SWT.NONE ).setText( Messages.get( "org.kalypso.ui.rrm.wizards.importGeologyData.ImportGeologyWizardPage.4" ) ); //$NON-NLS-1$
    ...
    btn_inputShpFileBrowse.setText( Messages.get( "org.kalypso.ui.rrm.wizards.importGeologyData.ImportGeologyWizardPage.11" ) ); //$NON-NLS-1$

    // Landuse property combo box
    new Label( container, SWT.NONE ).setText( Messages.get( "org.kalypso.ui.rrm.wizards.importGeologyData.org.kalypso.ui.rrm.wizards.importGeologyData.ImportGeologyWizardPage.12" ) ); //$NON-NLS-1$
    ...
    new Label( container, SWT.NONE ).setText( Messages.get( "org.kalypso.ui.rrm.wizards.importGeologyData.ImportGeologyWizardPage.14" ) ); //$NON-NLS-1$
  ...
  protected void updatePageComplete( )
  {
    ...
    {
      setMessage( null );
      setErrorMessage( Messages.get( "org.kalypso.ui.rrm.wizards.importGeologyData.ImportGeologyWizardPage.6" ) ); //$NON-NLS-1$
      return;
    }
    ...
    {
      setMessage( null );
      setErrorMessage( Messages.get( "org.kalypso.ui.rrm.wizards.importGeologyData.ImportGeologyWizardPage.10" ) ); //$NON-NLS-1$
      return;
    }
    setMessage( null );
    setErrorMessage( null );
