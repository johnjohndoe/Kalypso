...
public class WriteShapeTest extends TestCase
{
  ...
  public void testWriteShape( ) throws Exception
  {
    ...
    final IValuePropertyType doubleType = GMLSchemaFactory.createValuePropertyType( new QName( "anyNS", "aNumber" ), doubleTypeHandler.getTypeName(), doubleTypeHandler, 1, 1, false );
    final IValuePropertyType stringType = GMLSchemaFactory.createValuePropertyType( new QName( "anyNS", "aString" ), stringTypeHandler.getTypeName(), stringTypeHandler, 1, 1, false );
    final IValuePropertyType pointType = GMLSchemaFactory.createValuePropertyType( new QName( "anyNS", "aGeometry" ), pointTypeHandler.getTypeName(), pointTypeHandler, 1, 1, false );

    final IPropertyType[] properties = new IPropertyType[] { pointType, doubleType, stringType };
    final IFeatureType shapeFT = GMLSchemaFactory.createFeatureType( new QName( "anyNS", "shapeType" ), properties );
