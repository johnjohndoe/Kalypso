 ...
 * @author kuch
 */
public class ComponentUiStringHandler extends AbstractComponentHandler
{

  public ComponentUiStringHandler( final IComponent component )
  {
    super( component );
  ...
  private void mkeStyle( final IComponent component )
  {
