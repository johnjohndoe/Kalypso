...
public class FeatureAddActionDelegate implements IActionDelegate
{
  ...
  public void run( IAction action )
  {
    if( action.isEnabled() && m_selection != null )
    {
      ...
      final FeatureAssociationTypeProperty ftp = (FeatureAssociationTypeProperty)featureList.getParentFeatureTypeProperty();
      int pos = 0; // TODO get pos from somewhere
      final AddFeatureCommand command = new AddFeatureCommand( workspace, ftp.getAssociationFeatureType(), parentFeature, ftp.getName(), pos );
      try
      {
