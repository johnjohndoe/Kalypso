...
/**
 * A simple DataBean which actually wraps a DataHandler. It also has an identifier
 * in order to keep trace of it within the scope of the Observation service.
 * 
