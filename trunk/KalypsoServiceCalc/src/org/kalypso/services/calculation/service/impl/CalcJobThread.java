...
final class CalcJobThread extends Thread
{
  ...
  public CalcJobThread( final String id, final String description, final String typeID, final ICalcJob job,
      final ModelspecData modelspec, final DataHandler zipHandler, final CalcJobClientBean[] input,
