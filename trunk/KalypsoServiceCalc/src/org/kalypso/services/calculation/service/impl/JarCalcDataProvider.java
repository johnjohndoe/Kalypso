 ...
 * @author belger
 */
public class JarCalcDataProvider implements ICalcDataProvider
{
  ...
  public JarCalcDataProvider( final DataHandler zipHandler, final CalcJobClientBean[] input )
  {
  ...
  public URL getURLForID( final String id ) throws CalcJobServiceException
  {
    ...
    catch( final MalformedURLException e )
    {
      ...
      throw new CalcJobServiceException( "Ungültiger Pfad in Eingangsdaten", e );
    }
    catch( final IOException e )
    {
      e.printStackTrace();

      throw new CalcJobServiceException( "Konnte Eingangsdaten nicht lesen", e );
    }
  }
