...
public class OcsExportWizard extends Wizard implements IExportWizard
{
  ...
  {
    final IDialogSettings settings = KalypsoServiceObsClientPlugin.getDefault().getDialogSettings();
  ...
  public boolean performFinish()
  {
    ...
    try
    {
      srv = KalypsoServiceObsClientPlugin.getDefault().getObservationServiceProxy();
    }
    ...
    final MultiStatus ms = new MultiStatus( IStatus.ERROR, KalypsoServiceObsClientPlugin.getID(), 0,
