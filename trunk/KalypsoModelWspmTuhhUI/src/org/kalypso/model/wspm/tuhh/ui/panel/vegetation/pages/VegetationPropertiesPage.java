...
// {
// final boolean overwriteValues = MessageDialog.openQuestion( lnk.getShell(), "Overwrite",
// "Overwrite existing classes?" );
//
// final GuessRoughessClassesRunnable worker = new GuessRoughessClassesRunnable( getProfile(), getComponent().getId(),
// overwriteValues, Double.MAX_VALUE );
