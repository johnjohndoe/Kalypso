 ...
 */
public class RightBank extends AbstractFlowZoneType
{
  /**
  ...
  {
    return Messages.getString( "RightBank_0" ); //$NON-NLS-1$
  }
  ...
  public FlowZone createFlowZone( final IProfile profile )
  {
    ...
    final IProfilePointMarker leftMarker = tfMarkers[1];
    final IProfilePointMarker rightMarker = bvMarkers[1];
