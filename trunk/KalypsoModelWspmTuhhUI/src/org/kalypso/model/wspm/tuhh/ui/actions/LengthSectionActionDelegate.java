 ...
 * @author kimwerner
 */
public class LengthSectionActionDelegate extends ActionDelegate
{
  ...
  public void runWithEvent( final IAction action, final Event event )
  {
    ...
    final IWizard validateProfilesWizard = new CreateLengthSectionWizard( ws, foundProfiles, selectedProfiles );
