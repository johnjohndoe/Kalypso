...
/**
 * Helper that creates a set of {@link ProfileData}.<br/>
 * Sorts the {@link ProfileData} by discharge.
 *
 * @author Holger Albert
 */
class ProfileDataSetFactory
{
  /**
   * The sorted profile data.
   */
  private final SortedSet<ProfileData> m_profileSort = new TreeSet<>( new ProfileDataComparator() );
