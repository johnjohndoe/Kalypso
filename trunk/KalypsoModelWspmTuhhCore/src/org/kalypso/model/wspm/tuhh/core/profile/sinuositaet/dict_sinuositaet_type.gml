...
<gml:Dictionary xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 <gml:description>Dictionary for profile-building types. Subtype 'building'.</gml:description>
 <gml:name>Profile Building Type Dictionary</gml:name>

 <gml:dictionaryEntry>
    <swe:Phenomenon gml:id="SINUOSITAET">
     <gml:description/>
     <gml:name>%sinusitaet.name</gml:name>
    </swe:Phenomenon>
 </gml:dictionaryEntry>
