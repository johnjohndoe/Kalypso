 ...
 */
public class MaulProfileObjectData extends AbstractProfileObjectData
{
  ...
  public MaulProfileObjectData( final double bezugspunktX, final double bezugspunktY, final double hoehe, final double breite, final double sohlGefaelle, final double rauhheit )
  {
