...
public class ReevaluateResultAction extends Action
{
  ...
  public ReevaluateResultAction( final SelectResultWizardPage page, final ICommandTarget commandTarget, final IKalypsoLayerModell modell, final ICaseDataProvider<IModel> modelProvider )
  {
    m_page = page;
