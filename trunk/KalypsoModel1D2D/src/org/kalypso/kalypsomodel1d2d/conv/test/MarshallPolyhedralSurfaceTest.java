...
public class MarshallPolyhedralSurfaceTest extends TestCase
{
  ...
  {
    List<GM_Polygon> polygons = createPolygons();
    GM_PolyhedralSurface_Impl<GM_Polygon> surface = new GM_PolyhedralSurface_Impl<GM_Polygon>( polygons, crs );
  ...
  private List<GM_Polygon> createPolygons( ) throws Exception
  {
    GM_Position[] ring1 = new GM_Position[]{pos1, pos2, pos3, pos1};
    GM_Position[] ring2 = new GM_Position[]{pos3, pos4, pos5, pos6, pos3};
    
    List<GM_Polygon> list = new ArrayList<GM_Polygon>(2);
