...
public class WindDataDWDVectorReader implements IWindDataCollectionReader
{
  ...
  private final String m_strFileTypeDWDLine = ""; //$NON-NLS-1$
  ...
  private void parseDataLine( final String strActLine, final ActTimeStepLineDescriptor actBlockDescriptor )
  {
  ...
  private Date parseDateLine( )
  {
    ...
    final StringTokenizer lStringTokenizer = new StringTokenizer( m_strTimeStepLine, "=" ); //$NON-NLS-1$
  ...
  private boolean readHeader( )
  {
    ...
    m_listElementPropId = new ArrayList<>();
        ...
        else
        {
          switch( lIntDataInputsCounter )
          {
            ...
            case 3:
              ...
              break;
            case 4:
              final StringTokenizer lStrTokenizerElementDataAsStrings = new StringTokenizer( lStrActLine, " \t" ); //$NON-NLS-1$
              ...
              break;
            case 5:
              final StringTokenizer lStrTokenizerTimeAdditionlInfoAsStrings = new StringTokenizer( lStrActLine, " \t" ); //$NON-NLS-1$
              final int lIntCountTokens = lStrTokenizerTimeAdditionlInfoAsStrings.countTokens();
...
//    }
    ...
    {
      final StringTokenizer lStringTokenizer = new StringTokenizer( pStrRawLine, " =\t" ); //$NON-NLS-1$
      lStringTokenizer.nextToken();
