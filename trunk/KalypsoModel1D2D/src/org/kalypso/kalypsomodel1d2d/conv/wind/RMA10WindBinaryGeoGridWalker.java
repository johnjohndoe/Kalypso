...
//  private static final double DOUBLE_DEFAULT_IGNORE_VALUE = -9999.;

  private static final double DOUBLE_DEFAULT_SCALE_VALUE = 1.0;

  private List< GM_Position > m_listWrittenPositions;
  ...
  public RMA10WindBinaryGeoGridWalker( final GM_Envelope pGMEnvelope, final Formatter pFormatter, final RectifiedGridDomain pGridDescriptorOrig )
  {
    ...
    m_listWrittenPositions = new ArrayList<GM_Position>();
  ...
  public void operate( int x, int y, Coordinate c ) throws GeoGridException
  {
    ...
    Pair<Double, Double> lPairSpeedDirection = NativeWindDataModelHelper.convertVectorWindToSpeedAndDirection( lPairVectorNativeWindValues );
