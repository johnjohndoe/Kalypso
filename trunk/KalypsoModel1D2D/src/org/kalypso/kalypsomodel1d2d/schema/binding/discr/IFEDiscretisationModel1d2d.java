...
public interface IFEDiscretisationModel1d2d extends IModel
{
  ...
  QName WB1D2D_PROP_ELEMENTS = new QName( UrlCatalog1D2D.MODEL_1D2D_NS, "element" ); //$NON-NLS-1$

  QName WB1D2D_PROP_MESH = new QName( UrlCatalog1D2D.MODEL_1D2D_NS, "mesh" ); //$NON-NLS-1$
