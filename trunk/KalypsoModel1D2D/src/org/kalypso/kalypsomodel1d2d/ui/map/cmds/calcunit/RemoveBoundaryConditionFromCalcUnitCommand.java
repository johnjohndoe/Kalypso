...
public class RemoveBoundaryConditionFromCalcUnitCommand implements IFeatureChangeCommand
{
  ...
  private final IBoundaryCondition m_boundaryCondition;

  private final IFEDiscretisationModel1d2d m_model1d2d;

  private boolean m_done = false;

  public RemoveBoundaryConditionFromCalcUnitCommand( final IBoundaryCondition boundaryCondition, final ICalculationUnit calculationUnit, final IFEDiscretisationModel1d2d model1d2d )
  {
  ...
  private final void fireProcessChanges( )
  {
    ...
    final GMLWorkspace calUnitWorkspace = calUnitFeature.getWorkspace();
    final FeatureStructureChangeModellEvent event = new FeatureStructureChangeModellEvent( calUnitWorkspace, model1d2dFeature, features.toArray( new Feature[features.size()] ), FeatureStructureChangeModellEvent.STRUCTURE_CHANGE_DELETE );
