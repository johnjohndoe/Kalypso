...
{
  // TODO: ugly, remove
  private final CreateMainChannelComposite m_composite;

  private final CreateChannelData m_data;

  public CreateMainChannelApplyAction( final CreateChannelData data, final CreateMainChannelComposite composite )
  {
    m_data = data;
