...
public class GMLPoolLoader
{
   ...
   *          The filename.
   */
  public void load( IFolder path, String filename ) throws Exception
  {
    /* The url context. */
    URL context = ResourceUtilities.createURL( path );

    /* Create the pool key. */
    m_poolKey = new PoolableObjectType( "gml", filename, context );
   ...
   */
  public static CommandableWorkspace getWorkspace( IFolder path, String filename ) throws Exception
  {
    /* The url context. */
    URL context = ResourceUtilities.createURL( path );

    /* Create the pool key. */
    PoolableObjectType poolKey = new PoolableObjectType( "gml", filename, context );
