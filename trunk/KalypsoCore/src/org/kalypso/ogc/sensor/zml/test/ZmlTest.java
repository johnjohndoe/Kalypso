...
public class ZmlTest extends TestCase
{
      ...
      ParseException
  {
    ...
    assertTrue( dc.compare( values.getElement( 0, vAxis1 ), Double
        .valueOf( "1.0" ) ) == 0 );
    ...
    assertTrue( dc.compare( values.getElement( 20, vAxis1 ), Double
        .valueOf( "16.6" ) ) == 0 );
    assertTrue( dc.compare( values.getElement( 20, vAxis2 ), Double
        .valueOf( "18.5" ) ) == 0 );
  }
      ...
      ParseException
  {
    ...
    assertTrue( dc.compare( values.getElement( i, vAxis1 ), Double
        .valueOf( "44" ) ) == 0 );
