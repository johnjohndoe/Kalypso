...
public interface INaProjectConstants
{
  ...
  String GML_HYDROTOP_PATH = FOLDER_MODELS + "/" + GML_HYDROTOP_FILE;

  String GML_SYNTH_N_FILE = "synthN.gml";//$NON-NLS-1$

  String GML_SYNTH_N_PATH = FOLDER_MODELS + "/" + GML_SYNTH_N_FILE;

  String GML_GEOLOGIE_FILE = "geologie.gml";//$NON-NLS-1$

  String GML_GEOLOGIE_PATH = FOLDER_MODELS + "/" + GML_GEOLOGIE_FILE;
  ...
  String GML_PARAMETER_PATH = FOLDER_MODELS + "/" + GML_PARAMETER_FILE;
