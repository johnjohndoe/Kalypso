...
public class TimeseriesMappingCollection extends UnversionedModel
{
  ...
  private final IFeatureBindingCollection<Geology> m_timeseriesMappingMembers;
  ...
  public TimeseriesMappingCollection( final Object parent, final IRelationType parentRelation, final IFeatureType ft, final String id, final Object[] propValues )
  {
    ...
    m_timeseriesMappingMembers = new FeatureBindingCollection<Geology>( this, Geology.class, MEMBER_TIMESERIES_MAPPING );
  }

  public IFeatureBindingCollection<Geology> getTimeseriesMappings( )
  {
