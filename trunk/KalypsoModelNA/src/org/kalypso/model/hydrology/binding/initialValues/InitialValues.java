...
public class InitialValues extends Feature_Impl
{
  ...
  public synchronized IFeatureBindingCollection<Catchment> getCatchments( )
  {
    if( m_catchments == null )
      m_catchments = new FeatureBindingCollection<>( this, Catchment.class, MEMBER_CATCHMENT );
  ...
  {
    if( m_channels == null )
      m_channels = new FeatureBindingCollection<>( this, Channel.class, MEMBER_CHANNEL );
