 ...
 * @author Dirk Kuch
 */
public class QqRelationObservationBuilder
{
  Set<QqRelationRow> m_rows = new TreeSet<>( QqRelationRow.COMPARATOR );
  ...
  {
    m_rows.add( new QqRelationRow( discharge, dischargeRetentionBasin ) );
  }

  public IObservation getObservation( )
  {
    final SimpleTupleModel model = new SimpleTupleModel( new IAxis[] { getDischargeAxis(), getRetentionBasinDichargeAxis() } );
    for( final QqRelationRow row : m_rows )
    {
