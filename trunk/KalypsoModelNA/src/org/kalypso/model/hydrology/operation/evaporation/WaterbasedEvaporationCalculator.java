...
public class WaterbasedEvaporationCalculator implements ICoreRunnableWithProgress
{
  ...
  public IStatus execute( final IProgressMonitor monitor )
  {
    ...
    // iterate over values of the given date range
    while( ptr.before( to ) || ptr.equals( to ) )
    {
      final TupleModelDataSet humidity = getDataSet( m_humidity, ptr, ITimeseriesConstants.TYPE_MEAN_HUMIDITY );
      final TupleModelDataSet sunshine = getDataSet( m_sunshine, ptr, ITimeseriesConstants.TYPE_MEAN_SUNSHINE_HOURS );
      final TupleModelDataSet temperature = getDataSet( m_temperature, ptr, ITimeseriesConstants.TYPE_MEAN_TEMPERATURE );
      final TupleModelDataSet windVelocity = getDataSet( m_windVelocity, ptr, ITimeseriesConstants.TYPE_MEAN_WIND_VELOCITY );
