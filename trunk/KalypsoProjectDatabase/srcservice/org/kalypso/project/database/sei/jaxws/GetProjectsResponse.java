...
@XmlRootElement(name = "getProjectsResponse", namespace = "http://sei.database.project.kalypso.org/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getProjectsResponse", namespace = "http://sei.database.project.kalypso.org/")
