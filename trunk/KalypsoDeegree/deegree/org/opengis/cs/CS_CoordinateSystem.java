...
/**
 * Base interface for all coordinate systems. A coordinate system is a
 * mathematical space, where the elements of the space are called positions.
 * Each position is described by a list of numbers. The length of the list
 * corresponds to the dimension of the coordinate system. So in a 2D coordinate
 * system each position is described by a list containing 2 numbers. <br>
 * <br>
