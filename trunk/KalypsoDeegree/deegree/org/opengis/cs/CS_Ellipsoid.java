...
public interface CS_Ellipsoid extends CS_Info
{
   ...
   * <code>ivf=r<sub>e</sub>/(r<sub>e</sub>-r<sub>p</sub>)</code>. For
   * perfect spheres, this formula breaks down, and a special IVF value of zero
   * is used.
   * 
   * @throws RemoteException
   *           if a remote method call failed.
  ...
  /**
   * Returns the LinearUnit. The units of the semi-major and semi-minor axis
   * values.
   * 
   * @throws RemoteException
   *           if a remote method call failed.
