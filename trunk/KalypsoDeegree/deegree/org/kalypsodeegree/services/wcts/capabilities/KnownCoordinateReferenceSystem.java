 ...
 * KnownCoordinateReferenceSystem >. Transformation types deal with the
 * fundamental methods to transform coordinates from one reference system to
 * another. Transformation types are not for performing a concrete
 * transformation between two particular reference systems.
 * <p>
 * ----------------------------------------------------------------------
 * </p>
 * 
