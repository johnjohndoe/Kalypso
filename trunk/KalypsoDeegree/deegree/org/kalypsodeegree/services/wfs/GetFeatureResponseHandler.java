...
public interface GetFeatureResponseHandler {
    /**
     * the method handles the response of the WFSDispatcher and write it to the
     * submittetd <tt>OutputStream</tt>
     */
    void handleResponse( WFSGetFeatureResponse response, OGCWebServiceClient out, 
