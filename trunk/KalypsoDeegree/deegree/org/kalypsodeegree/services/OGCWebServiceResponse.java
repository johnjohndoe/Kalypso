 ...
 * requests. Each class that capsulates a response within an OWS has to
...
public interface OGCWebServiceResponse
{
   ...
   */
  Document getException();

  /**
   * sets an XML encoding of the exception that raised. If no exception raised
   * <tt>null</tt> will be returned.
   */
  void setException( Document exception );
