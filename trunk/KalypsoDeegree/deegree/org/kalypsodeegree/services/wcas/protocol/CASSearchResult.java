 ...
 * GetRecord request. The part of a GetRecord request capsulated by a
 * <tt>CASSearchResult</tt> is defined by one of the queries defined
 * within.
 * <p>--------------------------------------------------------------------</p>
...
public interface CASSearchResult {
   ...
   /**
    * returns the number of records contained within the <tt>CASSearchResult</tt>s.
    */	
 ...
 * Initial revision
 *
 * Revision 1.2  2004/02/09 07:57:02  poth
 * no message
 *
 * Revision 1.1.1.1  2002/09/25 16:01:55  poth
 * no message
 *
 * Revision 1.2  2002/08/19 15:57:11  ap
 * no message
 *
 * Revision 1.1  2002/08/08 07:08:57  ap
 * no message
 *
 */
