...
public interface Cache {	
   ...
   /**
    * sets the maximal time (milliseconds) an entry will be stored within
    * the cache without being called. If an entry is called through the 
    * get-method the timestamp will be refreshed.
    */		
	public void setMaxLifeTime(int maxLifeTime);
	
   /**
    * sets the maximal time (milliseconds) an entry will be stored within
    * the cache without being called. 
    */	
