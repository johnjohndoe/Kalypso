...
public interface GMLLinearRing extends GMLGeometry
{
  ...
  /**
   * @see #getCoord() a exception should be thrown if the coords are not homogen or the coords are not building a closed
   *      ring.
   */
  ...
  /**
   * @see #getCoord() a exception should be thrown if the coords are not building a closed ring.
   */
