...
/**
 *  class containing factory methods for creating GML-Objects
 *  from DOM-Elements and GM_XXXX geometries.
 *
 * <p>----------------------------------------------------------</p>
 *
...
public class GMLFactory {
     ...
     * @param geo geometry
     */
    public synchronized static GMLGeometry createGMLGeometry( GM_Object geo )
                                                      throws GMLException {
    ...
    private static GMLMultiLineString createGMLMultiLineString( GM_MultiCurve geo,
        ...
        GMLMultiLineString gmlMLineString = GMLMultiLineString_Impl.createGMLMultiLineString(
                                                    doc.getDocument() );
     ...
     * creates a GMLFeature from a XML Element
     */
    public static GMLFeature createGMLFeature( Document doc, Feature feature )
                                       throws GMLException {
 ...
 * Initial revision
 *
 * Revision 1.8  2004/03/29 10:37:13  poth
 * no message
 *
 * Revision 1.7  2004/02/18 14:55:25  poth
 * no message
 *
 * Revision 1.6  2004/01/22 07:49:29  poth
 * no message
 *
 ...
 * no message
 *
 * Revision 1.3  2003/04/17 11:23:45  axel_schaefer
 * wrong debug-end message in createGMLGeometry(Element)
 *
 ...
 * no message
 *
 * Revision 1.10  2002/08/19 15:59:29  ap
 * no message
 *
 * Revision 1.9  2002/08/05 16:11:02  ap
 * no message
 *
 * Revision 1.8  2002/08/01 08:56:56  ap
 * no message
 *
 */
