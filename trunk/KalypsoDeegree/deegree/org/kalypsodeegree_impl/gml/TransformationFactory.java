 ...
 * returns can be used for the transforming. Incoming Data can either be
 * <tt>CoordinateSystem</tt> or <tt>String</tt>.
 * 
 * @version 1.1
...
public class TransformationFactory
{
   ...
   * moment only transformations between geographic coordinate systems and
   ...
   * 
   * public static void main (String [] args) { TransformationFactory fac = new
