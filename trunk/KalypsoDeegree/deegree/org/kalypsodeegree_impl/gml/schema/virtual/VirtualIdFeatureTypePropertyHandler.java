...
public class VirtualIdFeatureTypePropertyHandler implements VirtualFeatureTypePropertyHandler
{

  /**
   * TypeHandler for virtual property that shows the features ID
   * 
   * @author doemming
   */
  public VirtualIdFeatureTypePropertyHandler( )
  {
    super();
  }
  ...
  {
    return new VirtualFeatureTypeProperty[] { new VirtualIdFeatureTypeProperty( ft.getQName() ) };
  }
}