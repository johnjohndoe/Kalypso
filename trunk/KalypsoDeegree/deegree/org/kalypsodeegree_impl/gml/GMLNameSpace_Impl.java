...
public class GMLNameSpace_Impl implements GMLNameSpace {
    ...
    /**
     * returns the name of the name space. <p>
     * if the name space is 'xmlns:gml="http://www.opengis.net/gml"',
     * 'xmlns' will be returned
     */
    ...
    /**
     * returns the name of the sub space.<p>
     * if the name space is 'xmlns:gml="http://www.opengis.net/gml"',
     * 'gml' will be returned
     */
    ...
    /**
     * returns the value of the name space.<p>
     * if the name space is 'xmlns:gml="http://www.opengis.net/gml"',
