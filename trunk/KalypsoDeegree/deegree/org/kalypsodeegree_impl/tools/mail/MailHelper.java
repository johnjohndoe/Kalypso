...
public abstract class MailHelper {
     ...
     */
    public static synchronized void createAndSendMail(MailMessage eMess, 
                                                      String mailHost) throws SendMailException {
        ...
        try {
            ...
            msg.setRecipients(Message.RecipientType.TO, 
                              InternetAddress.parse(eMess.getReceiver(), false));
