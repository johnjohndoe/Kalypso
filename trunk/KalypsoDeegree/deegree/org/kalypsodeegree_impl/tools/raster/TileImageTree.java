...
public class TileImageTree
{
  ...
  /** Creates a new instance of TileImageTree */
  public TileImageTree( String imageSource, String targetDir, String targetFormat,
      double[] targetResolutions, int startIndex, float quality, String crs, double minx,
  ...
  public static void main( String[] args )
  {
    ...
    try
    {
      TileImageTree tit = new TileImageTree( inFile, outDir, format, targetResolutions, startIndex,
          quality, crs );
