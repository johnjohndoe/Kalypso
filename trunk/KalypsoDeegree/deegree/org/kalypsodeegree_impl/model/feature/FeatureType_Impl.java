...
class FeatureType_Impl implements FeatureType, Serializable {
    ...
    public FeatureType_Impl(FeatureType[] parents, FeatureType[] children,
    ...
    /**
     * returns the direct parents of the FeatureType. If it
     * hasn't a parent null should be returned
     */
