 ...
 *          <p>
 */
public class GridExtentDescription_Impl extends DomainSetExtentDescription_Impl implements
    GridExtentDescription
{
  ...
  public GridExtentDescription_Impl( SpatialExtent spatialExtent, int dimension,
      TemporalExtent temporalExtent, ElevationExtent elevationExtent, Grid grid,
      GridAxisDescription gridAxisDescription, GridSpacing gridSpacing )
  {
  ...
  public GridExtentDescription_Impl( SpatialExtent spatialExtent, int dimension,
      TemporalExtent temporalExtent, ElevationExtent elevationExtent, RectifiedGrid rectifiedGrid,
      GridAxisDescription gridAxisDescription, GridSpacing gridSpacing )
  {
    super( spatialExtent, dimension, temporalExtent, elevationExtent );
