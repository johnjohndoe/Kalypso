...
public class DomainSetExtentDescription_Impl implements DomainSetExtentDescription {
    ...
    /** First, a required SpatialExtent element lists the bounds along each of
     * the spatial dimensions within which coverages may be requested from a
     * overage layer.
     *
     */
     ...
     * times for which coverages may be requested from a coverage layer. These
     * may consist of one or more intervals or points in time.
     * <p>
