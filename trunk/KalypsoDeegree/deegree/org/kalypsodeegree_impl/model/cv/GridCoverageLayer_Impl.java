...
class GridCoverageLayer_Impl extends CoverageLayer_Impl implements GridCoverageLayer
{
  ...
  GridCoverageLayer_Impl( String layerID, String title, String abstract_, String[] keywordList,
      ...
      GridExtentDescription gridExtentDescription, URL descriptorResource,
      RangeSetDescription rangeSetDescription )
  {
    super( layerID, title, abstract_, keywordList, latLonBoundingBox, crs, nativeCRS, metadataURLs,
        supportedFormatList, supportedInterpolationList, gridExtentDescription, descriptorResource );
  ...
  GridCoverageLayer_Impl( String layerID, String title, String abstract_, String[] keywordList,
      ...
      GridExtentDescription gridExtentDescription, RangeSetDescription rangeSetDescription )
  {
