...
/**
 * Flags indicating parts of domain covered by a convex hull. These flags can be combined. For example, the enum
 * <code>{@link #INSIDE}.or({@link #OUTSIDE})</code> means that some parts of the convex hull are inside the
...
public final class DomainFlags extends EnumeratedParameter
{
  ...
  /**
   * Initialize {@link #ENUMS}during class loading. This code must be done before we initialize public fields.
   */
  static
  {
  ...
  /**
   * Returns enum's names in the specified locale. For example if this enum has value "3", then <code>getNames</code>
  ...
  /**
   * Use a single instance of {@link DomainFlags}after deserialization. It allow client code to test
