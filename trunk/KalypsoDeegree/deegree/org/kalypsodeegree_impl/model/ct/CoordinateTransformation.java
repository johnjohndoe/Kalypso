...
import org.kalypsodeegree_impl.model.cs.Info;
...
public class CoordinateTransformation extends Info
{
   ...
   * @author Martin Desruisseaux
   */
  //    final class Export extends RemoteObject implements
  // CT_CoordinateTransformation,
  //                                                       Serializable
  final class Export implements CT_CoordinateTransformation, Serializable

  {
    /**
     * The originating adapter.
     */
    protected transient final Adapters adapters;
