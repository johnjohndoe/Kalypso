 ...
 * The use of halos greatly improves the readability of text labels.
 * <p>
...
public class Halo_Impl implements Halo, Marshallable {
     ...
     * <p>
     * @param radius radius to be used for the halo, use null for a rectangle
     *        styled halo
     * @param fill defines the fill style, use null for default style
     * @param stroke defines the stroke style, use null for default style
     */
     ...
     * <p>
     * @param fill defines the fill color and pattern
     */
     ...
     * edge of a font glyph to extend the area of coverage of the glyph (and
     * the inside edge of holes in the glyphs). The halo of a text label is
     ...
     * edge of a font glyph to extend the area of coverage of the glyph (and
     * the inside edge of holes in the glyphs). The halo of a text label is
     * considered to be a single shape. The default radius is one pixel. Negative
     ...
     * <p>
     * @param radius radius to be set for the halo
     */
     ...
     * <p>
     * @param stroke defines the stroke color and pattern
     */
