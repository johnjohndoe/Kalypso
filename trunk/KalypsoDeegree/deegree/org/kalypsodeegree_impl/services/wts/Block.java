...
public class Block extends Group
{
  ...
  public Block( float x, float y, float xsize, float ysize, float base, float height, float rotation )
  {
    addChild( addObject( x, y, xsize, ysize, base, height, rotation ) );
  }

  public Block( float x, float y, float xsize, float ysize, float base, float height,
      float rotation, String textureSource )
  {
  ...
  public Block( float x, float y, float xsize, float ysize, float base, float height,
      float rotation, BufferedImage texture )
  {
  ...
  public Group addObject( float x, float z, float xsize, float ysize, float base, float height,
      float rotation )
  {
