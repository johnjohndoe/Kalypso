...
public class WTSConfigurationFactory
{
  ...
  public static WTSConfiguration createConfiguration( String configFileURL )
      throws MalformedURLException, XMLParsingException, IOException, SAXException,
  ...
  public static WTSConfiguration createConfiguration( URL url ) throws MalformedURLException,
      XMLParsingException, IOException, SAXException, InvalidAxisDefinitionException
  {
    ...
    for( int i = 0; i < nl.getLength(); i++ )
    {
      createFeatureCollection( (Element)nl.item( i ), sourceTypes, formatNames, featureTextures,
          responsibleServices );
    }
    ...
    WTSConfiguration config = new WTSConfiguration_Impl( sourceTypes, formatNames, featureTextures,
  ...
  private static void createLayer( Element layer, HashMap sourceTypes, HashMap formatNames,
      HashMap responsibleServices ) throws MalformedURLException, XMLParsingException, IOException,
      SAXException, InvalidAxisDefinitionException
  {
  ...
  private static void createFeatureCollection( Element layer, HashMap sourceTypes,
      HashMap formatNames, HashMap textures, HashMap responsibleServices )
      throws MalformedURLException, XMLParsingException, IOException, SAXException,
      InvalidAxisDefinitionException
  {
    ...
    for( int i = 0; i < nl.getLength(); i++ )
    {
      String associatedFeature = XMLTools.getRequiredAttrValue( "associatedFeature", nl.item( i ) );
  ...
  private static HashMap createBackgrounds( NodeList nl ) throws MalformedURLException,
      XMLParsingException, IOException, SAXException
  {
