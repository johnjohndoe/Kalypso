 ...
 * fog, rain etc.) and additional light placed into the scene (e.g. street
...
public class WTSScene_Impl implements WTSScene
{
   ...
   * @param feature
   *          feature that shall be published in the scene
   * @param viewPoint
   *          object that describes the viewers position and the point he looks
   *          at
   */
   ...
   *          at
   * @param calendar
   *          describtion of the date and time for which the scene shall be
   *          rendered --> light conditions
   */
  public WTSScene_Impl( Shape3D[] terrain, Group[] feature, ViewPoint viewPoint, Calendar calendar )
  {
   ...
   *          rendered --> light conditions
   * @param conditions
   *          atmospheric conditions like fog, dust, rain etc. of the scene
   */
  public WTSScene_Impl( Shape3D[] terrain, Group[] feature, ViewPoint viewPoint, Calendar calendar,
   ...
   */
  public WTSScene_Impl( Shape3D[] terrain, Group[] feature, ViewPoint viewPoint, Calendar calendar,
      AtmosphericCondition[] conditions, Light[] lights )
  {
   ...
   *          spots etc.)
   * @param background
   *          scene background; have to be a <tt>Shape3D</tt> or a
   *          <tt>Background</tt>
   */
  public WTSScene_Impl( Shape3D[] terrain, Group[] feature, ViewPoint viewPoint, Calendar calendar,
      AtmosphericCondition[] conditions, Light[] lights, Object background )
  {
    if( feature != null )
    {
  ...
  private void createDayLight()
  {
    ...
    //Directional Light: A DirectionalLight node defines an oriented light with
    // an origin at infinity.
    DirectionalLight headlight = new DirectionalLight();
    headlight.setInfluencingBounds( light_bounds );
    headlight.setColor( white );
    headlight.setDirection( (float)Math.sin( hPos ), -(float)Math.sin( vPos ), (float)Math
        .abs( Math.cos( hPos ) ) );
    lights.add( headlight );
    //Ambient Light: Ambient light is that light that seems to come from all
    // directions.
  ...
  /**
   * adds a feature that shall be rendered. the first feature to be set shall be
   * the digital elevation model
   * 
   * @param feature
   *          feature to publish into the scene
   */
   ...
   * <p>
   * at the moment it isn't specified how to define atmospheric conditions in a
   * standarized form so just an <tt>Object</tt> is submitted to the method.
   * 
   * @param conditions
  ...
  /**
   * get the date and the time for determining time depending the light
   * conditions of the scene
   * 
   * @return describtion of the date and time for which the scene shall be
   *         rendered --> light conditions
   */
   ...
   * 
   * @param feature
   *          Shape3D object representing the scenes terrain.
   */
   ...
   * 
   * @param features
   *          Shape3D objects representing the scenes terrain.
   */
   ...
   * view in radians
   * 
   * @return object that describes the viewers position and the point he looks
   *         at
   */
   ...
   * 
   * @param light
   *          a light in addition to sun and basic ambient light (e.g. street
   *          lights, spots etc.)
   */
   ...
   * 
   * @return lights including sun and basic ambient light (e.g. street lights,
   *         spots etc.)
   */
   ...
   * 
   * @param lights
   *          lights in addition to sun and basic ambient light (e.g. street
   *          lights, spots etc.)
   */
