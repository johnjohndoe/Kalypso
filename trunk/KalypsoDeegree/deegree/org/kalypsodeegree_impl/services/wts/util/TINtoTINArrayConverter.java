...
public class TINtoTINArrayConverter {
    ...
    /**
     * Converts the geometries of the feature of a feature collection to
     * TINs stored in a javax.media.j3d.TriangleArray
     * 
     * @param fc feature collection
     * @param enableTexture true if the TINs shalled textured
     * @param scale scale factor ( 1 = original height )
     * @return
     */
