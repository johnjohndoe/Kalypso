...
public class SI_Gazetteer_Impl implements SI_Gazetteer
{
   ...
   */
  public SI_Gazetteer_Impl( String identifier, GM_Object territoryOfUse,
      CitedResponsibleParty custodian, SI_LocationType[] locationTypes, String scope,
  ...
  {
    return (SI_LocationType[])locationTypes.toArray( new SI_LocationType[locationTypes.size()] );
  }
