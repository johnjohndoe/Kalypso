...
public class WFSGCapabilitiesFactory {
    ...
    /**
     * factory method for creating a <tt>WFSGCapabilities</tt> object from
     ...
     */
    public static synchronized WFSGCapabilities createCapabilities(Document doc) throws GazetteerException {
        Debug.debugMethodBegin();
        ...
        try {
            ...
            throw new GazetteerException("Exception occured in creating WFSCapabilities out of Gazetteer:\n" + e.getMessage());
        }
        ...
        WFSGCapabilities_Impl capabilities = new WFSGCapabilities_Impl(capability, ftl, version, updateSequence, service);
    ...
    public static SI_Gazetteer getSI_Gazetteer(Element element) throws GazetteerException {
        ...
        ElementList elemlist = XMLTools.getChildElementsByName("locationType", NAMESPACE_WFSG, element);
        ...
        SI_Gazetteer si_gazetteer = new SI_Gazetteer_Impl(identifier, territoryOfUse, custodian, locationTypes, scope, coordinateSystem);
    ...
    public static SI_LocationType getSI_LocationType(Element element) throws GazetteerException {
        ...
        // TerritoryOfUse
        Element territoryofuseelement = XMLTools.getChildByName("territoryOfUse", NAMESPACE_WFSG, element);
        GM_Object territoryOfUse = null;
        ...
        return new SI_LocationType_Impl(name, theme, identifier, definition, owner, 
                                        parents, children, territoryOfUse);
    }
