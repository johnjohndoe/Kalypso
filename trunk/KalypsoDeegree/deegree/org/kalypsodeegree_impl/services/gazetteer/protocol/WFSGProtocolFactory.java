...
public class WFSGProtocolFactory
{
  ...
  public static WFSGGetCapabilitiesRequest createWFSGGetCapabilitiesRequest( String id )
  {
    ...
    WFSGGetCapabilitiesRequest req = new WFSGGetCapabilitiesRequest_Impl( "1.0.0", id,
   ...
   * @return
   */
  public static WFSGGetCapabilitiesResponse createWFSGGetCapabilitiesResponse(
      WFSGGetCapabilitiesRequest request, WFSGCapabilities capa )
  {
    Debug.debugMethodBegin();
   ...
   */
  public static WFSGGetCapabilitiesResponse createWFSGGetCapabilitiesResponse(
      WFSGGetCapabilitiesRequest request, Document exception )
  {
    Debug.debugMethodBegin();

    WFSGGetCapabilitiesResponse res = new WFSGGetCapabilitiesResponse_Impl( request, exception,
        null );
   ...
   * @return
   */
  public static WFSGDescribeFeatureTypeRequest createWFSGDescribeFeatureTypeRequest( String id,
      Document doc )
  {
    ...
    WFSGDescribeFeatureTypeRequest request = createWFSGDescribeFeatureTypeRequest( "1.0.0", id,
        null, null, outputFormat, typeNames );
  ...
  public static WFSGDescribeFeatureTypeRequest createWFSGDescribeFeatureTypeRequest(
      String version, String id, HashMap vendorSpecificParameter, WFSNative native_,
      String outputFormat, String[] typeNames )
  {

    Debug.debugMethodBegin( "WFSGProtocolFactory", "createWFSGDescribeFeatureTypeRequest" );

    WFSGDescribeFeatureTypeRequest req = new WFSGDescribeFeatureTypeRequest_Impl( version, id,
      ...
      throws InconsistentRequestException, GazetteerException
  {
    ...
    /*
     * constructor WFSGGetFeatureRequest_Impl: String version, String id,
     * HashMap vendorSpecificParameter, WFSNative native_, String outputFormat,
     * String handle, Filter filter, int maxFeatures, int startPosition,
     * WFSQuery[] query, String[] propertyNames, String[] featureIds, String[]
     * typeNames
     */

    WFSGGetFeatureRequest getfeaturerequest = new WFSGGetFeatureRequest_Impl( WFS_VERSION, id,
        vendorspecificparams, native_, outputFormat, handle, wfsfilterdirect, maxFeatures,
        startPosition, queries, propertyNames, featureIds, typeNames );
  ...
  public static Filter getFilter( Element element ) throws FilterConstructionException
  {
    ...
    {
      // filter =
      // org.deegree_impl.services.wfs.filterencoding.AbstractFilter.buildFromDOM(el);
