 ...
 */
public class WFSGGetFeatureRequest_Impl extends WFSGetFeatureRequest_Impl 
    ...
    public WFSGGetFeatureRequest_Impl(String version, String id, HashMap vendorSpecificParameter, 
        ...
        super( version, id, vendorSpecificParameter, native_, outputFormat, handle, 
               filter, maxFeatures, startPosition, query, propertyNames, featureIds, 
               typeNames );
    }
