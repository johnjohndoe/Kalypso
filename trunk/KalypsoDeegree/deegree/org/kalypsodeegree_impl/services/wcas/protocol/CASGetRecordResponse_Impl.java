 ...
 * @version 2002-04-16
 */
final public class CASGetRecordResponse_Impl extends OGCWebServiceResponse_Impl implements
    CASGetRecordResponse
{
   ...
   * @param response
   */
  CASGetRecordResponse_Impl( OGCWebServiceRequest request, Document exception, Object response )
  {
