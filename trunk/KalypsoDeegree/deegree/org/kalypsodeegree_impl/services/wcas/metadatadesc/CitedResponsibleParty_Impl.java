 ...
 */
public class CitedResponsibleParty_Impl implements CitedResponsibleParty {
    ...
    public CitedResponsibleParty_Impl(ContactInfo[] contactinfo,
        ...
        this.rolecode = new ArrayList();setContactInfo(contactinfo);
