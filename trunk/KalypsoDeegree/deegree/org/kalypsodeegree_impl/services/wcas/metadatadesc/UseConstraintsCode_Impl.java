...
public class UseConstraintsCode_Impl implements UseConstraintsCode
{
  ...
  public UseConstraintsCode_Impl( String restrict )
  {
    setRestrict( restrict );
  }

  /**
   * returns the Restrict-attribute. use="required" Possible values are:
   * <ul>
   * <li>copyright
   * <li>patent
   * <li>patentPending
   * <li>license
   * <li>intellectualPropertyRights
   * <li>trademark
   * </ul>
   *  
   */
