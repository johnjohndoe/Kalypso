...
public class ISO19119_Impl implements ISO19119 {
    ...
    public ISO19119_Impl(String abstract_,
    ...
    public LegalConstraints[] getLegalConstraints() {
        return (LegalConstraints[])legalconstraints.toArray( new LegalConstraints[legalconstraints.size()] );
    }
    ...
    public OperationMetadata[] getOperationMetadata() {
        return (OperationMetadata[])operationmetadata.toArray( new OperationMetadata[operationmetadata.size()] );
    }
    ...
    public ResourceSpecifiedUsage[] getResourceSpecifiedUsage() {
        return (ResourceSpecifiedUsage[])resourcespecifiedusage.toArray( new ResourceSpecifiedUsage[resourcespecifiedusage.size()] );
    }
    ...
    public SecurityConstraints[] getSecurityConstraints() {
        return (SecurityConstraints[])securityconstraints.toArray( new SecurityConstraints[securityconstraints.size()] );
    }
