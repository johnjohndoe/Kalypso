...
/**
 * The %lt;DescribeFeatureType&gt; tag isused to indicate what schema description
 * languages can be used to describe the schema of a feature type when a client
 * requests such a description. XMLSCHEMA is the only mandatory language that must
 * be available. The SCHEMALANGUAGES entity can be redefined to include vendor
 * specific languages.
 *
 * <p>-----------------------------------------------------</p>
 *
 ...
 * Initial revision
 *
 * Revision 1.3  2004/03/16 08:07:25  poth
 * no message
 *
 * Revision 1.2  2004/01/08 09:50:23  poth
 * no message
 *
