...
public class PresentOptions_Impl implements PresentOptions {
    ...
    PresentOptions_Impl(boolean startRec, boolean hits, int recsMax) {
    ...
    /**
     * @see PresentOptions_Impl#getStartRec()
     */ 
    ...
    /**
     * @see PresentOptions_Impl#getHits()
     */
    ...
    /**
     * returns the maximum number of records that the catalog will return
     * as response to one getRecord request.
     */
    ...
    /**
     * @see PresentOptions_Impl#getRecsMax()
     */
    public void setRecsMax(int recsMax) {
        this.recsMax = recsMax;
    }
