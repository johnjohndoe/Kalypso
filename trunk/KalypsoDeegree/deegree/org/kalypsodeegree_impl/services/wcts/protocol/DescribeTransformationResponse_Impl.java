 ...
 * @version 2002-07-10
 */
public class DescribeTransformationResponse_Impl extends OGCWebServiceResponse_Impl implements
    DescribeTransformationResponse
{
  ...
  DescribeTransformationResponse_Impl( OGCWebServiceRequest request, Document exception,
      CT_MathTransform[] parameterizedTransformation, int numberOfTransformations )
  {
  ...
  {
    return (CT_MathTransform[])parameterizedTransformation
        .toArray( new CT_MathTransform[parameterizedTransformation.size()] );
  }
