...
/**
 * <p>This class describes requests, which have to examine the
 * possibility to transform one coordinate system into another.
 * <p>Beside the source and the target coordinate-system, the format
 * of the return-value will be fixed.
 * <p>Furtheron the service offers the possibility to declarate
 ...
 * <p>As a rule every particular coordinate-system will be indicated 
 * by an identifier.
 * <p>----------------------------------------------------------------------</p>
 * @author <a href="mailto:poth@lat-lon.de">Andreas Poth</a>
 * @version 2002-07-10
 */
public class IsTransformableRequest_Impl extends OGCWebServiceRequest_Impl
