...
/**
 * TimeExtent implements the ISO extended time format The syntax for expressing
 * Time constraints and date / time values is specified in WMS 1.1 Annexes B
 */
public class TimeExtent_Impl implements TimeExtent
{
  ...
  public String toString()
  {
    ...
    {
      sb.append( "PERIODIC, " ).append( _startdate ).append( "-->" ).append( _enddate ).append(
          " P " ).append( _period );
    }
