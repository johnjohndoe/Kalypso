 ...
 * labels defined by a particular Authority. For example, the Global Change
...
class Identifier_Impl implements Identifier, Marshallable
{
  ...
  /**
   * returns the value of the identifier. that may be a ID, a label or something
   * comparable
   */
  ...
  /**
   * sets the value of the identifier. that may be a ID, a label or something
   * comparable
   */
