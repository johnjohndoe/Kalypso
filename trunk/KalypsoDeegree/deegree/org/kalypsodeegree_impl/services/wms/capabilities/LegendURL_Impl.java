 ...
 * @version $Revision$
 */
class LegendURL_Impl extends ImageURL implements LegendURL, Marshallable {
    ...
    */
    ...
    public String exportAsXML() {
        ...
        sb.append( "<LegendURL width=\"" ).append( getWidth() ).append( "\" height=\"" )
          .append( getHeight() ).append( "\">" ).append( "<Format>" )
