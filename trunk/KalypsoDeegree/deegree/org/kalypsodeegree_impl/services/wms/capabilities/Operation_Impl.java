...
/**
 * The interface <Operation> defines the differt types of operations that may be performed
...
class Operation_Impl implements Operation, Marshallable {
    ...
    */
     ...
     * <p>
     * @param format the name of the <tt>Format</tt> to look up
    ...
    public void setOperationType( int operationType ) {
        ...
        switch ( operationType ) {
            case GETCAPABILITIES:
                operationName = GETCAPABILITIES_NAME; break;
            case CAPABILITIES:
                operationName = CAPABILITIES_NAME; break;
            case GETMAP:
            ...
            case FEATUREINFO:
                ...
                break;
            case DESCRIBELAYER:
                operationName = DESCRIBELAYER_NAME; break;
            case GETLEGENDGRAPHIC:
                operationName = GETLEGENDGRAPHIC_NAME; break;
            case GETSTYLES:
                operationName = GETSTYLES_NAME; break;
            case PUTSTYLES:
                operationName = PUTSTYLES_NAME; break;
            default:
                operationName = UNKNOWN_NAME; break;
        }
    }
    ...
    */
    ...
    public String exportAsXML() {
        ...
        while ( it.hasNext() ) {
            ...
            sb.append( "<Format>" ).append( XMLTools.validateCDATA( fo.getName() ) )
              .append( "</Format>" );
        }
