...
public class OGCWMSCapabilitiesFactoryTest extends TestCase
{
  ...
  /*
   * Class under test for WMSCapabilities createCapabilities(URL, String, String, String, String)
   */
...
//     URL url=new URL("http","demo.deegree.org",8080,"/deegree/wms?SERVICE=WMS&VERSION=1.1.1&REQUEST=GetCapabilities");
...
//      
//   WMSCapabilities wmsCaps=wmsCapFac.createCapabilities(url, "172.16.0.1", "8080", "belger", "LaufMensch");
