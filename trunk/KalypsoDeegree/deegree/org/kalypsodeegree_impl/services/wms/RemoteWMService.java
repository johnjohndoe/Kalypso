...
public class RemoteWMService extends OGCWebService_Impl
{
        ...
        try
        {
          ...
          else
          {
            ...
            exce = new OGCWebServiceException_Impl( "RemoteWMS:handleGetMap",
                "Response of the remote " + "WMS contains wrong content " + "type: " + contentType
                    + ";request: " + lparam + res );
          }
        }
        catch( Exception e )
  ...
  /**
   * reads feature infos from the remote WMS by performing a FeatureInfo request
      ...
      throws WebServiceException
  {
    ...
    if( url == null )
    {
      throw new WebServiceException( "GetFeatureInfo is not supported by " + "the RemoteWMS: "
        ...
        try
        {
          ...
          else
          {
            exce = new OGCWebServiceException_Impl( "RemoteWMS:handleFeatureInfo",
                "Response of the remote " + "WMS contains unknown content " + "type: "
      ...
      throws WebServiceException
  {
    ...
    if( url == null )
    {
      throw new WebServiceException( "DESCRIBELAYER is not supported by " + "the RemoteWMS: "
          + capabilities.getService().getName() );
    }
      ...
      OGCWebServiceClient client ) throws WebServiceException
  {
    ...
    if( url == null )
    {
      throw new WebServiceException( "GETLEGENDGRAPHIC is not supported by " + "the RemoteWMS: "
          + capabilities.getService().getName() );
    }
