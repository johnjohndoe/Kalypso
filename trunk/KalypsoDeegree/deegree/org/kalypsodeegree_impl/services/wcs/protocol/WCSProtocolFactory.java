...
public class WCSProtocolFactory {
    ...
    public static synchronized WCSGetCoverageRequest createWCSGetCoverageRequest(HashMap model)
        ...
        if (width > 0) {
            request = createWCSGetCoverageRequest((String) model.get("VERSION"),
                                                  (String) model.get("ID"), null,
                                                  (String) model.get("LAYER"),
                                                  (String) model.get("SRS"),
                                                  responseSRS,
                                                  (GM_Envelope) model.get("BBOX"),
												  rpl,
                                                  width, height, depth,
												  (String) model.get("FORMAT"),
                                                  (String) model.get("INTERPOLATIONMETHOD"),
                                                  (String) model.get("EXCEPTIONS"));
        } else {
            request = createWCSGetCoverageRequest((String) model.get("VERSION"),
                                                  (String) model.get("ID"), null,
                                                  (String) model.get("LAYER"),
     ...
     */
    public static synchronized WCSGetCoverageRequest createWCSGetCoverageRequest(String version, String id,
                                                                    HashMap vendorspecificParameters,
                                                                    String layer,
                                                                    String crs, String responseCrs,
        ...
        return new WCSGetCoverageRequest_Impl(version, id, vendorspecificParameters, layer,
                                              crs, responseCrs, boundingBox, rpl,
    ...
    public static synchronized WCSGetCoverageRequest createWCSGetCoverageRequest(String version, String id,
        ...
        return new WCSGetCoverageRequest_Impl(version, id, vendorspecificParameters, layer,
											  ...
											  boundingBox, rpl,
                                              resX, resY, resZ,
											  format, interpolationMethod, exceptions);
    }
     ...
     * @return
     */
    public static synchronized WCSGetCoverageResponse createGetCoverageResponse(OGCWebServiceRequest request,
                                                            Object coverage) {
