...
/**
 * For the <GetFeatureWithLock>request, a WFS must generate a result that
 * includes the lock identifier.
 * 
 * <p>
 * --------------------------------------------------------
 * </p>
 ...
 */
class WFSGetFeatureWithLockResponse_Impl extends WFSGetFeatureResponse_Impl implements
    WFSGetFeatureWithLockResponse
{
  ...
  WFSGetFeatureWithLockResponse_Impl( String lockId, OGCWebServiceRequest request,
      String[] affectedFeatureTypes, Document exception, Object response )
  {
