...
class FeatureType_Impl implements FeatureType
{
   ...
   */
  FeatureType_Impl( String name, String title, String abstract_, String srs,
      GM_Envelope latLonBoundingBox, FeatureTypeList parentList, String[] keyword,
 ...
 * empty log message *** Revision 1.3 2004/01/12 10:21:57 mrsnyder Operations
 * that are added to a FeatureType are now checked for existence first.
 * 
 * Revision 1.2 2002/11/06 17:08:56 poth no message
 * 
 * Revision 1.1.1.1 2002/09/25 16:01:22 poth no message
 * 
 * Revision 1.13 2002/08/19 15:58:51 ap no message
 * 
 * Revision 1.12 2002/08/15 10:01:40 ap no message
 * 
 * Revision 1.11 2002/08/09 15:36:30 ap no message
 * 
 * Revision 1.10 2002/07/04 14:55:07 ap no message
 * 
 * Revision 1.9 2002/05/22 16:05:02 ap no message
 * 
 * Revision 1.8 2002/05/16 15:52:13 ap no message
 * 
 * Revision 1.7 2002/05/13 16:10:47 ap no message
 * 
 * Revision 1.6 2002/05/06 16:02:07 ap no message
 * 
 * Revision 1.5 2002/04/26 09:05:10 ap no message
 * 
 * Revision 1.3 2002/04/25 16:18:47 ap no message
 * 
