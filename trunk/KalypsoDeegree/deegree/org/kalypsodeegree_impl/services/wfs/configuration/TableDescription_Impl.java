...
/**
 * the interface describes a table that contains data that are part of a feature
 * type
 * 
 * <p>
 * ---------------------------------------------------------------------
...
public class TableDescription_Impl implements TableDescription
{
  ...
  /**
   * returns the name of the table. in the case that a datastore encapsulates an
   * esri shapefile this is the name of the shape without extension
   */
  ...
  /**
   * returns all references contained within the table. an implementation have
   * to ensure that if no references are contained a zero length will be
   * returned
   */
  ...
  /**
   * returns true if the submitted field shall be interpreted as field that
   * contains geo spatial data. only needed for GMLDB and POINTDB
   */
  ...
  /**
   * returns all describtions for all fields that contains geo spatial data. an
   * implementation have to ensure that if no references are contained a zero
