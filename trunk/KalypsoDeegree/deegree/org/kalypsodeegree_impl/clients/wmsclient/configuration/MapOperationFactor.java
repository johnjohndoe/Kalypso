...
public class MapOperationFactor
{
   ...
   * @param free
   *          true if the <tt>MapOperationFactor</tt> represents a field that
   *          allows the user to enter his own map size
   */
  ...
  /**
   * returns true if the <tt>MapOperationFactor</tt> represents a field that
   * allows the user to enter his own map size
   */
