...
public class ContextSwitchListener extends AbstractListener
{
  ...
  public void actionPerformed( FormEvent event )
  {
    ...
    System.out.println( "using " + mapContext + " and " + xslFilename );
  ...
  protected String doTransformContext( String xsl, String context )
  {
    ...
    //        ContextTransformer ct = ContextTransformer.getInstance();
    ...
    try
    {
      ...
      System.out.println( "cxt: " + ctxtUrl.toString() );
      ...
      System.out.println( "xslt: " + xsltUrl.toString() );
      //            return ct.transformContext(xsltUrl.openStream(), ctxtUrl.openStream());
