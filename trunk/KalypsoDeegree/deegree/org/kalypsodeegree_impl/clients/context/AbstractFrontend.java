 ...
 */
public abstract class AbstractFrontend implements Frontend, Marshallable
{
   ...
   * @param center
   */
  public AbstractFrontend( String controller, GUIArea west, GUIArea east, GUIArea south,
      GUIArea north, GUIArea center )
  {
