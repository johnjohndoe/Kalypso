...
/**
 * this class encapsulates the style description as defined by the OGC Web Map
...
public class Style implements Marshallable
{
  ...
  /**
   * Each <Style>element may alternatively define the style(s) of the layer with
   * a <SLD>element.
   * 
   * @return
   */
  ...
  public String exportAsXML()
  {
    ...
    else
    {
      ...
      if( legendURL != null )
      {
        sb.append( "<LegendURL width='" ).append( legendURL.getWidth() ).append( "' height='" )
            .append( legendURL.getHeight() ).append( "' format='" ).append( legendURL.getFormat() )
            .append( "'>" );
        sb.append( "<OnlineResource  xlink:type='simple' xlink:href='" ).append(
            NetWorker.url2String( legendURL.getOnlineResource() ) ).append( "'/>" );
        sb.append( "</LegendURL>" );
      }
    }
    sb.append( "</Style>" );
