...
/**
 * This listener generates a list of availavle ViewContexts. The only parameter
 * passed is the user name.Currently only .xml files are being accepted as
 * contexts and it's also also assumed that those are available under
