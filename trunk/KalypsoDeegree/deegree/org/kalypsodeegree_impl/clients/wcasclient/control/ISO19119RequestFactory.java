...
public class ISO19119RequestFactory
{
   ...
   * Service Catalog Profil and GDI NRW catalog specifications against a a
   * catalog serving ISO 19119 conform service metadata
   */
  public static String createRequest( String setName, String serviceType, String[] datasetIds,
   ...
   * catalog serving ISO 19119 conform service metadata
   */
  public static String createRequest( String setName, String[] datasetIds ) throws Exception
  {
