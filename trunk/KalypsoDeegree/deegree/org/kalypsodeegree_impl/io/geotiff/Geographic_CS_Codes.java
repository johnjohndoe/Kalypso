// $Header:
// /cvsroot/deegree/deegree/org/deegree_impl/io/geotiff/Geographic_CS_Codes.java,v
// 1.3 2004/08/18 08:50:17 axel_schaefer Exp $
/*----------------    FILE HEADER  ------------------------------------------
...
public class Geographic_CS_Codes
{
  ...
  static
  {
    geographic_cs_type_codes = new HashMap( 200 );
    ellipsoid_only_GCS = new HashMap( 200 );
    geodectic_datum_code = new HashMap( 200 );
    ellipsoid_only_datum = new HashMap( 200 );
    ellipsoid_codes = new HashMap( 200 );
    prime_meridian_codes = new HashMap( 200 );
  ...
  public static int getGeogrpahicCSTypeCode( String code ) throws GeoTiffException
  {
    ...
    throw new GeoTiffException( "Error in accessing Geographics CS Type Code.\n" + "  Code: "
        + code + " not found." );
 ...
 * *** empty log message *** Revision 1.3 2004/08/18 08:50:17 axel_schaefer no
 * message
 * 
 * Revision 1.2 2004/07/16 07:42:50 poth no message
 * 
 * Revision 1.1 2004/07/15 09:57:47 axel_schaefer initial release. Coordinate
 * System codes
 * 
 * ****************************************************************************
 */