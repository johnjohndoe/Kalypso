...
public class MySQLDBAccess extends DBAccess
{
   ...
   * @throws Exception
   */
  public MySQLDBAccess( String driver, String logon, String user, String password )
   ...
   * @throws Exception
   */
  public MySQLDBAccess( String driver, String logon, Properties properties ) throws SQLException,
      Exception
  {
   ...
   * @throws Exception
   */
  public MySQLDBAccess( String driver, String logon, Properties properties, boolean autoCommit )
      throws SQLException, Exception
  {
