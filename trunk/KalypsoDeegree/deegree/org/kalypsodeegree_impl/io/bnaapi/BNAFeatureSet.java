...
public class BNAFeatureSet {
     ...
     * Access order is arbitrary and doesnt have to reflect data ordering inside the BNA file.
     */
    ...
    public void addFeature( BNAFeature feature ) {
        ...
        // the geometries of the two features can be merged, in that they belong to the same feature.
