 ...
 *          <p>
 */
public class WCServicePool extends ObjectPool
{

  private static WCServicePool instance = null;

  private CVDescriptor[] descriptors = null;

  // private constructor to protect initializing
  private WCServicePool( CVDescriptor[] descriptors )
  {
   ...
   * 
   * @return an instance of the object pool. it is gauranteed that there exists
   *         only one instance of pool for each submitted class name.
   */
  public static WCServicePool getInstance( CVDescriptor[] descriptors )
  {
    if( instance == null )
    {
      synchronized( WFSServicePool.class )
      {
        if( instance == null )
        {
          instance = new WCServicePool( descriptors );
        }
      }
    }
    return instance;
  ...
  public synchronized Object acuireObject() throws Exception
  {
    ...
    // else instatiate a new object
    {
      ...
      Object o = new WCService_Impl( descriptors );
  ...
  {
    return "org.deegree_impl.enterprise.WCServicePool";
  }
