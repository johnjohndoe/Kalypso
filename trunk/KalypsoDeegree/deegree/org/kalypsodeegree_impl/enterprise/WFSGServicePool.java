...
public class WFSGServicePool extends ObjectPool
{
  ...
  private WFSGCapabilities wfsgCapa = null;
   ...
   */
  public static WFSGServicePool getInstance( WFSGCapabilities wfsgCapa, GazetteerConfiguration conf )
  {
    if( instance == null )
    {
      synchronized( WFSGServicePool.class )
      {
        if( instance == null )
        {
          instance = new WFSGServicePool( wfsgCapa, conf );
        }
      }
    }
    return instance;
