 ...
 * et les divers resources seront mises à la disposition du développeur via les
 * méthodes statiques.
 * 
 * @version 1.0
...
{
  /**
   * Instance statique crée une fois pour toute. Tous les messages seront
   * construits à partir de cette instance.
   */
   ...
   * forcément dans la langue de l'utilisateur. Il s'agit plutôt de ressources à
   * utiliser par défaut si aucune n'est disponible dans la langue de
   * l'utilisateur. Ce constructeur est réservé à un usage interne et ne devrait
   * pas être appellé directement.
   */
  public Units()
  {
   ...
   * n'y en a pas. A la différence de <code>format(String)</code>, cette
   * méthode ne lance pas d'exception si la resource n'est pas trouvée.
   */
