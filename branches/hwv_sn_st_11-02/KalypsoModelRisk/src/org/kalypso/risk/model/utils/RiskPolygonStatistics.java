...
public class RiskPolygonStatistics
{
  ...
  public RiskPolygonStatistics( final double returnPeriod )
  {
  ...
  public void update( final double doubleValue )
  {
    ...
    m_maxValue = m_maxValue.max( value );
    m_minValue = m_minValue.min( value );

    final BigDecimal newSum = m_sumValue.add( value );
