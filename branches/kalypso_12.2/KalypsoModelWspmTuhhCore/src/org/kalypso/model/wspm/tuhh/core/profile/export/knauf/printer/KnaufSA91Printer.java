 ...
 * @author Dirk Kuch
 */
public class KnaufSA91Printer extends AbstractKnaufPrinter
{

  public KnaufSA91Printer( final KnaufSA91Bean bean )
  {
    super( bean );
  }

  @Override
  protected KnaufSA91Bean getBean( )
  {
    return (KnaufSA91Bean) super.getBean();
  }
