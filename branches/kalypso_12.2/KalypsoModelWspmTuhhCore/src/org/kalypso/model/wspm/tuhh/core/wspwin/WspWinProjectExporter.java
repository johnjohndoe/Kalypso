...
public class WspWinProjectExporter
{
  ...
  public void export( final File outputDir, final IProgressMonitor monitor ) throws IOException
  {
    ...
    final WspWinProjectWriter wspWinProjectWriter = new WspWinProjectWriter( m_projectType, outputDir, m_roughnessType, m_preferRoughnessClasses, m_preferVegetationClasses );
