...
public interface IWspmTuhhConstants extends IWspmConstants
{
  ...
  String BUILDING_PROPERTY = "urn:ogc:gml:dict:kalypso:model:wspm:profileBuildingComponents#"; //$NON-NLS-1$
  ...
  /* BUILDING_PROPERTY */
  String BUILDING_PROPERTY_BEZUGSPUNKT_X = BUILDING_PROPERTY + "BEZUGSPUNKT_X"; //$NON-NLS-1$

  String BUILDING_PROPERTY_BEZUGSPUNKT_Y = BUILDING_PROPERTY + "BEZUGSPUNKT_Y"; //$NON-NLS-1$

  String BUILDING_PROPERTY_BREITE = BUILDING_PROPERTY + "BREITE"; //$NON-NLS-1$

  String BUILDING_PROPERTY_FORMBEIWERT = BUILDING_PROPERTY + "FORMBEIWERT"; //$NON-NLS-1$

  String BUILDING_PROPERTY_HOEHE = BUILDING_PROPERTY + "HOEHE"; //$NON-NLS-1$

  String BUILDING_PROPERTY_RAUHEIT = BUILDING_PROPERTY + "RAUHEIT"; //$NON-NLS-1$

  String BUILDING_PROPERTY_SOHLGEFAELLE = BUILDING_PROPERTY + "SOHLGEFAELLE"; //$NON-NLS-1$

  String BUILDING_PROPERTY_STEIGUNG = BUILDING_PROPERTY + "STEIGUNG"; //$NON-NLS-1$

  String BUILDING_PROPERTY_UNTERWASSER = BUILDING_PROPERTY + "UNTERWASSER"; //$NON-NLS-1$

  String BUILDING_PROPERTY_WEHRART = BUILDING_PROPERTY + "WEHRART"; //$NON-NLS-1$
