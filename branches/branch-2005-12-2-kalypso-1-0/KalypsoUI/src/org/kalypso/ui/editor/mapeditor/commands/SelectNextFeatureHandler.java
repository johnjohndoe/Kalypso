...
{
  private Map m_map = Collections.EMPTY_MAP;
      ...
      throws CoreException
  {
    ...
    {
      m_map = (Map)data;
      m_forward = Boolean.valueOf( (String)m_map.get( "forward" ) ).booleanValue();
      m_rotate = Boolean.valueOf( (String)m_map.get( "rotate" ) ).booleanValue();
   ...
   */
  public Object execute( final Map parameterValuesByName ) throws ExecutionException
  {
    final MapPanel mapPanel = (MapPanel)parameterValuesByName.get( "mapPanel" );
    ...
    final EasyFeatureWrapper wrapperToSelect = new EasyFeatureWrapper( featureTheme.getWorkspace(), featureToSelect,
        featureList.getParentFeature(), featureList.getParentFeatureTypeProperty().getName() );
