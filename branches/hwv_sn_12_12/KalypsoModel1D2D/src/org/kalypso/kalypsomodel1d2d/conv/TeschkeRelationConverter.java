...
public class TeschkeRelationConverter
{
  ...
  {
    final Map<String, SortedMap<Double, IPolynomial1D>> helperMap = new HashMap<String, SortedMap<Double, IPolynomial1D>>();
    ...
    for( final IPolynomial1D polynomial1D : polynomials )
    {
      ...
      {
        sortedMap = new TreeMap<Double, IPolynomial1D>();
    ...
    final Map<String, IPolynomial1D[]> result = new HashMap<String, IPolynomial1D[]>( helperMap.size() );
  ...
  {
    /* type -> range */
    final Map<String, Range> rangesPerType = new HashMap<String, Range>();
