...
public class LengthSectionBuildingTheme extends AbstractChartLayer implements ITooltipChartLayer
{
  ...
  public EditInfo getHover( final Point pos )
  {
    ...
    {
      if( layers[i] instanceof ITooltipChartLayer )
      {
        final ITooltipChartLayer tLayer = (ITooltipChartLayer) layers[i];
        final EditInfo info = tLayer.getHover( pos );
        if( info != null )
        {
          if( !tLayer.isActive() )
