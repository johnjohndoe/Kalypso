 ...
 *   
 *  ---------------------------------------------------------------------------*/
package org.kalypso.kalypsomodel1d2d.apps.velodiff2d;

import java.util.Map;

import org.eclipse.equinox.app.IApplication;
import org.eclipse.equinox.app.IApplicationContext;
import org.kalypso.kalypsomodel1d2d.conv.results.differences.VeloDiff2D;

/**
 * @author jung
 * 
 */
public class VeloDiff2dApplication implements IApplication
{
  /**
  ...
  public Object start( IApplicationContext context ) throws Exception
  {
    ...
    final VeloDiff2D veloDiff = new VeloDiff2D();
