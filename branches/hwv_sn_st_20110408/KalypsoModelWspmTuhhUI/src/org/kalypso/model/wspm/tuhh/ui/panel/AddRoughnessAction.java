...
import org.kalypso.contribs.eclipse.ui.actions.DropDownMenuCreator;
 ...
 */
public class AddRoughnessAction extends Action
{
  private final RauheitenPanel m_panel;
  ...
  public void update( final IComponent[] addableComponents )
  {
    ...
    setEnabled( addableComponents.length > 0 );
  }
