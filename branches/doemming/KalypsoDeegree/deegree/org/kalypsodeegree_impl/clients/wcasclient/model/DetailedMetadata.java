...
public class DetailedMetadata extends BaseMetadata {
    ...
    public DetailedMetadata( String title, String fileIdentifier, Calendar dateStamp, 
                             ...
                             Calendar startTime, Calendar endTime, String abstract_, String crs, 
                             String lineageSrcDesc, String lineageStatement, 
                             String maintenanceAndUpdateFrequency, String resourceConstraints, 
                             String processStep, String scale, String[] keywords, 
                             Contact[] contacts, OnlineTransferOption[] onlineTransferOptions ) {
