...
public class CSWClientConfiguration {
     ...
     * @throws Exception
     */
    CSWClientConfiguration( CCatalog[] ccatalog, CMapping mapping, 
                   int maxInactiveInterval, WMSClientConfiguration wmsCConfig, 
                   HashMap thesauri,  Download download, TextComponent textComponent, 
                   int maxRecords, String[] filterIDs ) throws Exception {
    ...
    */
    ...
    /**
    * returns the maximun time a session will be alive after the last change
    * in seconds
    */
    ...
    */
    ...
    /**
    * returns the address of the host for sending the mails that inform the
    * users about the place where to download the requested data
    */
    ...
    /**
     * returns the maximum number (iterations) to cascaded catalogs that shall
     * be performed.
     */
    ...
    /**
     * returns the configuration of the map client used by the catalogclient
     * for searching and displaying the results.
     */
