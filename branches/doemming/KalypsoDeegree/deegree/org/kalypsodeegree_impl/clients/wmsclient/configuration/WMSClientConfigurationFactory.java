...
public class WMSClientConfigurationFactory {
     ...
     * parameters contained in the configuration file referenced by the 
     * submitted <tt>URL</tt>
     *
     * @param url refernce to a wms client configuration document
     ...
     *
     * @param root XML element containing the web map client configuration
     * @param defaultConfig default map client configuration
     *
     * @return instance of <tt>WMSClientConfiguration</tt>
     */
    public WMSClientConfiguration createWMSClientConfiguration( Element root, 
        ...
        Debug.debugMethodEnd();
        return new WMSClientConfiguration( defaultConfig, knownWMS, offeredMapSizes, 
                                           offeredMapFormats, offeredInfoFormats,
                                           offeredMapOperations, offeredZoomFactors,
                                           offeredPanFactors, minScale, maxScale, 
                                           gmr, projects );
    }

    /**
     * creates a <tt>HashMap</tt> with the id of the WMS known by the client
     * as a key and the <tt>URL</tt> to its capabilities as value
     *
     * @param knownWMSE <KnownWMS> element of the client configuration
     *
    ...
    private HashMap createKnownWMS( Element knownWMSE ) throws XMLParsingException {
        ...
        if ( knownWMSE == null ) return knownWMS;
     ...
     * size is defined in the client configuration document the default map
     * size of 600x400 will be created.
     *
     * @param mapSizes <OfferedMapSize> element of the configuration
     *
    ...
    private MapSize[] createOfferedMapSizes( Element mapSizes ) throws XMLParsingException {
        ...
        if ( mapSizes == null ) return new MapSize[0];
     ...
     * format is given in the configuration document 'image/jpg' will be used
     * as default
     *
     * @param mapFormats <OfferedMapFormats> element of the configuration
     *
    ...
    private Format[] createOfferedMapFormats( Element mapFormats ) throws XMLParsingException {
        ...
        if ( mapFormats == null ) return new Format[0];
    ...
    /**
     * returns a list of the map operations (zoomin, zoomout, pan etc.) offered
     * by the client
     *
     * @param mapOperations <OfferedMapOperations> element of the configuration
     *
    ...
    private MapOperation[] createOfferedMapOperations( Element mapOperations )
        ...
        if ( mapOperations == null ) return new MapOperation[0];
     ...
     *
     * @param factors a <tt>Element</tt> that contains <Factor> elements as 
     *                children
     *
    ...
    private MapOperationFactor[] createOfferedMapOperationFactors( Element factors )
        ...
        if ( factors == null ) return new MapOperationFactor[0];
    ...
    private WMSGetMapRequest createInitialGetMapRequest( Element initMapReq )
        ...
        if ( initMapReq == null ) return null;
        ...
        try {
            ...
            throw new XMLParsingException( "could not create initial get map "+
                                           "request\n" + e );
        }
    ...
    private Project createProject(Element projectElement ) throws  XMLParsingException {
        ...
        Element initMapReq = 
            XMLTools.getRequiredChildByName ( "InitialGetMapRequest", CNS, 
                                              projectElement );
        WMSGetMapRequest gmr = createInitialGetMapRequest( initMapReq );
