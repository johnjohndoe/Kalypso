...
public class RemoteWCService extends OGCWebService_Impl {
    ...
    public void doService(OGCWebServiceEvent event) throws WebServiceException {
        ...
        if (request instanceof WCSGetCoverageRequest) {
            ...
            //Object result = handleDescribeCoverageLayer((WCSDescribeCoverageLayerRequest) request);
        } else if (request instanceof WCSGetCapabilitiesRequest) {
            //Object result = handleGetCapabilities((WCSGetCapabilitiesRequest) request);
        }
     ...
     */
    private OGCWebServiceEvent handleGetCoverage(WCSGetCoverageRequest request) throws WebServiceException {
    ...
    /**
     * reads feature infos from the remote WCS by performing a FeatureInfo
     ...
     */
    private OGCWebServiceEvent handleDescribeCoverageLayer(WCSDescribeCoverageLayerRequest request) throws WebServiceException {
     ...
     */
    private OGCWebServiceEvent handleGetCapabilities(WCSGetCapabilitiesRequest request) throws WebServiceException {
