...
/**
 * creates an instance of a WCS (<tt>OGCWebService</tt>) from the capabilities 
 * submitted to the create method
 *
 * @version $Revision$
...
public class WCSFactory {
     ...
     *
     * @param capabilities capabilities of a WCS
     */
    public static OGCWebService createWCService( WCSCapabilities capabilities ) 
                                                    throws XMLParsingException {
        return new WCService_Impl( capabilities );
    }
}