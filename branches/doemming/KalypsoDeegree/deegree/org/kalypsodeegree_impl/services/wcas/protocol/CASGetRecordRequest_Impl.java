 ...
 * specified at the "OGC Web Services Stateless Catalog Profile" and
 * is enhanced by some parameters defined within the GDI NRW Testbed II.
 * <p>--------------------------------------------------------------------</p>
 *
 * @author <a href="mailto:poth@lat-lon.de">Andreas Poth</a>
 * @version $Revision$ $Date$
 */
final public class CASGetRecordRequest_Impl extends OGCWebServiceRequest_Impl
    ...
    CASGetRecordRequest_Impl(String version, String id, HashMap vendorSpecificParameter, 
                             int maxRecords, int startPosition, String outputFormat, 
                             String outputRecType, CASQuery[] queries, int queryScope, 
                             Filter filter) {
    ...
    /**
     * returns the query objects of the getRecord request that specifies
     * the query in detail
     */
    ...
    /**
     * returns a Filter object that is common to all queries definied in
     * a getRecord request
     */
    ...
    /**
     * returns the maximum amount of records that shall be returned as
     * result of a getRecord request. if <tt>getMaxRecords</tt> returns
     * a value that is larger than the maxRecords defined in the capabilities
     * of the service the last one will be used.
     */
     ...
     * this is a usefull parameter if you like to retrieve the result of a query
     * in block of e.g. 20 entries.
     */
    ...
    /**
     * @see CASGetRecordRequest_Impl#getQueryScope()
    ...
    /**
     * returns the record type the result shall be formated in. a catalog
     * may offers different metadata formats for different kind of metadata
     * (service- versus data-metadata) or different formats for the same
     * kind of metadata (e.g. different profils on ISO19115).
     */
 ...
 * Initial revision
 *
 * Revision 1.4  2004/03/29 10:39:04  poth
 * no message
 *
 * Revision 1.3  2004/01/08 09:50:23  poth
 * no message
 *
 * Revision 1.2  2003/04/07 07:26:14  poth
 * no message
 *
 * Revision 1.1.1.1  2002/09/25 16:01:32  poth
 * no message
 *
 * Revision 1.4  2002/08/19 15:58:21  ap
 * no message
 *
 * Revision 1.3  2002/08/15 10:01:24  ap
 * no message
 *
 * Revision 1.2  2002/08/08 07:09:42  ap
 * no message
 *
 * Revision 1.2  2002/08/05 16:13:11  ap
 * no message
 *
 */
