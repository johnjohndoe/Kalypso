...
/**
 * The main purpose of the &lt;RecordTypeList&gt; section is to define the
 * list of record types that a WFS can service and define the operations
 * that are supported on each record type. For possible operations see the
...
public class RecordType_Impl implements RecordType {
    ...
    RecordType_Impl(String name, String title, String abstract_, String srs,
                    GM_Envelope latLonBoundingBox, RecordTypeList parentList,
                    String[] keyword, Operation[] operation, MetadataURL[] metadataURL,
     ...
     * are supported on a record type. Any locally defined
     ...
     * the data inaparticularrecord type.The type attribute
    ...
    /**
     * returns an instance of the record type list the record
     * belongs to.
     */
    ...
    /**
     * sets an instance of the record type list the record
     * belongs to.
     */
