...
public class Capability_Impl implements Capability {
    ...
    Capability_Impl(TaxonomyTypeList taxonomyTypeList,
                    Request request, RecordTypeList recordTypeList,
   ...
   /**
    * returns a list of federated catalogs that shall be called by the catalog
    * as cascaded catalogs when recieving a request
    */
    ...
    */ 
     ...
     * @param queryLanguages query languages known by a catalog
     */ 
 ...
 * Initial revision
 *
 * Revision 1.2  2004/03/16 08:07:25  poth
 * no message
 *
 * Revision 1.1.1.1  2002/09/25 16:01:30  poth
 * no message
 *
 * Revision 1.1  2002/08/19 15:58:38  ap
 * no message
 *
 */
