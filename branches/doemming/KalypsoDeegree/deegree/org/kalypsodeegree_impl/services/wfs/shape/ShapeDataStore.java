            ...
            try {
                ...
                for ( int i = 0; i < queries.length; i++ ) {
                    if ( isKnownFeatureType( queries[i].getTypeName() ) ) {
                        ...
                        Feature[] features = getFeatures( queries[i].getTypeName(), filter, 
...
//                    shapeIds[i] = Integer.parseInt( ( (FeatureId)featureIds.get( i ) ).getValue()
//                                                                                  .substring( nameLen ) );
//                }
//            }
             else if ( filter == null ) {
...
/* ********************************************************************
   ...
   Revision 1.24  2004/03/22 11:44:34  poth
   no message
