 ...
 * known as the "default" style and need not be advertised by the server.<p></p>
...
class Style_Impl implements Style, Marshallable {
    ...
    */
     ...
     * @exception thrown if the resource doesn't hold the style definitions in
     *            a SLD conform document
     */
    ...
    /**
     * returns an array of LegendURL objects that defines the location, size
    ...
    */
    ...
    public String exportAsXML() {
        ...
        sb.append( "<Style>" ).append( "<Name>" ).append( XMLTools.validateCDATA( name ) )
          .append( "</Name>" ).append( "<Title>" ).append( XMLTools.validateCDATA( title ) )
          .append( "</Title>" );

        if ( styleResource != null ) {
            sb.append( "<StyleResource>" ).append( styleResource.toString() )
              .append( "</StyleResource>" );
        }
