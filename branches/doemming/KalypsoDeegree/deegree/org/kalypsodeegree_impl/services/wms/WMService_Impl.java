...
public class WMService_Impl extends OGCWebService_Impl {
    ...
    public void doService( OGCWebServiceEvent event ) throws WebServiceException {
        ...
        //WMSCache cache = WMSCache.getInstance( capabilities.getDeegreeParam().getCacheSize() );
        ...
        if ( request instanceof WMSGetMapRequest ) {
            ...
            if ( result == null ) {
                GetMapHandler gmh = (GetMapHandler)createHandler( request, 
                                                                  WMSGetMapRequest.class, 
                                                                  Operation.GETMAP );
     ...
     * @param concrete class of the request (WMSGetStylesRequest, WMSFeatureInfoRequest etc.)
     * @param operationType type of the operation to perform by the handler
     */
    private Object createHandler( OGCWebServiceRequest request, Class requestClass, 
                                  int operationType ) throws WebServiceException {
