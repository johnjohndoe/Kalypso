 ...
 */
public class WMSGetScaleBarRequest_Impl extends OGCWebServiceRequest_Impl
    ...
    public WMSGetScaleBarRequest_Impl( String version, String id, HashMap vendorSpecificParameter, 
                                       String units, int topLabel, int bottomLabel, 
                                       Color labelColor, Font font, String barStyle, 
                                       Color barColor, Color bgColor, int size, 
                                       double scale, int scaleDenominator, String format ) {
    ...
    /**
      ...
      * WMSGetScaleBarRequest.and L_NONE. 
         *
         * @param tLabel type of label to display above the scale bar
         */
     ...
     * values are WMSGetScaleBarRequest.L_SCALE, WMSGetScaleBarRequest.L_SIZE 
     * and WMSGetScaleBarRequest.L_NONE
     *
     * @param bLabel type of label to display below the scale bar
     */
     ...
     *
     * @param size of the scale bar in pixel
     */
    ...
    /**
     * sets the color will be painted or <tt>null</tt> if the scale bar hasn't
     * a unique color (depends on the style)
     *
     * @param bColor color of the scale bar
     */
    ...
    /**
         * returns the color will be painted or <tt>null</tt> if the scale bar hasn't
         * a unique color (depends on the style)
         *
     ...
     *
     * @param lColor color of the labels
     */
    ...
    /**
     * returns the name of the style the scale bar should be drawed. beside 'default'
    ...
    /**
         ...
         * and 'ALTERNATE' the available styles depends on the implementation.
         *
         * @param bStyle style of the scale bar
         */
     ...
     * pixels size at different clients are used at the same time. So in most cases
     * this method returns the default pixels size of 0.28 mm.
     *
     * @return client pixel size in milli meter
     */
    public double getPixelSize() {
        return 0.28;
        //TODO was ordentliches dafür schreiben und eventuell getWMSScaleBarRequest() in der Klasse WMSProtokolFactory anpassen
    }
