...
public class TransformResponse_Impl extends OGCWebServiceResponse_Impl implements TransformResponse {
    ...
    */
    ...
    /**
    * parses geometries to nodes
        private Node toDOMNode(GMLGeometry data) throws Exception
        {
            Debug.debugMethodBegin("TransformResponse_Impl", "toDOMNode");
            
            String stringi = data.toString();
            Node node = XMLTools.parse(stringi);
