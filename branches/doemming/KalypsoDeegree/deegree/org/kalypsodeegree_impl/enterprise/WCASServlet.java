...
public class WCASServlet extends HttpServlet {
    ...
    private class WCAS implements OGCWebServiceClient {
        ...
        /** constructor
         */
        WCAS( HttpServletRequest servletRequest, HttpServletResponse servletResponse )
            throws Exception {
        ...
        WCAS( HashMap model, HttpServletResponse servletResponse ) throws Exception {
            ...
            if ( req.equals( "DescribeFeatureType" ) ) {
                ...
                if ( tmp != null ) {
                    ...
                    String[] setNames = StringExtend.toArray( (String)model.get( "SETNAME" ), ",;", 
                                                              false );
         ...
         * of a <tt> WCASService</tt> instance.
         */
            ...
            try {
                if ( request.indexOf( "<GetCapabilities" ) > -1 ) {
                    ...
                    OGCWebServiceEvent event = 
                        new OGCWebServiceEvent_Impl( this, request, null, this );
