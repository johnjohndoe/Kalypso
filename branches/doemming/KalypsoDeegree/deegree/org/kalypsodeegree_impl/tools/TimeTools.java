...
public class TimeTools {
    ...
    public static int get(int value, String isoTimestamp) {
        ...
        switch (value) {
            case 0: s = isoTimestamp.substring(0,4); break;
            case 1: s = isoTimestamp.substring(5,7); break;
            case 2: s = isoTimestamp.substring(8,10); break;
            case 3: {
    ...
    public static int getISO8601(int value, String isoTimestamp) {
        ...
        switch (value) {
            case 0: s = isoTimestamp.substring(0,4); break;
            case 1: s = isoTimestamp.substring(4,6); break;
            case 2: s = isoTimestamp.substring(6,8); break;
            case 3: {
