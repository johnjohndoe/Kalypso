...
public class StyleFactory {
     ...
     * as value 
     * 
     * @param value value of the <tt>ParameterValueType</tt>
     *
    ...
    /**
     * creates a <tt>ParameterValueType</tt> instance with a <tt>int</tt>
     * as value 
     * 
     * @param value value of the <tt>ParameterValueType</tt>
     *
     ...
     *
     * @param name name of the css parameter
     * @param value value of the css parameter
     *
     ...
     *
     * @param graphic <tt>Graphic</tt object
     *
    ...
    /**
     * create a default Stroke that black, 1 pixel width, complete opaque,
     * with round linejoin and square line cap
     *
    ...
    /**
     * create a fill with color and opacity supplied and uses
     * the graphic fill supplied for the fill
     *
     ...
     * @param displacementY - the Y distance from the anchor
     * @param rotation - the rotaion of the label
     * @param auto - auto positioning of the label
     *
     * @return the pointplacement created
     */
    public static PointPlacement createPointPlacement( double anchorX, double anchorY, 
     ...
     * the labels and the lines. A positive value indicates a position above
     * the line, a negative value indicates a position below. The line width
     * is asumed to be 2 pixel and the gap between the labels is set to factor
     * 10 of the label width.
     *
     ...
     *
     * @param position of the label relative to the line
     *
     * @return the LinePlacement created
     */
     ...
     * creates a <tt>LinePlacement</tt> with a user defined distance between
     * the labels and the lines. A positive value indicates a position above
     * the line, a negative value indicates a position below. 
     *
     * @param offset - the distance between the line and the label
     * @param lineWidth - assumed lineWidth
     * @param gap - gap between the labels measured in label width
     *
     * @return the LinePlacement created
     */
     ...
     * the line, a negative value indicates a position below. 
     *
     * @param position - relative position of the label to the line
     * @param lineWidth - assumed lineWidth
     * @param gap - gap between the labels measured in label width
     *
     * @return the LinePlacement created
     ...
     *
     * @param linePlacement description of the line where the lable will be 
     *                      orientated on
     ...
     *
     * @param pointPlacement description of the point where the lable will be 
     *                      orientated on
     * @return created LabelPlacement
     */
     ...
     * @param radius - the radius of the halo use a value <= 0 for rectangle
     *
     * @return the new halo
     */
     ...
     * wrapper round StyleFactory method to create halo
     *
     * @param fillColor - the fill color of the halo
     * @param opacity - the opacity of the halo fill 0 - transparent 1 - solid
     * @param strokeColor - the stroke color of the halo     
     * @param radius - the radius of the halo use a value <= 0 for rectangle
     *
     * @return the new halo
     */
    public static Halo createHalo( Color fillColor, double opacity, Color strokeColor, 
                            double radius ) {
     ...
     * @param stroke - the stroke of the halo
     * @param radius - the radius of the halo use a value <= 0 for rectangle
     *
     * @return the new halo
     */
     ...
     * @param stroke - the stroke to be used to draw the line
     * @param geometryPropertyName - the name of the geometry to be drawn
     * @param min min scale denominator
     * @param max max scale denominator
     *
     * @return the new line symbolizer
     */
    public static LineSymbolizer createLineSymbolizer( Stroke stroke, String geometryPropertyName,
    ...
    public static PolygonSymbolizer createPolygonSymbolizer( Stroke stroke, Fill fill, 
                                                      String geometryPropertyName ) {
        return createPolygonSymbolizer( stroke, fill, geometryPropertyName,
                                        0, Double.MAX_VALUE );
    }
     ...
     * create a textsymbolizer
     *
     * @param geometryPropertyName geometry assigned to the TextSymbolizer
     * @param attribute attribute to draw/print
     * @param labelPlacement defines the placement of the text
     *
     * @return the new textsymbolizer
     *
     */
    public static TextSymbolizer createTextSymbolizer( String geometryPropertyName, 
                                                String attribute, 
                                                LabelPlacement labelPlacement) {
        Font font = createFont( java.awt.Font.decode( "Sans Serif" ) );
        return createTextSymbolizer( geometryPropertyName, attribute, font, 
                                     labelPlacement, createHalo(), createFill(), 
                                     0, Double.MAX_VALUE);
    }
     ...
     * @param labelPlacement defines the placement of the text
     * @param halo halo/backgroud of the text
     * @param fill color, opacity of the text
     * @param min min scale denominator
     * @param max max scale denominator
     *
     * @return the new textsymbolizer
    ...
    public static TextSymbolizer createTextSymbolizer( String geometryPropertyName, 
                                                String attribute, 
                                                Font font, LabelPlacement labelPlacement, 
                                                Halo halo, Fill fill, double min, 
                                                double max ) {
        Geometry geom = null;
        if ( geometryPropertyName != null ) {
            new Geometry_Impl( geometryPropertyName, null );
     ...
     * create a textsymbolizer
     *
     * @param geometry geometry assigned to the TextSymbolizer
     * @param label attribute to draw/print
     * @param font font to use for the text
     * @param labelPlacement defines the placement of the text
     * @param halo halo/backgroud of the text
     * @param fill color, opacity of the text
    ...
    public static TextSymbolizer createTextSymbolizer( Geometry geometry, ParameterValueType label, 
                                                ...
                                                Halo halo, Fill fill, double min, 
                                                double max ) {
        return new TextSymbolizer_Impl( geometry, label, font, labelPlacement, 
                                        halo, fill, min, max);
    }
     ...
     * @param abstract_ - text describing throws rule 
     * @param minScaleDenominator - the minimim scale to draw the feature at
     * @param maxScaleDenominator - the maximum scale to draw the feature at
     *
     * @return the new rule
    ...
    public static Rule createRule( Symbolizer[] symbolizers, String name, String title, 
                            String abstract_, double minScaleDenominator, 
                            double maxScaleDenominator ) {
        return createRule( symbolizers, name, title, abstract_, null, null, false, 
                           minScaleDenominator, maxScaleDenominator );
    }
     ...
     * @param title - title of the rule
     * @param abstract_ - text describing throws rule 
     * @param filter - filter to use with the rule
     * @param elseFilter - true if the passed is an ElseFilter (see SLD spec)
     * @param minScaleDenominator - the minimim scale to draw the feature at
     * @param maxScaleDenominator - the maximum scale to draw the feature at
     *
     * @return the new rule
     */
    public static Rule createRule( Symbolizer[] symbolizers, String name, String title, 
                            String abstract_, LegendGraphic legendGraphic, 
                            Filter filter, boolean elseFilter, 
                            double minScaleDenominator, double maxScaleDenominator ) {
        return new Rule_Impl( symbolizers, name, title, abstract_, legendGraphic, 
     ...
     * create a Feature type styler 
     *
     * @param rule - rule contained in the featureTypeStyle 
     *
     * @return the new feature type styler
     */
     ...
     * create a Feature type styler 
     *
     * @param rules - rules contained in the featureTypeStyle 
     *
     * @return the new feature type styler
     */
     ...
     *
     * @param featureTypeStyleName - name for the feature type styler
     * @param featureTypeName - name of the feature type the Feature type style
     *                          shall be assigned to
     * @param title - title of the FeatureTypeStyle
     * @param abstract_ - text describing the FeatureTypeStyle
     * @param rules - rules contained in the featureTypeStyle 
     *
     * @return the new feature type styler
     */
    public static FeatureTypeStyle createFeatureTypeStyle( String featureTypeStyleName, 
                                                    String title, String abstract_, 
                                                    String featureTypeName,
                                                    Rule[] rules ) {        

        return new FeatureTypeStyle_Impl( featureTypeStyleName, title, abstract_, 
                                          featureTypeName, null, rules );
    }
     ...
     * @param abstract_ - text describing the style
     ...
     * @param title - title of the style
     * @param abstract_ - text describing the style
     * @param featureTypeStyles - featureTypeStyle
     *
     * @return the new style
     */
    public static Style createStyle(String name, String title, String abstract_,
     ...
     * @param size - the size of the graphic
     * @param rotation - the rotation from the top of the page of the graphic
     * @param min - the minimim scale to draw the feature at
     * @param max - the maximum scale to draw the feature at
     *
     * @return the style created
     */    
    public static Style createPointStyle( String wellKnownName, Color fillColor, Color borderColor, 
                                   double borderWidth, double opacity, double size, 
     ...
     * @return the style created
     */    
    public static Style createLineStyle(Color color, double width, double opacity,
                                        double min, double max) {
     ...
     * @param strokeOpacity - the opacity of the line
     * @param min - the minimim scale to draw the feature at
     * @param max - the maximum scale to draw the feature at
     *
     * @return the style created
     */    
    public static Style createPolygonStyle(Color fillColor, double fillOpacity,
                                           Color strokeColor, double strokeWidth,
                                           double strokeOpacity, double min, 
                                           double max) {
    ...
    /**
     * creates a style with name 'defaultPoint' for rendering point geometries. 
     * The style contains 1..n rules depending on the value range and the 
     * number of steps within it. So it is possible to create a style that 
     * creates different rendering depending on the value of one feature
     * attribute.<p>
     ...
     *
     * @param wellKnownNames - list of well known names of the mark. the first field
     *                        will be assigned to the starting rule the last to the
     *                        ending rule.
     * @param startFillColor - the color of the mark of the first rule
     * @param endFillColor - the color of the mark of the last rule
     * @param startBorderColor - the outline color of the mark of the first rule
     * @param endBorderColor - the outline color of the mark of the last rule
     * @param startBorderWidth - the width of the outline of the first rule
     * @param endBorderWidth - the width of the outline of the last rule
     * @param opacity - the opacity of the graphic
     * @param startSize - the size of the graphic of the first rule
     * @param endSize - the size of the graphic of the last rule
     * @param rotation - the rotation from the top of the page of the graphic
     * @param min - the minimim scale to draw the feature at
     * @param max - the maximum scale to draw the feature at
     * @param featurePropertyName - name of the feature property that determines
     *                              the selection of the rule for drawing
     * @param numberOfSteps - number of steps used for the interpolation between
     *                        first and last value. It is identical with the number
     *                        of rules that will be created.
     *
     * @return the style created
     */    
    public static Style createPointStyle( String[] wellKnownNames, Color startFillColor, 
                                   Color endFillColor, Color startBorderColor, 
                                   Color endBorderColor, double startBorderWidth, 
                                   double endBorderWidth, double opacity, 
                                   double startSize, double endSize, double rotation, 
                                   double min, double max, String featurePropertyName,
                                   int numberOfSteps) {
        return null;
    }
     ...
     * first and the last rule considering the number of passed steps (rules)
     *
     * @param startColor - the color of the first rule
     * @param endColor - the color of the last rule
     * @param startWidth - the width of the line of the first rule
     * @param endWidth - the width of the line of the last rule
     * @param opacity - the opacity of the graphic
     * @param min - the minimim scale to draw the feature at
     * @param max - the maximum scale to draw the feature at
     * @param featurePropertyName - name of the feature property that determines
     ...
     * first and the last rule considering the number of passed steps (rules)
     *
     * @param startFillColor - the fill color of the first rule
     * @param endFillColor - the fill color of the last rule
     * @param fillOpacity - the opacity of the fill
     * @param startStrokeColor - the line color of the first rule
     * @param endStrokeColor - the line color of the last rule
     * @param startStrokeWidth - the width of the outline of the first rule
     * @param endStrokeWidth - the width of the outline of the last rule
    ...
    public static Style createPolygonStyle(Color startFillColor, Color endFillColor, 
                                           double fillOpacity, Color startStrokeColor, 
                                           Color endStrokeColor, double startStrokeWidth,
                                           double endStrokeWidth, double strokeOpacity, 
                                           double min, double max, String featurePropertyName, 
                                           int numberOfSteps) {
        return null;
    }
