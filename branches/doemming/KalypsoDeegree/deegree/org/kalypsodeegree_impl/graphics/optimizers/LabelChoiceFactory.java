	...
	static ArrayList createLabelChoices (LabelDisplayElement element, Graphics2D g,
		...
		try {
			...
			if (geometry instanceof GM_Point) {                    
				...
				labels [0] = LabelFactory.createLabel (caption, font, sldFont.getColor (feature), metrics, feature, symbolizer.getHalo(), x, y, w, h, rotation*Math.PI, new double [] {0.0, 0.0}, new double [] {displacement [0], displacement [1]}); 
				labels [1] = LabelFactory.createLabel (caption, font, sldFont.getColor (feature), metrics, feature, symbolizer.getHalo(), x, y, w, h, rotation*Math.PI, new double [] {0.0, 1.0}, new double [] {displacement [0], -displacement [1]});
				labels [2] = LabelFactory.createLabel (caption, font, sldFont.getColor (feature), metrics, feature, symbolizer.getHalo(), x, y, w, h, rotation*Math.PI, new double [] {1.0, 1.0}, new double [] {-displacement [0], -displacement [1]});
				labels [3] = LabelFactory.createLabel (caption, font, sldFont.getColor (feature), metrics, feature, symbolizer.getHalo(), x, y, w, h, rotation*Math.PI, new double [] {1.0, 0.0}, new double [] {-displacement [0], displacement [1]});
				labels [4] = LabelFactory.createLabel (caption, font, sldFont.getColor (feature), metrics, feature, symbolizer.getHalo(), x, y, w, h, rotation*Math.PI, new double [] {0.0, 0.5}, new double [] {displacement [0], 0});
				labels [5] = LabelFactory.createLabel (caption, font, sldFont.getColor (feature), metrics, feature, symbolizer.getHalo(), x, y, w, h, rotation*Math.PI, new double [] {0.5, 1.0}, new double [] {0, -displacement [1]});
				labels [6] = LabelFactory.createLabel (caption, font, sldFont.getColor (feature), metrics, feature, symbolizer.getHalo(), x, y, w, h, rotation*Math.PI, new double [] {1.0, 0.5}, new double [] {-displacement [0], 0});
				labels [7] = LabelFactory.createLabel (caption, font, sldFont.getColor (feature), metrics, feature, symbolizer.getHalo(), x, y, w, h, rotation*Math.PI, new double [] {0.5, 0.0}, new double [] {0, displacement [1]});					
...
//				double [] displacement = pPlacement.getDisplacement( feature );
				...
				if (intersection != null) {
					...
					labels [0] = LabelFactory.createLabel (caption, font, sldFont.getColor (feature), metrics, feature, symbolizer.getHalo(), x, y, w, h, rotation*Math.PI, new double [] {0.5, 0.5}, new double [] {0, 0}); 
					labels [1] = LabelFactory.createLabel (caption, font, sldFont.getColor (feature), metrics, feature, symbolizer.getHalo(), x, y, w, h, rotation*Math.PI, new double [] {0.5, 0.0}, new double [] {0, 0});
					labels [2] = LabelFactory.createLabel (caption, font, sldFont.getColor (feature), metrics, feature, symbolizer.getHalo(), x, y, w, h, rotation*Math.PI, new double [] {0.5, 1.0}, new double [] {0, 0});
	...
	/**
	 * Determines <tt>LabelChoice</tt>s for the given <tt>GM_MultiCurve</tt> where a
	 ...
	 */
	static ArrayList createLabelChoices (GM_MultiCurve multiCurve,   
	...
	/**
	 * Determines <tt>LabelChoice</tt>s for the given <tt>GM_Curve</tt> where a
	 * <tt>Label</tt> could be drawn. For each <tt>LabelChoice</tt>, three candidates
	 * are generated: one on the line, one above it and one below.
	 * <p>
	 * @param curve
	 ...
	 * @throws FilterEvaluationException
	 */
	static ArrayList createLabelChoices (GM_Curve curve,
		LabelDisplayElement element, Graphics2D g, GeoTransform projection)
		throws FilterEvaluationException {
			...
			if (LabelFactory.getDistance (boxStartX, boxStartY, x, y) >= w) {
				...
				switch (placementType) {
					case LinePlacement.TYPE_ABSOLUTE: {
						Label label = LabelFactory.createLabel (caption, font, sldFont.getColor (feature), metrics, feature, symbolizer.getHalo(), boxStartX, boxStartY, (int) width, (int) height, rotation, new double [] {0.0, 0.5}, new double [] {(w - width) / 2, perpendicularOffset});
					...
					case LinePlacement.TYPE_ABOVE: {
						Label upperLabel = LabelFactory.createLabel (caption, font, sldFont.getColor (feature), metrics, feature, symbolizer.getHalo(), boxStartX, boxStartY, (int) width, (int) height, rotation, new double [] {0.0, 0.5}, new double [] {(w - width) / 2, delta + deviation [0]});
					...
					case LinePlacement.TYPE_BELOW: {
						Label lowerLabel = LabelFactory.createLabel (caption, font, sldFont.getColor (feature), metrics, feature, symbolizer.getHalo(), boxStartX, boxStartY, (int) width, (int) height, rotation, new double [] {0.0, 0.5}, new double [] {(w - width) / 2, -delta - deviation [1]});
					...
					case LinePlacement.TYPE_CENTER: {
						Label centerLabel = LabelFactory.createLabel (caption, font, sldFont.getColor (feature), metrics, feature, symbolizer.getHalo(), boxStartX, boxStartY, (int) width, (int) height, rotation, new double [] {0.0, 0.5}, new double [] {(w - width) / 2, 0.0});
