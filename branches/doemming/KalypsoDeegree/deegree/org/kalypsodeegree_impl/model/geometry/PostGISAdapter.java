...
public class PostGISAdapter {
     ...
     * @throws GM_Exception 
     */
    public static GM_Object wrap( PGgeometry geom, CS_CoordinateSystem crs) 
                                  throws GM_Exception {
    ...
    private static GM_Point createPoint(Point ppoint, CS_CoordinateSystem crs)  
        ...
        if ( ppoint.getDimension() == 2 ) {
            ...
            p = GeometryFactory.createGM_Position( new double[] {ppoint.getX(), 
                                                         ppoint.getY()} );                    
    ...
    private static GM_Curve createCurve(LineString lineString, CS_CoordinateSystem crs) 
        ...
        if ( lineString.getDimension() == 2 ) {
            ...
            for ( int i = 0; i < lineString.numPoints(); i++ ) {
                ...
                // GeometryFactory
                double[] d = new double[] { lineString.getPoint( i ).getX(), 
                                            lineString.getPoint( i ).getY() };
     ...
     * @param mlinestring postgis multi lineString
     */
     ...
     * @param mpolygon postgis multi polygon
     */
     ...
     *
     * @param surface deegree GM_Surface
     */
     ...
     *
     * @param mpoint deegree GM_MultiPoint
     */
     ...
     *
     * @param mcurve deegree GM_MultiCurve
     */
     ...
     *
     * @param msurface deegree GM_MultiSurface
     */
