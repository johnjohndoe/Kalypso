...
* A implementing class should  act as a dispatcher deligating the
* incoming request and responses to specialized classes (but don't 
* have to).
* <p>
* The dispatcher acts as source of events to inform
* registered WFSResponseListener.
*
* <p>----------------------------------------------------------------------</p>
*
* @author Andreas Poth
