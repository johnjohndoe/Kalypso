...
public class SimulationKalypsoRiskModelspecHelper implements ISimulationSpecKalypsoRisk
{
  ...
  {
    final List<MODELSPEC_KALYPSORISK> inputs = new ArrayList<>();
    ...
    final List<MODELSPEC_KALYPSORISK> outputs = new ArrayList<>();
    outputs.add( MODELSPEC_KALYPSORISK.CONTROL_MODEL );
    outputs.add( MODELSPEC_KALYPSORISK.RASTER_MODEL );
    outputs.add( MODELSPEC_KALYPSORISK.VECTOR_MODEL );
