...
/**
 * Binding class for {http://www.tuhh.de/initialValues}IniHyd.
 * 
...
public class IniHyd extends Feature_Impl
{
  ...
  private static final QName PROP_BI = new QName( NS_INIVALUES, "bi" );//$NON-NLS-1$

  public IniHyd( final Object parent, final IRelationType parentRelation, final IFeatureType ft, final String id, final Object[] propValues )
  {
    super( parent, parentRelation, ft, id, propValues );
  }

  public String getNaHydrotopID( )
  {
