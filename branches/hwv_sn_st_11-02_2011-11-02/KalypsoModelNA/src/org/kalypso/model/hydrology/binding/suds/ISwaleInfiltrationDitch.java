...
{
  String IDEAL_LANDUSE = "MRS_N"; //$NON-NLS-1$

  QName QN_PROPERTY_ELEMENT_TYPE = new QName( NaModelConstants.NS_NASUDS, "elementType" ); // suds:EnumSwaleInfiltrationDitchType //$NON-NLS-1$
