...
{
  private final List<ICalculationUnit> m_selectedSubUnits = new ArrayList<ICalculationUnit>();
  ...
  public void createControl( final Composite parent )
  {
    ...
    final List<ICalculationUnit> availableSubUnits = new ArrayList<ICalculationUnit>();
