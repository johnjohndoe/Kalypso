...
<om:Observation xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:gml="http://www.opengis.net/gml"
	...
	<om:time />
	<om:procedure>
		<om:ObservationProcedure gml:id="proc_telemackalypso_simulation">
			<gml:description>Telemac·Kalypso Simulation</gml:description>
			<gml:name>TelemacKalypso Simulation</gml:name>
			<om:method />
		</om:ObservationProcedure>
	</om:procedure>
	<om:observedProperty>
		<swe:Phenomenon gml:id="phen_iteration_rmakalypso">
			<gml:name>TelemacKalypso Iteration</gml:name>
		</swe:Phenomenon>
	</om:observedProperty>
