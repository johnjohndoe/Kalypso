...
public class TypeInfo
{
   ...
   *
   */
  public static final boolean is1DEdge( final IFE1D2DEdge edge )
  {
    if( edge == null )
    {
      return false;
    }
    final IFeatureBindingCollection<IFE1D2DElement> containers = edge.getContainers();
    for( final IFE1D2DElement element : containers )
    {
   ...
   *
   */
  public static final boolean is1DEdgeFeature( final Feature edgeFeature )
  {
    if( edgeFeature == null )
    {
      return false;
    }
    final IFE1D2DEdge edge = (IFE1D2DEdge) edgeFeature.getAdapter( IFE1D2DEdge.class );
   ...
   *
   */
  public static final boolean is2DEdge( final IFE1D2DEdge edge )
  {
    if( edge == null )
    {
      return false;
   ...
   * @deprecated Test for instanceof IElement1D instead.
   */
  @Deprecated
  public static final boolean isElement1DFeature( final Feature feature )
  {
    if( feature == null )
    {
      return false;
   ...
   * @return true if the given feature is an element 1d feature
   * 
   * @deprecated Test for instanceof {@link IPolyElement} instead.
   */
  @Deprecated
  public static final boolean isPolyElementFeature( final Feature feature )
  {
    if( feature == null )
    {
      return false;
  ...
  public static boolean isNode( final Feature selecFeature )
  {
