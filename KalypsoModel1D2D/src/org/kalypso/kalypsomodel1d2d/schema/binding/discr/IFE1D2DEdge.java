...
/**
 * Interface for the class that represents an edge in a mesh. An edge always has 2 nodes.
 * 
 * @author Stefan Kurzbach
 */
public interface IFE1D2DEdge extends Feature
{
  ...
  void addLinkedElement( IFE1D2DElement element );

  void removeLinkedElement( IFE1D2DElement element );

  IFE1D2DElement[] getLinkedElements( );

  void setNodes( IFE1D2DNode node0, IFE1D2DNode node1 );
  ...
  boolean containsNode( IFE1D2DNode node );
}
