...
public class RoughnessHandler
{
  ...
  private final Map<String, String> m_protoClasses = new HashMap<String, String>();

  private final Map<String, IRoughnessCls> m_newClasses = new HashMap<String, IRoughnessCls>();
