...
public class DiscretisationModelInserter
{
  ...
  public IStatus commitChanges( )
  {
    ...
    final IStatusCollector stati = new StatusCollector( KalypsoModel1D2DPlugin.PLUGIN_ID );
  ...
  IStatus insertElementIntoModel( final IPolygonWithName item )
  {
    ...
    catch( final Exception e )
    {
      ...
      return new Status( IStatus.ERROR, KalypsoModel1D2DPlugin.PLUGIN_ID, message, e );
    }
  }
}