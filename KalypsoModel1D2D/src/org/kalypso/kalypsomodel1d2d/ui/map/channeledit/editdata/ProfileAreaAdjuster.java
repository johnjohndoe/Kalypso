...
class ProfileAreaAdjuster
{
  ...
  public IProfil execute( final IProfil adjustingProfile )
  {
    ...
    if( diffArea > 0.10 )
    {
      final String s = String.format( "Schlauchgenerator: Station %.4f - Fl‰chenausgleich nicht hinreichend genau: %f - %f", adjustingProfile.getStation(), originalArea, areaNew );
