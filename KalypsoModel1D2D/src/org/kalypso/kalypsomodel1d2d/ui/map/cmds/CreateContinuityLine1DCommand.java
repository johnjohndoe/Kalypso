...
public class CreateContinuityLine1DCommand implements IFeatureChangeCommand
{
  ...
  public CreateContinuityLine1DCommand( final IFEDiscretisationModel1d2d model, final IFE1D2DNode node )
  {
    m_model = model;
    m_node = node;
  }
  ...
  public void process( ) throws Exception
  {
    ...
    m_line = m_model.createContinuityLine1D( m_node );
