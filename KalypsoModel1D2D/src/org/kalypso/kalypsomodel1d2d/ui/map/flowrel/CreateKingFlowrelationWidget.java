 ...
 */
public class CreateKingFlowrelationWidget extends AbstractCreateFlowrelationWidget
{
  ...
  {
    final IFeatureType newFT = GMLSchemaUtilities.getFeatureTypeQuiet( IKingFlowRelation.QNAME );
