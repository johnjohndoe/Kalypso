...
public class CreateTeschkeFlowrelationWidget extends AbstractCreateFlowrelationWidget
{
  ...
  {
    super( Messages.getString("org.kalypso.kalypsomodel1d2d.ui.map.flowrel.CreateTeschkeFlowrelationWidget.0"), Messages.getString("org.kalypso.kalypsomodel1d2d.ui.map.flowrel.CreateTeschkeFlowrelationWidget.1"), ITeschkeFlowRelation.QNAME ); //$NON-NLS-1$ //$NON-NLS-2$
  }
   ...
   */
  @Override
  protected ITeschkeFlowRelation createNewFeature( final CommandableWorkspace workspace, final Feature parentFeature, final IRelationType parentRelation, final Feature modelElement )
  {
    final IFeatureType newFT = GMLSchemaUtilities.getFeatureTypeQuiet( ITeschkeFlowRelation.QNAME );
