...
public class CloneCalculationUnitWizard extends Wizard
{
  ...
  private ICalculationUnit m_calcUnitToClone;
  ...
  public boolean performFinish( )
  {
    ...
    final CreateCalculationUnitCmd cmd = new CreateCalculationUnitCmd( m_calcUnitToClone.getFeature().getQualifiedName(), Util.getModel( IFEDiscretisationModel1d2d.class ), calcUnitName, m_calcUnitToClone )
    {
      /**
