...
public class CloneCalculationUnitWizard extends Wizard
{
  ...
  public boolean performFinish( )
  {
    ...
    final CreateCalculationUnitCmd cmd = new CreateCalculationUnitCmd( m_calcUnitToClone.getQualifiedName(), Util.getModel( IFEDiscretisationModel1d2d.class.getName(), IFEDiscretisationModel1d2d.class ), calcUnitName, m_calcUnitToClone )
    {
      /**
