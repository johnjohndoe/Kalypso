 ...
 * @author schlienger
 */
public class MultiTupleResultTest extends TestCase
{
  private static int rowCount = 0;
  private MultiTupleResultModel model;
  ...
  public static MultiTupleResultModel createTestModel()
  {
    MultiTupleResultModel model = new MultiTupleResultModel();
    
    IObservation<TupleResult> obs1 = ObservationTest.createTestObservation();
