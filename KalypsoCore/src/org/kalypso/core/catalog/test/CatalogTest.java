...
public class CatalogTest extends TestCase
{
  ...
  public void testCatalog( ) throws Exception
  {
    try
    {
      ...
      // vector.addElement( "eins" );
      // vector.addElement( "zwei" );
      // vector.addElement( "drei" );
      //
      // CatalogEntry.addEntryType( entryType, vector.size() );
      // final CatalogEntry entry = new CatalogEntry( entryType, vector );
