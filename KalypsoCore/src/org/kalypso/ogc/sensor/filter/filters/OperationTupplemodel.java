...
public class OperationTupplemodel implements ITuppleModel
{
    ...
    public OperationTupplemodel(double operand, int operation,
            ITuppleModel baseModel)
    {
        m_operand = operand;
    ...
    public Object getElement(int index, IAxis axis) throws SensorException
    {
        ...
        throw new UnsupportedOperationException(getClass().getName()
                + " unterstuetzt den datentyp " + object.getClass().getName()
                + " nicht.");
    }

    /*
     * 
     * @see org.kalypso.ogc.sensor.ITuppleModel#setElement(int,
     *      java.lang.Object, org.kalypso.ogc.sensor.IAxis)
     */
