...
public class RasterMetaReaderGeo implements IRasterMetaReader
{
  ...
  public String getUpperLeftCornerY( )
  {
    try
    {
      final double[] modelBounds = m_getTiffReader.getModelBounds();
  ...
  public String getVectorXy( )
  {
    try
    {
      final double[] scale = m_getTiffReader.getPixelScale();
  ...
  public String getVectorYx( )
  {
    try
    {
      final double[] points = m_getTiffReader.getTiepoints();
