...
/**
 * For testing purposes. Just remembers all given files.
 * 
 * @author belger
 */
public class SimpleCalcResultEater implements ICalcResultEater
{
  ...
  public File getResult( final String id )
  {
    return (File)m_files.get( id );
  }
}
