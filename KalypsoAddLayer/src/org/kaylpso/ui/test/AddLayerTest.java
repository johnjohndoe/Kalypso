...
public class AddLayerTest extends TestCase
{
  ...
  public void testReadImage()
  {
    ...
    try
    {
      ...
      rx = ( new Double( br.readLine() ) ).doubleValue();
      ry = ( new Double( br.readLine() ) ).doubleValue();
    ...
    double maxy = ulcy;
    GM_Envelope bbox = GeometryFactory.createGM_Envelope( ulcx, ulcy + ( height * dy ),
         ulcx + ( width * dx ), ulcy );
