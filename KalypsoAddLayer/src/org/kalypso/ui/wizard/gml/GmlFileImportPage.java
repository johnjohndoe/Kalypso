...
public class GmlFileImportPage extends WizardPage implements SelectionListener, ModifyListener
{
  ...
  public void widgetSelected( SelectionEvent e )
  {
    ...
    {
      final KalypsoResourceSelectionDialog dialog = new KalypsoResourceSelectionDialog( getShell(), null, "Ausw‰hlen einer GML Datei", new String[] { "gml" }, m_selectedProject, new ResourceSelectionValidator() );
      dialog.open();
