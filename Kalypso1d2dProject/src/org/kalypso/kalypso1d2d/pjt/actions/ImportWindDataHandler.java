 ...
 * @author ig
 */
public class ImportWindDataHandler extends AbstractHandler
{
  ...
  public Object execute( final ExecutionEvent event ) throws ExecutionException
  {
    ...
    try
    {
      ...
      final IStructuredSelection selection = new StructuredSelection( new Object[] { lWindModel, modelFolder, temFolder } );
