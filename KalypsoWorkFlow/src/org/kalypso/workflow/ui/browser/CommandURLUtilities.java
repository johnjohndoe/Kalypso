 ...
 * @author doemming
 */
public class CommandURLUtilities
{
  ...
  public static boolean runCommands( final WorkflowContext workflowContext, final List<String> commands )
  {
    for( final String command : commands )
    {
      boolean success = run( workflowContext, command );
      if( !success )
        return false; // abort
    }
