package org.kalypso.KalypsoManualWSPM.help;
...
public interface IKalypsoHelpContextIds {
	...
	public static final String einfuehrungkalypso_wspm = PREFIX
			+ "einfuehrungkalypso_wspm";

	public static final String kalypso_wspm_Datenakquisition = PREFIX
			+ "kalypso_wspm_Datenakquisition";

	public static final String kalypso_wspm_AllgemeineBegriffe = PREFIX
			+ "kalypso_wspm_AllgemeineBegriffe";

	public static final String kalypso_wspm_Allgemeines = PREFIX
			+ "kalypso_wspm_Allgemeines";

	public static final String kalypso_wspm_Perspektiven_Views = PREFIX
			+ "kalypso_wspm_Perspektiven_Views";

	public static final String kalypso_wspm_Perspektive_Spiegellinienberechnung = PREFIX
			+ "kalypso_wspm_Perspektive_Spiegellinienberechnung";

	public static final String kalypso_wspm_Perspektive_Profileditor_manager = PREFIX
			+ "kalypso_wspm_Perspektive_Profileditor_manager";

	public static final String kalypso_wspm_neues_projekt = PREFIX
			+ "kalypso_wspm_neues_projekt";

	public static final String kalypso_wspm_wspwin_Projekt_importieren = PREFIX
			+ "kalypso_wspm_wspwin_Projekt_importieren";

	public static final String kalypso_wspm_vorhandene_Projekte_bearbeiten = PREFIX
			+ "kalypso_wspm_vorhandene_Projekte_bearbeiten";
	...
	public static final String kalypso_wspm_exportieren_in_wspwin = PREFIX
			+ "kalypso_wspm_exportieren_in_wspwin";
	...
	public static final String kalypso_wspm_Profildiagramm = PREFIX
			+ "kalypso_wspm_Profildiagramm";

	public static final String kalypso_wspm_Profileditortabelle = PREFIX
			+ "kalypso_wspm_Profileditortabelle";
	...
	public static final String kalypso_wspm_Profileditorlegende_Rauheit = PREFIX
			+ "kalypso_wspm_Profileditorlegende_Rauheit";

	public static final String kalypso_wspm_Profileditorlegende_Rauheitszuweisung_Polygone = PREFIX
			+ "kalypso_wspm_Profileditorlegende_Rauheitszuweisung_Polygone";

	public static final String kalypso_wspm_Profileditorlegende_Bewuchs = PREFIX
			+ "kalypso_wspm_Profileditorlegende_Bewuchs";
	...
	public static final String kalypso_wspm_Abflussereignisse_Neu = PREFIX
			+ "kalypso_wspm_Abflussereignisse_Neu";

	public static final String kalypso_wspm_prozessing = PREFIX
			+ "kalypso_wspm_prozessing";

	public static final String kalypso_wspm_Berechnungsvariante_editieren = PREFIX
			+ "kalypso_wspm_Berechnungsvariante_editieren";

	public static final String kalypso_wspm_Berechnungsvariante_Neu = PREFIX
			+ "kalypso_wspm_Berechnungsvariante_Neu";
	...
	public static final String kalypso_wspm_Berechnungsparameter_Berechnungsabschnitt = PREFIX
			+ "kalypso_wspm_Berechnungsparameter_Berechnungsabschnitt";

	public static final String kalypso_wspm_Berechnungsparameter_Numerische_Parameter = PREFIX
			+ "kalypso_wspm_Berechnungsparameter_Numerische_Parameter";

	public static final String kalypso_wspm_Berechnungsparameter_Untere_Randbedingung = PREFIX
			+ "kalypso_wspm_Berechnungsparameter_Untere_Randbedingung";

	public static final String kalypso_wspm_Berechnung_Starten = PREFIX
			+ "kalypso_wspm_Berechnung_Starten";

	public static final String kalypso_wspm_Postprozessing = PREFIX
			+ "kalypso_wspm_Postprozessing";

	public static final String kalypso_wspm_Ergebnis_Ausgabe = PREFIX
			+ "kalypso_wspm_Ergebnis_Ausgabe";
	...
	public static final String kalypso_wspm_Karten_Symbolleiste = PREFIX
			+ "kalypso_wspm_Karten_Symbolleiste";

	public static final String kalypso_wspm_Karten_Gliederung = PREFIX
			+ "kalypso_wspm_Karten_Gliederung";
