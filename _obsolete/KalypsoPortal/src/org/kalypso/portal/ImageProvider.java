...
public class ImageProvider
{
  ...
  {
    return id( "org.kalypso.portal", location );
  }
  public static final ImageDescriptor IMAGE_MEASURE_RETENSION_BASIN = id( "icons/RHB_icon.gif" );
  public static final ImageDescriptor IMAGE_MEASURE_SWALT_TRENCH = id( "icons/MRS_icon.gif" );
  public static final ImageDescriptor IMAGE_MESASURE_CHANGE_SEALING = id( "icons/Entsiegelung.gif" );
