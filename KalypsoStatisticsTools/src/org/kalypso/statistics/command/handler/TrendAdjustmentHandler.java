...
import org.kalypso.statistics.gui.wizards.trendAdjustment.TrendAdjustmentWizard;
import org.kalypso.statistics.utils.AppUtils;

public class TrendAdjustmentHandler extends AbstractHandler implements IHandler {

	public static final String ID = TrendAdjustmentHandler.class.getCanonicalName();
	...
	public Object execute(final ExecutionEvent event) throws ExecutionException {
		...
		if (part != null && part instanceof TimeseriesListView) {
			...
			final IWizardDescriptor wizardDesc = PlatformUI.getWorkbench().getNewWizardRegistry().findWizard(TrendAdjustmentWizard.ID);
			try {
