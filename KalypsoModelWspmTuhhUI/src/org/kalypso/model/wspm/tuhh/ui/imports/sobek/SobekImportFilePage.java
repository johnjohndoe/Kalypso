...
public class SobekImportFilePage extends WizardPage
{
  ...
  private void createInputDirControls( final Composite panel )
  {
    final Label destinationLabel = new Label( panel, SWT.NONE );
    destinationLabel.setText( "SOBEK Project" );
    ...
    final Control historyControl = directoryBinding.createDirectoryFieldWithHistory( panel, modelHistory );
    ...
    final Button searchButton = directoryBinding.createDirectorySearchButton( panel, historyControl, getWizard().getWindowTitle(), message );
