-- TODO
-- alle Rauheitswerte mit 0.0 l�schen, damit ab 0.04 die klasse benutzt wird?

ALTER TABLE pdb.roughness
   ALTER COLUMN k_value TYPE numeric(8,3);

ALTER TABLE pdb.point
   ALTER COLUMN roughness_k_value TYPE numeric(8,3);
