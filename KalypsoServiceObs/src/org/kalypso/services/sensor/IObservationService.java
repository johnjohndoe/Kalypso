...
{
  /**
   * @return useful (short) description that will be displayed to the user in
   *         order to identify this service.
   */
  public String getDescription() throws RemoteException;

  /**
   * @return observation bean if itembean is adaptable to a IObservation.
   ...
   * 
   * @return the DataHandler can be used to open a stream on the underlying
   *         Zml-Observation.
   */
  public DataBean readData( final String href ) throws RemoteException;

  /**
   * Call this method once client is done with manipulation of the data. The
   * service will then free dependent resources.
   * 
   * @param dataId the id of the DataBean that the client did receive after
   *          calling readData( String )
   */
   ...
   * observation.
   */
  public void writeData( final ObservationBean observation,
      final DataHandler data ) throws RemoteException;
}