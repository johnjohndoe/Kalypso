...
<gml:Dictionary xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  xmlns:st="http://www.seegrid.csiro.au/xml/st" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:gml="http://www.opengis.net/gml" xmlns:om="http://www.opengis.net/om" xmlns:swe="http://www.opengis.net/swe" gml:id="components">
  ...
  <gml:dictionaryEntry>
    <swe:ItemDefinition gml:id="Width">
      <gml:description>Breite</gml:description>
  ...
  <gml:dictionaryEntry>
    <swe:ItemDefinition gml:id="RunoffChannel">
      ...
      <gml:name>Q Flussschlauch</gml:name>
      <swe:property xlink:href="#phenomenonRunoff" />
      <swe:representation>
        <swe:SimpleType>
          <st:restriction base="decimal">
  ...
  <gml:dictionaryEntry>
    <swe:ItemDefinition gml:id="AreaFloodplain">
      ...
      <gml:name>Fläche Vorland</gml:name>
      <swe:property xlink:href="#phenomenonArea" />
      <swe:representation>
        <swe:SimpleType>
          <st:restriction base="decimal">
  ...
  <gml:dictionaryEntry>
    <swe:ItemDefinition gml:id="WidthFloodplain">
      ...
      <gml:name>Breite Vorland</gml:name>
      <swe:property xlink:href="#phenomenonWidth" />
      <swe:representation>
        <swe:SimpleType>
          <st:restriction base="decimal">
