 ...
 */
public class LengthSectionColumnFroude extends AbstractLengthSectionColumn
{
  public final static double gravity = 9.81;

  public LengthSectionColumnFroude( )
  {
    super( IWspmConstants.LENGTH_SECTION_PROPERTY_FROUDE );
  }
  ...
  protected double calculateValue( final IRecord record )
  {
    ...
    return buildFroude( record, velocityComponent, areaComponent, widthComponent );
  }

  private double buildFroude( final IRecord record, final int velocityComponent, final int areaComponent, final int widthComponent )
  {
    ...
    if( velocityValue instanceof Number && areaValue instanceof Number && widthValue instanceof Number )
    {
      ...
      return velocity / (Math.sqrt( divisor ));
    }
    else
      return Double.NaN;
  }
