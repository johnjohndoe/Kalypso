 ...
 */
public class TrapezProfileObjectData extends AbstractProfileObjectData
{
  ...
  private final double m_steigung;

  private final double m_sohlGefaelle;

  private final double m_rauhheit;

  public TrapezProfileObjectData( final double bezugspunktX, final double bezugspunktY, final double hoehe, final double breite, final double steigung, final double sohlGefaelle, final double rauhheit )
  {
