...
public class WspWinProfileWriter
{
  ...
  public WspWinProfileWriter( final IProfil profil, final int profileNumber, final String roughnessType, final boolean preferRoughnessClasses, final boolean preferVegetationClasses )
  {
    m_profil = profil;
