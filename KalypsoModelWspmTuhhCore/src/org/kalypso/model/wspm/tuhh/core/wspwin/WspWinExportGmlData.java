...
{
  private final Collection<WspmWaterBody> m_waterBodies = new HashSet<WspmWaterBody>();

  private final Map<WspmWaterBody, Set<TuhhReach>> m_reaches = new HashMap<WspmWaterBody, Set<TuhhReach>>();
