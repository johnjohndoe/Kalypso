...
public class KnaufBridgeProfileBuilder extends AbstractKnaufProfileBeanBuilder
{
  ...
  private IStatus moveBridgeProfile( final double distance )
  {
    ...
    {
      final String msg = String.format( "Konflikt! Kann KalypsoWSPM Br¸ckenprofil nicht in Unterwasser-Richtung verschieben. Neue Stationierung %.3f km kollidiert mit bestehenden Nachbar-Profilen (%.3f km, %.3f km)", station, previous.getStation(), next.getStation() );
    ...
    return new Status( IStatus.OK, KalypsoModelWspmTuhhCorePlugin.getID(), "Verschiebung des Br¸ckenprofils in Unterwasser-Richtung" );
  }
