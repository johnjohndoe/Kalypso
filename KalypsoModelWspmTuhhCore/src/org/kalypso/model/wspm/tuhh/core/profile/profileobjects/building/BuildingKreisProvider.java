 ...
 */
public class BuildingKreisProvider implements IProfileObjectProvider
{
  @Override
  public BuildingKreis createProfileObject( final IProfile profile )
  {
  ...
  public IProfileObject buildProfileObject( final IProfile profile, final Feature profileObjectFeature )
  {
    ...
    final BuildingKreis profileObject = createProfileObject( profile );
  ...
  private void fillMetadata( final IObservation<TupleResult> profileObjectObservation, final BuildingKreis profileObject )
  {
