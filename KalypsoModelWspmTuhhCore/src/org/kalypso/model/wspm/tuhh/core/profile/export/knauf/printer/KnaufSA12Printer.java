...
public class KnaufSA12Printer extends AbstractKnaufPrinter
{
  ...
  {
    final DateFormat sdf = DateFormat.getDateTimeInstance( DateFormat.MEDIUM, DateFormat.SHORT );
    final Calendar calendar = Calendar.getInstance( KalypsoCorePlugin.getDefault().getTimeZone() );

    return String.format( Messages.getString("KnaufSA12Printer_0"), sdf.format( calendar.getTime() ) ); //$NON-NLS-1$
  }
