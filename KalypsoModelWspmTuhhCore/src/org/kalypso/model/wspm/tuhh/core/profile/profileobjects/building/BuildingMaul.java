...
{
  public static final String ID = "urn:ogc:gml:dict:kalypso:model:wspm:profileBuildingTypes#MAUL"; //$NON-NLS-1$
  ...
  public String getPropertyLabel( final String property )
  {
    if( PROPERTY_HOEHE.equals( property ) )
      return Messages.getString("BuildingMaul_0"); // Overall Height //$NON-NLS-1$
