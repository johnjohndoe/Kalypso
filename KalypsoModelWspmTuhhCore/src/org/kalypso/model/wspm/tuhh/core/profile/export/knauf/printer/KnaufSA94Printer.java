 ...
 * @author Dirk Kuch
 */
public class KnaufSA94Printer extends AbstractKnaufPrinter
{

  public KnaufSA94Printer( final KnaufSA94Bean bean )
  {
    super( bean );
  }

  @Override
  protected KnaufSA94Bean getBean( )
  {
    return (KnaufSA94Bean) super.getBean();
  }
