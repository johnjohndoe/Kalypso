 ...
 * @author Dirk Kuch
 */
public class KnaufProfileFeatureStationComparator implements Comparator<KnaufProfileWrapper>
{
  private final TuhhStationComparator m_stationComparator;

  public KnaufProfileFeatureStationComparator( final boolean isDirectionUpstreams )
  {
