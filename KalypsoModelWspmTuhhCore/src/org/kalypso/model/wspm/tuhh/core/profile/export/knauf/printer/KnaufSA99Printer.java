 ...
 * @author Dirk Kuch
 */
public class KnaufSA99Printer extends AbstractKnaufPrinter
{

  public KnaufSA99Printer( final KnaufSA99Bean bean )
  {
    super( bean );
  }

  @Override
  protected KnaufSA99Bean getBean( )
  {
    return (KnaufSA99Bean) super.getBean();
  }
