...
public class SpreeCalcJob extends WasyCalcJob
{
  ...
  protected WQInfo[] getWQMap()
  {
    return new WQInfo[]
    {
        new WQInfo( "Schirgisw", "W_SCHIRG", 1 ),
        new WQInfo( "Bautzen WB", "W_BAUTZWB", 3 ),
        new WQInfo( "Gröditz 1", "W_GROEDI", 3 ),
        new WQInfo( "Lieske", "W_LIESKE", 2 ),
        new WQInfo( "Jänkendorf", "W_JAENKD", 3 ),
        new WQInfo( "Holtendorf", "W_HOLTD", 1 ),
        new WQInfo( "Särichen", "W_SAERI", 4 ),
        new WQInfo( "Boxberg", "W_BOXBRG", 4 ),
        new WQInfo( "Sprey", "W_SPREY", 1 ),
        new WQInfo( "Spreewitz", "W_SPWITZ", 1 ),
        new WQInfo( "Spremberg", "W_SPREMB", 0 ) };
  }
