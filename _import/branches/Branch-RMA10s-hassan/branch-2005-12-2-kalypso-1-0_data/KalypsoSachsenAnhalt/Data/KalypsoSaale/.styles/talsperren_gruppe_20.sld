...
<StyledLayerDescriptor version="String" xmlns="http://www.opengis.net/sld" xmlns:gml="http://www.opengis.net/gml" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
        <NamedLayer>
                                ...
                                <Rule>
                                        ...
                                        <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
                                                <ogc:PropertyIsEqualTo>
                                                        ...
                                                        <ogc:Literal>573100</ogc:Literal>
                                                </ogc:PropertyIsEqualTo>
                                        </ogc:Filter>
                                        ...
                                        <TextSymbolizer>
                                                ...
                                                <Label>
                                                        <ogc:PropertyName>TS_NAME</ogc:PropertyName>
                                                </Label>
                                                <Font>
                ...
                <UserStyle>
                        <Name>Ueberleitung</Name>
                        <Title>Ueberleitung</Title>
                        <IsDefault>1</IsDefault>
                        <FeatureTypeStyle>
                                <Name>Ueberleitung</Name>
                                <Rule>
                                        ...
                                        <PointSymbolizer>
                                                ...
                                                <Graphic>
                                                        <Mark>
                                                                <WellKnownName>triangle</WellKnownName>
                                                                <Fill>
                                                                        <CssParameter name="fill">#d5d5ff</CssParameter>
                                                                </Fill>
                                                                <Stroke>
                                                                        <CssParameter name="stroke">#111111</CssParameter>
                                                                        <CssParameter name="stroke-width">1.0</CssParameter>
