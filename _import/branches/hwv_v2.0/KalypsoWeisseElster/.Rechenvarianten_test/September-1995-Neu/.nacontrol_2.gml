...
<rrmControl:NAModellControl xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:gml="http://www.opengis.net/gml" xmlns:xs="http://www.w3.org/2001/XMLSchema-instance" xmlns:rrmControl="org.kalypso.namodell.control" xs:schemaLocation="org.kalypso.namodell.control project:/.model/schema/nacontrol.xsd" gml:fid="ID000000">
 ...
 <rrmControl:CatchmentsBianf>1.219</rrmControl:CatchmentsBianf>
 <rrmControl:CatchmentsFaktorRetobTetint>1.185</rrmControl:CatchmentsFaktorRetobTetint>
 <rrmControl:CatchmentsFaktn>1.28</rrmControl:CatchmentsFaktn>
 <rrmControl:CatchmentsFaktorAigw>1.499</rrmControl:CatchmentsFaktorAigw>
 <rrmControl:KMChannels>//rrm:KMChannel[@gml:fid="KMChannel1700"]</rrmControl:KMChannels>
 <rrmControl:KMChannelsFaktorRkf>1.193</rrmControl:KMChannelsFaktorRkf>
 <rrmControl:KMChannelsFaktorRnf>0.826</rrmControl:KMChannelsFaktorRnf>
