 ...
 * @author kuepfer
 */
public class NaSimulationDataProvider implements ISimulationDataProvider
{
  ...
  public NaSimulationDataProvider( final File calcDir )
  {
    m_calcDir = calcDir;
  }
  ...
  public Object getInputForID( String id ) throws SimulationException
  {
    ...
    {
      throw new SimulationException( "Error while creating data provieder for RRM ", e );
    }
    return null;
  }
