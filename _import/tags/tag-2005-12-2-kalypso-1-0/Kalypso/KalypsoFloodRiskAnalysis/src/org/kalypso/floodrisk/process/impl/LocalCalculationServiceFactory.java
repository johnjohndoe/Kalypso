 ...
 */
public class LocalCalculationServiceFactory implements ICalculationServiceProxyFactory
{
  ...
  public ICalculationService createService()
  {
    try
    {
      ...
      ProcessExtension[] extensions = ProcessExtensionReader.retrieveExtensions();
      ...
      return new CalcJobServiceProxyWrapper( new LocalCalculationService( localCalcJobFactory,
   ...
   *  
   */
  private ICalcJobFactory createCalcJobFactoryForLocalProcesses( ProcessExtension[] extensions )
  {
