...
public interface PSICompact {
    ...
    /**
     * Archiv Status Der Archivwert ist manuell korrigiert worden, d.h. das Ergebnis der automatischen Verdichtung ist überschrieben worden. Der Wert kann für die Prognose verwendet werden.
     */
    public static int STATUS_MANKOR = 1;
    /**
     * Archiv Status Mindestens ein Ersatzwert ist in die automatische Wertbildung eingeflossen, d.h. der Wert ist für die Prognose u.U. nicht verwendbar.
     */
    public static int STATUS_ERSALLG = 2;
    /**
     * Archiv Status Der Archivwert wurde durch die Simulation, bzw. Prognose gebildet. Dieser Status wird automatisch gesetzt, wenn Archivwerte durch die Prognose geschrieben wurden.
     */
    public static int STATUS_REKO = 3;
    /**
     * Archiv Status Der Archivwert wurde durch eine automatische Nachberechnung gebildet. Der Wert kann für die Prognose verwendet werden.
     */
    public static int STATUS_AUTO = 4;
    /**
     * Archiv Status Der Archivwert wurde automatisch nachgeführt. Die automatische Nachführung sorgt beim Start des Archivdienstes automatisch dafür, dass nicht vorhandene Archivwerte erzeugt werden. Wie die Archivwerte erzeugt werden, richtet sich nach der parametrierten Nachführstrategie dieses Objektes. Der Wert kann für die Prognose u.U. nicht verwendet werden.
     */
    public static int STATUS_NACH = 5;
    /**
     * Archiv Status Ein Archivwert wird als normiert bezeichnet, wenn er nicht existiert, d.h. nicht oder noch nicht geschrieben wurde. Der Wert kann für die Prognose nicht verwendet werden.
     */
    public static int STATUS_NORM = 6;
    /**
     * Archiv Status Mindestens ein normierter Archivwert ist in die Wertbildung während der Verdichtung eingeflossen. Der Wert kann für die Prognose u.U. nicht verwendet werden.
     */
    ...
    // TYPE_MEASUREMENT bezeichnet eine Messung und somit die Eingangsdaten für die Prognose
    // TYPE_VALUE bezeichnet einen Messwert und somit die Ausgangsdaten der Prognose
    /**
     * Typ Undefiniert
     */
    ...
    public class ObjectMetaData implements Serializable{
         ...
         * @param idParam
         */
        public ObjectMetaData(String idParam, int unitParam, double alarm1Param, double alarm2Param, double alarm3Param, double alarm4Param, int mapNoParam, int rightParam, int heightParam, int[] archiveDataParam, double levelParam, String levelUnitParam) {
        ...
        /**
         * @param alarm1 The alarm1 to set.
         */
        ...
        /**
         * @param alarm2 The alarm2 to set.
         */
        ...
        /**
         * @param alarm3 The alarm3 to set.
         */
        ...
        /**
         * @param alarm4 The alarm4 to set.
         */
         ...
         * @param mapNo New value of property mapNo.
         */
         ...
         * @param archiveData New value of property archiveData.
         */
         ...
         * @param levelUnit New value of property levelUnit.
         */
    ...
    public class WQParamSet implements Serializable{
        ...
        /**
         * @param wqData The wqData to set.
         */
     ...
     *
     * @param file relativer Pfad und Dateiname der Datei die verteilt werden soll.
     ...
     * Löschen einer Datei
     *
     * @param file relativer Pfad und Dateiname der Datei die gelöscht werden soll.
     * @return True falls alles OK, False wenn Fehler aufgetreten ist
     */
     ...
     *
     * @param message Nachricht die protokolliert werden soll.
     * @return True falls alles OK, False wenn Fehler aufgetreten ist
     */
     ...
     *
     * @param typespec Objekttyp zu dem die Daten geholt werden sollen siehe Konstanten TYPE_*.
     ...
     *
     * @param id Kennzeichen des Objekts für das Archivadaten abgefragt werden sollen.
     * @param arcType Archivtyp aus dem die Archivwerte geholt werden sollen, siehe Konstanten ARC_*
     * @param from erster Archiveintrag der geholt werden soll
     * @param to letzter Archiveintrag der geholt werden soll
     ...
     * @param id Kennzeichen des Objekts für das Archivadaten geschrieben werden sollen.
     * @param arcType Archivtyp aus dem die Archivwerte geholt werden sollen, siehe Konstanten ARC_*
     * @param from erster Archiveintrag der geschrieben werden soll.
     * @param data die zu schreibenden Archivwerte
     * @return True falls alles OK, False wenn Fehler aufgetreten ist.
     */
     ...
     *
     * @param id Kennzeichen des Objekts für das W-Q Parameter geholt werden sollen.
