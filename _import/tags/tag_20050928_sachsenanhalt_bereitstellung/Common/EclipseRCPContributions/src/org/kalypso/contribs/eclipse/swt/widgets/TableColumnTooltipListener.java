...
public final class TableColumnTooltipListener extends AbstractControlTooltipListener
{
  ...
  {
    super( column.getParent().getShell(), TOOLTIP_PROPERTY );

    m_column = column;
  }

  /**
   * @see org.kalypso.contribs.eclipse.swt.widgets.AbstractControlTooltipListener#getItemForEvent(org.eclipse.swt.widgets.Event)
   */
