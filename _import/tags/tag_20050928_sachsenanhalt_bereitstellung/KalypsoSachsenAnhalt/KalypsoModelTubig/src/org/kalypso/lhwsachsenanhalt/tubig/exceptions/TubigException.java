 ...
 * @author thuel2
 */
public class TubigException extends Exception
{
  public TubigException()
  {
    super();
  }

  public TubigException( final String message )
  {
    super( message );
  }

  public TubigException( final Throwable cause )
  {
    super( cause );
  }

  public TubigException( final String message, final Throwable cause )
  {
    super( message, cause );
  }
}