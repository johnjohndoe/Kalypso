...
public class GenerateDifferenceResultTinWizard extends Wizard
{
  ...
  public void addPages( )
  {
    ...
    final SelectResultWizardPage selectMasterResultWizardPage = new SelectResultWizardPage( PAGE_SELECT_MASTER_RESULTS_NAME, "Ergebnis-Minuend ausw‰hlen", null, resultFilter, comparator, null );
    final SelectResultWizardPage selectSlaveResultWizardPage = new SelectResultWizardPage( PAGE_SELECT_SLAVE_RESULTS_NAME, "Ergebnis-Subtrahend ausw‰hlen", null, resultFilter, comparator, null );
    ...
    final SelectResultWizardPage selectDestinationResultWizardPage = new SelectResultWizardPage( PAGE_SELECT_DESTINATION_RESULTS_NAME, "Ziel ausw‰hlen", null, resultFilter2, comparator, themeConstructionFactory );
  ...
  public boolean performFinish( )
  {
    ...
    {
      MessageDialog.openInformation( getShell(), "Kein Ergebnis-Minuend ausgew‰hlt", "Bitte w‰hlen Sie ein Ergebnis aus, von dem Sie andere Ergbnisdaten abziehen wollen." );
      return false;
    }
    else
    {
    ...
    {
      MessageDialog.openInformation( getShell(), "Kein Ergebnis-Subtrahend ausgew‰hlt", "Bitte w‰hlen Sie ein Ergebnis aus, das abgezogen wird." );
      return false;
    }
    else
    {
    ...
    {
      MessageDialog.openInformation( getShell(), "Kein Ziel ausgew‰hlt", "Bitte w‰hlen Sie einen Zeitschritt aus, unter dem die erzeugten Differenzen abgelegt werden sollen." );
      return false;
    }
    else
    {
      ...
      if( destResult == null )
      {
        MessageDialog.openInformation( getShell(), "Falsches Ziel ausgew‰hlt", "Bitte w‰hlen Sie einen Zeitschritt aus, unter dem die erzeugten Differenzen abgelegt werden sollen." );
        return false;
      }
    }
