...
!      OPEN(IFIT,FILE=FNAME,STATUS='OLD',ACCESS='TRANSPARENT'
      OPEN(IFIT,FILE=FNAME,STATUS='OLD',FORM='UNFORMATTED'
     +        ,IOSTAT=IOERR)
          IF(IOERR .NE. 0) THEN
            CALL IOSMSG(IOERR)
            IERMSG=1
...
!      OPEN(IRMAFM,FILE=FNAME,STATUS='UNKNOWN',ACCESS='TRANSPARENT')
      OPEN(IRMAFM,FILE=FNAME,STATUS='UNKNOWN',FORM='UNFORMATTED')
          FNAM18=FNAME
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
cipk dec version       OPEN(INBNWGT,FILE=FNAME,STATUS='UNKNOWN',FORM='UNFORMATTED')
      ...
      OPEN(INBNWGT,FILE=FNAME,STATUS='UNKNOWN',FORM='UNFORMATTED')
          FNAM37=FNAME
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!      OPEN(INBNSTR,FILE=FNAME,STATUS='UNKNOWN',ACCESS='TRANSPARENT')
      OPEN(INBNSTR,FILE=FNAME,STATUS='UNKNOWN',FORM='UNFORMATTED')
          FNAM29=FNAME
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
