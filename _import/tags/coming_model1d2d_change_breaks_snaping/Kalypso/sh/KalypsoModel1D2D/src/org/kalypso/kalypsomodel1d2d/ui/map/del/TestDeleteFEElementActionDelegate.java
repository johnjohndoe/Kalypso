 ...
 *
 */
public class TestDeleteFEElementActionDelegate extends AbstractGisMapEditorActionDelegate implements IEditorActionDelegate
{
  public TestDeleteFEElementActionDelegate( )
  {
    super( new DeleteFEElementsWidget());
  }
