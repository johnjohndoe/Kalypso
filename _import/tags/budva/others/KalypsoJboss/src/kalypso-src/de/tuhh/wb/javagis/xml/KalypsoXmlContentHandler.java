...
{    
    ...
    public KalypsoXmlContentHandler(KalypsoXmlVectorSetListener vectorSetListener)
    {
	this.importListener=null;
	this.vectorSetListener=vectorSetListener;
	this.tableName=null;
	this.transferObject=null;
	this.vectorSet=null;
	this.agregatedVectorSet=null;
	...
	//	System.out.println("entering "+localName);
	// new table...
	...
	if("o".equals(localName))
		...
		if(agregatedVectorSet!=null)
			...
			if(vectorSetListener!=null)
			    vectorSetListener.importVectorSet(vectorSet);
