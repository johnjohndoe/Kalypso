...
public class ProcessHelper
{
  ...
  /**
   * startet Prozess (sCmd, envp, fleExeDir), schreibt Ausgaben nach wLog, wErr,
   * beendet den Prozess automatisch nach iTOut ms (iTOut = 0 bedeutet, dass der
   * Prozess nicht abgebrochen wird), die Abarbeitung des Prozesses beachtet
   * auch den Cancel-Status von cancelable
   * 
   * @param sCmd
   * @param envp
   * @param fleExeDir
  ...
  public static int startProcess( final String sCmd, final String[] envp, final File fleExeDir,
      final ICancelable cancelable, final long lTimeOut, final Writer wLog, final Writer wErr )
   ...
   * bei lTimeout = 0 wird die Ausführung des Prozesses proc nicht abgebrochen.
   * 
   * @author Thül
   */
