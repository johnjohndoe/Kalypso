...
public class PSICompactAxis extends DefaultAxis
{
   ...
   */
  public PSICompactAxis( final String label, final String axisType, final String unit, final Class dataClass, final boolean restricted, final int type )
  {
    super( label, axisType, unit, dataClass, restricted, type );
  }
}
