...
void CCoolDialogBar::OnUpdateCmdUI( CFrameWnd* pTarget, BOOL bDisableIfNoHndler )
{
  UpdateDialogControls(pTarget, bDisableIfNoHndler);
}

BOOL CCoolDialogBar::Create(CWnd* pParentWnd, CDialog *pDialog, CString &pTitle, UINT nID, BOOL bInvalidate, DWORD dwStyle) 
{
  // manche Dialoginhalte mögen das Invalidate in OnNCPaint nicht
  // deswegen kanns der User entscheiden, obs invalidiert wird oder nicht
...
void CCoolDialogBar::OnNcPaint() 
{
  ...
  if( m_bInvalidate )
    InvalidateRect( &pRect, TRUE ); // ist schlecht hier TODO!
}
...
BOOL CCoolDialogBar::PreTranslateMessage(MSG* pMsg) 
{
