...
/**
 * Class needed to register UrlCatalog (Hack)
 * 
 * @author thuel2
 */
public class ZwischengebieteCalcJob implements ISimulation
{
  /**
  ...
  {
    // Does nothing, everything is calculated via te ant scripts
  }
