...
public class SpreeCalcJob extends AbstractCalcJob
{
  ...
  public final static TSDesc[] TS_DESCRIPTOR = new TSDesc[]
  {
      ...
      new TSDesc( "Q_TSBAUTZ", true, "QV_TSBAUTZ" ),
      new TSDesc( "QV_TSBAUTZ" ),
      new TSDesc( "QP_TSBAUTZ", true, "QV_TSBAUTZ" ),
      new TSDesc( "V_TSBAUTZ", true, "QV_TSBAUTZ" ),
      new TSDesc( "S_GROEDI" ),
      new TSDesc( "W_GROEDI" ),
      new TSDesc( "Q_GROEDI" ),
      ...
      new TSDesc( "Q_TSQUITZ", true, "QV_TSQUITZ" ),
      new TSDesc( "QV_TSQUITZ" ),
      new TSDesc( "QP_TSQUITZ", true, "QV_TSQUITZ" ),
      new TSDesc( "V_TSQUITZ", true, "QV_TSQUITZ" ),
      new TSDesc( "S_SAERI" ),
      new TSDesc( "W_SAERI" ),
      new TSDesc( "Q_SAERI" ),
