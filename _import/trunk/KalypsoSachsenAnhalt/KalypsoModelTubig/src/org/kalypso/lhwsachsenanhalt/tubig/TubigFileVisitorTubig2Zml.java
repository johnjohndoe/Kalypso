...
public class TubigFileVisitorTubig2Zml implements FileVisitor
{
  ...
  /**
   * @param dirIn
   *          Quellverzeichnis (in diesem Verzeichnis stehen die Dateien, die konvertiert werden sollen)
   * @param dirOut
   *          Zielverzeichnis
   * @param sFeatTyp
   *          um welchen FeatureTyp handelt es sich (Speicher, Pegel)
  ...
  /**
   * gibt ZML-File für TUBIG-Datei zurück. Das Verzeichnis, in dem die ZML sttht wird gleichzeitig angelegt
   * 
   * @param fleTubig
   */
   ...
   * @param sTubigExt
   *          aus der Tubig-Dateiendung wird abgeleitet, welcher TimeSeriesLink gesucht wird
   */
