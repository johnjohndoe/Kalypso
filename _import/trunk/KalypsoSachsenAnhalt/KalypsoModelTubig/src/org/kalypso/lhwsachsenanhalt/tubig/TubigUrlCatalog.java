...
public final class TubigUrlCatalog extends AbstractUrlCatalog
{
  protected final void fillCatalog( final Class myClass, final Map catalog )
  {
    ...
    catalog.put( "org.kalypso.tubig.ombrometer", myClass.getResource( "schemata/ombrometer.xsd" ) );
    catalog.put( "org.kalypso.tubig.speicher", myClass.getResource( "schemata/speicher.xsd" ) );
    catalog.put( "org.kalypso.tubig.common", myClass.getResource( "schemata/common.xsd" ) );
    catalog.put( "org.kalypso.tubig.control", myClass.getResource( "schemata/control.xsd" ) );
  }
}
