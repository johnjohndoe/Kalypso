...
/**
 * WiskiObservationManipulator is able to extend the metadata information of an
 * IObservation
 * 
...
{
  /**
   * This implementation tries to fetch the RatingTable from the file-cache and
   * eventually updates the observation metadata.
   * <p>
