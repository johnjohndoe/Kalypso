  ...
  public static void main( String[] args )
  {
    try
    {
          ...
          && "1".equals( auth.get( KiWWDataProviderInterface.AUTHKEY_ALLOWED ) ) )
      {
        ...
        LinkedList columnnames = myServerObject.getColumnNames( domain, method );
        ...
        String[] getsl = new String[] { "station_no", "station_name",
            "station_id", "station_group_name", "station_longname",
        ...
        HashMap tsinfolist_name = myServerObject.getTsInfoList( ud, gettsinfo,
            null, filter_ts_station, 15, 0, false, null );

        System.out
            .println( "TS_INFOLIST(station_name and tsinfo_name filter) = "
                + tsinfolist_name );
        ...
        HashMap tsinfolist_group = myServerObject.getTsInfoList( ud, gettsinfo,
            null, filter_ts_group, 15, 0, false, null );

        System.out.println( "TS_INFOLIST(group filter) = " + tsinfolist_group );
        ...
        HashMap alarmlevel = myServerObject.getAlarmLevelList( ud, new Long[] {
            new Long( 216698 ), new Long( 53177 ), new Long( 53755 ) }, null );
        ...
        HashMap grouplist = myServerObject.getGroupList( ud, new String[] {
            "group_id", "group_name", "supergroup_name" },
            KiWWDataProviderInterface.TIMESERIES_GROUP, null, filtergroup, 15,
            0, false, null );
        ...
        HashMap getratingtables = myServerObject.getRatingTables( ud,
            KiWWDataProviderInterface.OBJECT_STATION, new Long[] { new Long(
                1024009663 ) }, curvets );
        ...
        HashMap getts_data_check = myServerObject.getTsData( ud,
            new long[] { (513824046) }, Timestamp
                .valueOf( "2004-12-30 12:00:00" ), Timestamp
                .valueOf( "2005-01-02 12:00:00" ), null );
        ...
        map_comments1.put( "fromdate", Timestamp
            .valueOf( "2004-12-10 12:00:00" ) );
        map_comments1.put( "untildate", Timestamp
            .valueOf( "2004-12-25 12:00:00" ) );
        map_comments1.put( "comment", "Testkommentar erstellt am 25.02.2005" );

        map_comments2.put( "id", new Long( 456798 ) );
        map_comments2.put( "fromdate", Timestamp
            .valueOf( "2000-01-10 12:00:00" ) );
        map_comments2.put( "untildate", Timestamp
            .valueOf( "2000-10-25 12:00:00" ) );
        ...
        //boolean returnvalue = myServerObject.setComments(ud,
        // map_objectType_as_key, null);
