...
public class KonfigWrite
{
	...
	writeBoolean(out,gto.getSimplePropertyAsBoolean("m_bof"),"       nbof bodenfeuchte          .bof");
	writeBoolean(out,gto.getSimplePropertyAsBoolean("m_bsp"),"       l3 daten bodensp           .bsp");
	writeBoolean(out,gto.getSimplePropertyAsBoolean("m_gws"),"       grundwasserstand           .gws");
	writeBoolean(out,true,"       gesamtabfluss              .qgs");
	writeBoolean(out,true,"       Gesamtabfluss TG           .qgg");
	writeBoolean(out,gto.getSimplePropertyAsBoolean("m_qna"),"       Overlansflow               .qna");
	...
	writeBoolean(out,gto.getSimplePropertyAsBoolean("m_qgw"),"       grundwasser                .qgw");
	...
	writeBoolean(out,gto.getSimplePropertyAsBoolean("m_sph"),"       wasserstandspeicher        .sph");
