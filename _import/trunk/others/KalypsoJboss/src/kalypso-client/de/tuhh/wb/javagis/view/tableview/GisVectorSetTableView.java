	...
	*/
	...
	JTable table = (JTable)cards.elementAt(selectedTab);
		...
		if(selectedValue!=null)
		    {
			mi = new JMenuItem("<html>set in selected "+myGisTableModel.getName()+"s ("+myGisTableModel.getRowCount()+")<br>"
					   +"in "+tableModel.getName()+"s row #"+selectedRow+"<br>"
					   +"the "+tableModel.getColumnName(selectedCol)+" to "+selectedValue+"<html>");
