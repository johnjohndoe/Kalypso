!     Last change:  WP   11 Dec 2006    3:04 pm
!--------------------------------------------------------------------------
...
CHARACTER(LEN=29), parameter :: VERSIONNR   = ' KALYPSO-1D, VERSION 1.3.0.1 '
CHARACTER(LEN=17), parameter :: VERSIONDATE = 'Stand: 08.03.2007'
