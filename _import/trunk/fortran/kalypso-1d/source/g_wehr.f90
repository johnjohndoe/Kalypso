!     Last change:  WP   30 May 2005   10:11 am
!--------------------------------------------------------------------------
...
SUBROUTINE g_wehr (hr, lein, jw8, ifehl1, auew, huew, wl, hwmin)
...
!**   SCHREIBEN IN KONTROLLFILE                                         
      IF (lein.eq.3) write (jw8, '(//,'' hr='',f8.4)') hr 
...
!**   SCHREIBEN IN KONTROLLFILE                                         
      IF (lein.eq.3) write (jw8, '(''   j  huew    auew     wl     hwmin&
     &  '')')                                                           
...
!**        ifehl2 = 0                                                   
        ...
        CALL linie (hmin, xokw, hokw, nokw, ianfw (j), iendw (j),       &
        npl1, xl, hl)                                                   
...
!JK       SCHREIBEN IN KONTROLLFILE                                     
      IF (lein.eq.3) write (jw8, '(''Polygonzuege im algebra nicht      &
...
!****************************************************                   
   ...
   40   END DO 
        ...
        IF (lein.eq.3) write (jw8, '(i4,4f8.4)') j, huew (j) , auew (j) &
        , wl (j) , hwmin (j)                                            
