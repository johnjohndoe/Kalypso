C     Last change:  MD   14 Jan 2009   10:38 am
...
!MD:              call generateOutputFileName
!MD:     +          ('mini', 0, icyc, maxn, modellaus, modellein,
!MD:     +          modellrst, ct, nb, outputFileName, inputFileName,
!MD:     +          outputBedName, inputBedName)
!MD:              call write_Kalypso (outputFileName, 'mini')
!MD:              call generateOutputFileName
!MD:     +          ('maxi', 0, icyc, maxn, modellaus, modellein,
!MD:     +          modellrst, ct, nb, outputFileName, inputFileName,
!MD:     +          outputBedName, inputBedName)
!MD:              call write_Kalypso (outputFileName, 'maxi')
            END IF
!-
CIPK AUG02
