C     Last change:  M    14 Jul 2006    3:48 pm
...
C  find Y parameter
C
	    Y = ( ( gnsg * d50m**3.0 )**0.5 / viscosity )**(-0.6)
C
...
C
		...
		c_bar = c_bar * (depth/d50m)**(-1.0/3.0)
	    end if
C
...
C
c	write(lout,*) Y,gnsg,d50m,viscosity,cF,slope,Fg,Fg_crit,depth,
