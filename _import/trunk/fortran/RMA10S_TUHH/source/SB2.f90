      ...
      SAVE
C
C     Subroutine to obtain 5th or 7th order gauss point values
C
...
C
C
C     NODE AND GAUSS POINT LOCATIONS DIAGRAMMED BELOW.
C     FOR 5TH ORDER CASE
C     FOR A QUAD, -1. < (ETA,PSI) < 1.
C     FOR A TRIANGLE, 0. < (ETA,PSI) < 1., AND ETA+PSI < 1.
C
C                      PSI                          5
C                      /                                                               /
C                     /                                                              /
