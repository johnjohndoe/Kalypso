!     Last change:  WP   17 Apr 2008    1:02 pm
...
!
!ipk oc98        VM=SQRT(VEL(1,NA)**2+VEL(2,NA)**2)
...
!*sqrt(cos(thet)**2 + sin(thet)**2)
          reductionfactor = reductionfactor / SQRT(dxline**2+dyline**2) 
!
          maxL = lmt(j) - 2
!
