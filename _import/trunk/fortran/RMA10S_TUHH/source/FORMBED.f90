C     Last change:  MD   30 Jul 2009    2:11 pm
...
cipk feb95        IF(TM(NN) <= 0.)GO TO 350
C.......................................................................
...
cipk apr06        if (nl > mxsedlay+10)  then
...
CIPK SKIP THIS TEST        IF(MOD(IT,NPRTF) /= 0 .AND. TET /= 0.) RETURN
C        WRITE(181,80)
        DO 480 I=1,NPM
          N=I
...
cipk jan99         IF (NLAY(N) > 0 .OR. NLAYO(N) > 0) THEN
