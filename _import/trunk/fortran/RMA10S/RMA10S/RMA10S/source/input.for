...
cipk MAR03 add FREQUCY FOR OUTPUT OF RESULTS FILES AND RESTART FILES
      ...
      IF(ID(1:2) .EQ. 'C6') THEN
        ...
        READ(DLIN,'(2I8)') IOUTFREQ,IOUTRST
        call ginpt(lin,id,dlin)
	  WRITE(LOUT,6024) IOUTFREQ,IOUTRST
...
cipk sep04
        CLOSE(75)
        OPEN(75,FILE='ERROR.OUT')
        WRITE(75,*) 'ERROR -- NO ELEMENT CHARACTERISTICS READ'
        WRITE(*,*) 'ERROR -- NO ELEMENT CHARACTERISTICS READ'
        STOP
      ENDIF
      WRITE(LOUT,6030)
      DO J=1,NMAT
...
CIPK DEC00 UPDATE FORMAT
 ...
 6000 FORMAT( 1H1  / 10X, 'FINITE ELEMENT METHOD FOR FLUID FLOW...PROGRA
     ...
     2EMPERATURE-SEDIMENT'/18X,'VERSION 3.2 SEPTEMBER 2005')
 6005 FORMAT( 5X, A72 )
