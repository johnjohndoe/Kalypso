...
public class CreateTinSimulation implements ISimulation {
	...
	public static final String INPUT_BOUNDARY = Gaja3dQNames.RP_BOUNDARY
			.getLocalPart();
	public static final String INPUT_BREAKLINES = Gaja3dQNames.RP_BREAKLINES
			.getLocalPart();

	public static final String INPUT_MAX_AREA = Gaja3dQNames.RP_MAX_AREA
			.getLocalPart();
	public static final String INPUT_MIN_ANGLE = Gaja3dQNames.RP_MIN_ANGLE
			.getLocalPart();

	public static final String OUTPUT_MODEL_TIN = Gaja3dQNames.RP_MODEL_TIN
			.getLocalPart();
