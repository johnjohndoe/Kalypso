 ...
 *   
 *  ---------------------------------------------------------------------------*/
package org.kalypso.gaja3d.service.internal.simulation;
...
import org.kalypso.gaja3d.service.internal.grid.Gaja3dGridJobSubmitter;
import org.kalypso.gaja3d.service.internal.grid.SimulationGridJobSubmitter;
...
public class DetectBreaklinesSimulation implements ISimulation {
	...
	public static final String INPUT_BOUNDARY = Gaja3dQNames.RP_BOUNDARY
			.getLocalPart();
	public static final String INPUT_DEM_GRID = Gaja3dQNames.RP_DEM_GRID
			.getLocalPart();

	public static final String INPUT_EDGE_FILTER = Gaja3dQNames.RP_EDGE_FILTER
			.getLocalPart();
	public static final String INPUT_SMOOTH_FILTER = Gaja3dQNames.RP_SMOOTH_FILTER
			.getLocalPart();
	public static final String INPUT_SMOOTH = "smooth";
	public static final String INPUT_FEATURE_DETECTOR = Gaja3dQNames.RP_FEATURE_DETECTOR
			.getLocalPart();
	...
	public static final String OUTPUT_BREAKLINES = Gaja3dQNames.RP_BREAKLINES
			.getLocalPart();
