...
public class WorkflowPartFigure<T extends IWorkflowPart> extends Clickable//Figure 
{
	...
	static 
	{
		...
		MAP_FONT.put(ISubTaskGroup.class, new Font(null, "Arial", 8, SWT.BOLD));
		MAP_FONT.put(ITask.class, new Font(null, "Arial", 8, SWT.BOLD));
	...
	final static private Font getClassFont(Class type)
	{
	  ...
	  public <E extends IWorkflowPart> WorkflowPartFigure<E> add(E childPart, Class<E> type)
	  {
		  System.out.println("adding="+childPart);
		  WorkflowPartFigure<E> cf=
			  new WorkflowPartFigure<E>(childPart,type);
