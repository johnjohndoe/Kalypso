...
public class Utils
{
  ...
  public static final String ID_GIS_MAP_EDITOR = "org.kalypso.ui.editor.mapeditor.GisMapEditor";
  ...
  public void importAll( IProject activeProject )
  {
    ...
    if( page != null )
    {
      ...
      try
      {
        ...
        IFile gmtFile = activeProject.getFile( "project:/.metadata/agger_karte.gmt" );
        if( !gmtFile.exists() )
        {
          logger.warning( "DO NOT EXISTS:" + gmtFile + " pjt=" + activeProject );
          return;
        }
        ...
        GisMapOutlinePage gmoPage = (GisMapOutlinePage) ep.getAdapter( IContentOutlinePage.class );

        KalypsoAddLayerWizard wiz = new KalypsoAddLayerWizard( gmoPage.getModellView() );
        wiz.init( PlatformUI.getWorkbench() );
        // dlg
        WizardDialog wd = new WizardDialog( page.getActivePart().getSite().getShell(), wiz );
