...
public class ActivitySeqTest extends TestCase
{
	...
	public void testCreation()
	{
		...
		assertEquals(
				"First activity in the sequence must be Activity1",
				TestRDFModel.ACTIVITY1_ID, 
				activitySeq.get(0).getURI());
		assertEquals(
				"Second activity in the sequence must be Activity2",
				TestRDFModel.ACTIVITY2_ID, 
				activitySeq.get(1).getURI());
	}
}
