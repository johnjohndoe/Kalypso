...
public class TestRDFModel {
	final static private String TEST_NS = "http://www.tu-harburg.de/wb/kalypso/kb/workflow/test#";
	...
	static private Model shModel;

	private TestRDFModel() {
		InputStream iStream = TestRDFModel.class
				.getResourceAsStream(TEST_TASK_RDF);
		workflowModel = ModelFactory.createDefaultModel();
		workflowModel.read(iStream, null);

		//
		iStream = TestRDFModel.class.getResourceAsStream(TEST_TASK_RDF_SH);
