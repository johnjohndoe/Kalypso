...
public class GenerateDifferenceResultTinWizard extends Wizard
{
  ...
  public void addPages( )
  {
    ...
    final SelectResultWizardPage selectMasterResultWizardPage = new SelectResultWizardPage( PAGE_SELECT_MASTER_RESULTS_NAME, "Ergebnis-Minuend ausw‰hlen", null, resultFilter, null );
    final SelectResultWizardPage selectSlaveResultWizardPage = new SelectResultWizardPage( PAGE_SELECT_SLAVE_RESULTS_NAME, "Ergebnis-Subtrahend ausw‰hlen", null, resultFilter, null );
    ...
    final SelectResultWizardPage selectDestinationResultWizardPage = new SelectResultWizardPage( PAGE_SELECT_DESTINATION_RESULTS_NAME, "Ziel ausw‰hlen", null, resultFilter2, themeConstructionFactory );
