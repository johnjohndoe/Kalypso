  ...
  private void createStyleComponent( final Composite commonComposite )
  {
    ...
    if( m_symbolizer instanceof SurfaceLineSymbolizer )
    {
      ...
      else
      {
        ...
        errorText.setText( "Styledatei(en) fehlerhaft oder nicht synchron mit Oberfl‰che. Bitte anderen Style ausw‰hlen" );
    ...
    else
    {
      ...
      errorText1.setText( "Styledatei(en) fehlerhaft oder nicht synchron mit Oberfl‰che." );
      ...
      errorText2.setText( "Bitte anderen Style ausw‰hlen." );
