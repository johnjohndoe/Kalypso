...
public class SelectLengthSectionWizard extends Wizard
{
  ...
  public void addPages( )
  {
    ...
    final SelectResultWizardPage selectResultWizardPage = new SelectResultWizardPage( PAGE_SELECT_RESULTS_NAME, "L‰ngsschnitt anzeigen", null, resultFilter, null );
  ...
  public boolean performFinish( )
  {
    ...
    final ICoreRunnableWithProgress op = new ICoreRunnableWithProgress()
    {
      ...
      public IStatus execute( final IProgressMonitor monitor )
      {
        ...
        monitor.beginTask( "L‰ngsschnittanzeige...", 1 );
