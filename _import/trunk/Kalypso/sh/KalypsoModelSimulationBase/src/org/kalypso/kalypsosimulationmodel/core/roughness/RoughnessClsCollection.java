 ...
 *
 */
public class RoughnessClsCollection 
					extends FeatureWrapperCollection<IRoughnessCls>
					implements IRoughnessClsCollection
{
	...
	public RoughnessClsCollection(Feature featureCol)
	{
		super(
			featureCol, 
			IRoughnessCls.class,
			KalypsoModelRoughnessConsts.WBR_PROP_ROUGHNESS_CLS_MEMBER);
	}
	 ...
	 */
	public RoughnessClsCollection(
						Feature parentFeature, 
						QName propQName) throws IllegalArgumentException
	{
		super(
			parentFeature, 
			propQName,
...
//	}
	...
	public List<IRoughnessCls> selectRoughnessByName(String nameRegExp)
	{
		...
		List<IRoughnessCls> rcList= 
			new ArrayList<IRoughnessCls>(size());
		String name;
		Matcher matcher;
