...
/**
 * Fill the gobal schema catalog with entries related to the
 * gml imitation schema
 * 
 * @author Patrice Congo
 */
public class UrlCatalogGmlImitations extends AbstractUrlCatalog
{
	/**
	 ...
	 */
	final static public URL URL_GML_IMITATION=
					UrlCatalogGmlImitations.class.getResource( 
												REL_PATH_GML_IMITATIONS );
	 ...
	 */
	  ...
	  {  
	    catalog.put( 
	    			NS_GML_IMITATIONS, 
	    			myClass.getResource( REL_PATH_GML_IMITATIONS) );
	    prefixes.put(NS_GML_IMITATIONS, NS_PREFIX_GML_IMITATION);	    
	  }
