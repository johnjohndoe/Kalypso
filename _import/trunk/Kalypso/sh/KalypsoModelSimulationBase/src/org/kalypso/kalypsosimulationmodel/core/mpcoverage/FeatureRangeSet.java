 ...
 * 
 * The feature contained in the range set need to be adaptable into a {@link RangeSetCls} object
 * 
 * @author Patrice Congo
 */
public class FeatureRangeSet<RangeSetCls extends IFeatureWrapper2> implements IFeatureRangeSet<RangeSetCls>
{
  /**
  ...
  public FeatureRangeSet( Feature rsFeature, Class<RangeSetCls> rangeSetClass )
  {
    ...
    this.rsFeatureList = (FeatureList) this.rsFeature.getProperty( GmlImitationsConsts.GML_PROP_FEATURE_MEMBER );
  }

  @SuppressWarnings("unchecked")
  public FeatureRangeSet( Feature parentFeature, QName propQName, Class<RangeSetCls> rangeSetClass ) throws IllegalArgumentException
  {
    if( parentFeature == null || propQName == null )
    {
      throw new IllegalArgumentException( "Argument parentFeature and propQName must not be null:" + "\n\tparentFeature=" + parentFeature + "\n\tpropQName=" + propQName );
    }

    try
    {
      this.rsFeature = FeatureHelper.addFeature( parentFeature, propQName, GmlImitationsConsts.WBGML_F_FEATURERANGESET );
    }
    catch( GMLSchemaException ex )
    {

      throw new IllegalArgumentException( "Property " + propQName + " does not accept element of type" + GmlImitationsConsts.WBGML_F_FEATURERANGESET, ex );
    }
  ...
  public boolean addAll( Collection< ? extends RangeSetCls> c )
  {
    ...
    return rsFeatureList.addAll( FeatureHelper.toFeatureList( c ) );

  }

  @SuppressWarnings("unchecked")
  public boolean addAll( int index, Collection< ? extends RangeSetCls> c )
  {
    Assert.throwIAEOnNull( c, "Argument c must not be null" );
    return rsFeatureList.addAll( index, FeatureHelper.toFeatureList( c ) );
  }
  ...
  public boolean contains( Object o )
  {
    ...
    {
      return rsFeatureList.contains( ((IFeatureWrapper2) o).getWrappedFeature() );
    }
    else
    {
      return false;
  ...
  public int indexOf( Object o )
  {
    if( o instanceof IFeatureWrapper2 )
    {
      return rsFeatureList.indexOf( ((IFeatureWrapper2) o).getWrappedFeature() );
    }
    else
    {
      return -1;
  ...
  public Iterator<RangeSetCls> iterator( )
  {
    ...
    {
      private final Iterator it = rsFeatureList.iterator();
      ...
      public RangeSetCls next( )
      {
        ...
        if( wrapper == null )
        {
          throw new RuntimeException( "Feature " + f + " could not be adapted to " + rangeSetClass );
        }
        return wrapper;
      }
  ...
  public int lastIndexOf( Object o )
  {
    if( o instanceof IFeatureWrapper2 )
    {
      return rsFeatureList.lastIndexOf( ((IFeatureWrapper2) o).getWrappedFeature() );
    }
    else
    {
      return -1;
  ...
  public RangeSetCls remove( int index )
  {
    ...
    IFeatureWrapper2 wrapper = (IFeatureWrapper2) f.getAdapter( rangeSetClass );
    return (RangeSetCls) wrapper;
  }
  ...
  public boolean remove( Object o )
  {
    if( o instanceof IFeatureWrapper2 )
    {
      return rsFeatureList.remove( ((IFeatureWrapper2) o).getWrappedFeature() );
    }
    else
    {
      return false;
