...
/**
 * 
 * @author Dejan Antanaskovic, <a
 *         href="mailto:dejan.antanaskovic@tuhh.de">dejan.antanaskovic@tuhh.de</a>
 * 
 */
public class DataContainer {
	...
	public final void setOutputFile(String outputFile) {
		if (outputFile == null || outputFile.length() == 0)
			this.m_outputFile = FileUtilities.nameWithoutExtension(FileUtilities.nameFromPath(this.m_inputFile))
					+ ".gml";
