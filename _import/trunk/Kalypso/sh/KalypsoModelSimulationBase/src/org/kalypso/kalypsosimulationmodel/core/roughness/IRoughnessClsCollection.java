 ...
 * a wbr:RoughnessCollection elemenent
 * 
...
public interface IRoughnessClsCollection extends Collection<IRoughnessCls>
{
	 ...
	 * 
	 * @param name the new name for the roughness collection
	 * @throws IllegalArgumentException if name is null or an
	 * 		empty string
	 */
	public void setName(
					String name)
	 ...
	 * 
	 * @param uri the uri of the roughness to look-up
	 * @return the roughness with the specified uri
	 * @throws IllegalArgumentException if uri is null or
	 * 			an empty string
	 */
	public IRoughnessCls getRoughnessByURI(
									String uri)
									throws IllegalArgumentException;
	
	
	/**
	 * Select all rougthness in the collection with a name matching 
	 * the the given regular expression
	 * 
	 * @param nameRegExp -- 
	 * @return
	 */
