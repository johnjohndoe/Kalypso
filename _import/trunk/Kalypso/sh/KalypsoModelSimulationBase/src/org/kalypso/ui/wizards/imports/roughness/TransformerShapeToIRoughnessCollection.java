...
import org.kalypso.ui.wizards.imports.utils.MapUtils;
...
public class TransformerShapeToIRoughnessCollection implements ICoreRunnableWithProgress
{
  ...
  public IStatus execute( IProgressMonitor monitor )
  {
    try
    {
      ...
      root.getProject( "test03" ).refreshLocal( IResource.DEPTH_INFINITE, null );
      root.getProject( "test04" ).refreshLocal( IResource.DEPTH_INFINITE, null );
