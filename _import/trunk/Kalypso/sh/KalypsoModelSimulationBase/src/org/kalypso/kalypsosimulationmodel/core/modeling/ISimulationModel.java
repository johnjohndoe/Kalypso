 ...
 */
public interface ISimulationModel<StaticM extends IStaticModel, OpM extends IOperationalModel, CntlM extends IControlModel, EvalM extends IEvaluationModel, AdmP extends IFeatureWrapper2, OverM extends IFeatureWrapper2>
    extends IModel
{
  /**
  ...
  /**
   * To get the addidtional properties assosiated with this simulation model
   * 
   * @return the addidtional properties assosiated with this simulation model
   */
  public IFeatureWrapperCollection<AdmP> getAdditionalModelProps( );

  /**
   * To get general overriding model associated with this simulation model
   * 
   * @return general overriding model associated with this simulation model
   */
