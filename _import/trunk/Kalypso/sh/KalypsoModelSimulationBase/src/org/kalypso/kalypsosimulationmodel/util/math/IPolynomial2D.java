 ...
 * The algerbic representation is:
 * SUM(aijx^iy^j) for 0&lt=i&lt=degreeX and 0&lt=i&lt=degreeY
 *  
 * 
...
public interface IPolynomial2D extends IPolynomial
{
	 ...
	 * i*(getDegreeX)+j in the return array.
	 * 
	...
	public void setCefficients(
						double[] coefficients)throws IllegalArgumentException;
	
	/**
	 * Sets the polynom parameter, which are its order, 
	 * its dimention and the coefficients
	 *   
	 * @param degreeX the new x degree of the polynom
	 * @param degreeY the new y degree of the polynom
	 ...
	 * 			equal to order (deegreeX+1)*(degreeY+1) and their
