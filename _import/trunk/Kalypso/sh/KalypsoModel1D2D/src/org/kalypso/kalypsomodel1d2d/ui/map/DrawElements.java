...
public class DrawElements
{
  public void paint(
              ...
              ICalculationUnit2D<IElement2D> unit2D )
  {
    //TODO check adapation to IElement2D
    IFeatureWrapperCollection elements = unit2D.getElements();
    for( Object ele : elements )
    {
      if( ele instanceof IPolyElement )
      {
        paint(g,projection,(IPolyElement)ele);
      }
    }
  }
                ...
                IPolyElement polyElement )
  {
    ...
    List<GM_Point> gmPoints = new ArrayList<GM_Point>();
