...
public class DeleteCmdFactory
{
   ...
   */
  public static final IDiscrModel1d2dChangeCommand createDeleteCmd(
                                    Feature feature, 
  ...
  public static final void createDeleteCmd(
                                IFEDiscretisationModel1d2d model1d2d,
    ...
    for(EasyFeatureWrapper easyFeatureWrapper:selected)
    {
      if(easyFeatureWrapper==null)
      {
        throw new IllegalArgumentException(
            "All easy features in selected must be non null");
      }
      try
      {
        ...
        if(feature!=null)
        {
          IDiscrModel1d2dChangeCommand delCmd = 
            createDeleteCmd( feature, model1d2d );
          if(delCmd != null)
          {
          ...
          else
          {
            throw new UnsupportedOperationException(
                "No delete command implemented for this feature:"+feature);
          }
        }
      }
      catch(Throwable th)
