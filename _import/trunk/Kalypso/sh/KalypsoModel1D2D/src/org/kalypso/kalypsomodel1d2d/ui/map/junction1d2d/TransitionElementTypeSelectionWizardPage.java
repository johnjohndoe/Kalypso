 ...
 * 
 */
public class TransitionElementTypeSelectionWizardPage extends WizardPage
{

  private Button[] m_radioBtnGroup;

  private TRANSITION_TYPE m_selectedType;
  ...
  public void createControl( final Composite parent )
  {
    ...
    m_radioBtnGroup[0].setText( "1D nach 2D ‹bergang" );
    ...
    m_radioBtnGroup[1].setText( "2D nach 1D ‹bergang" );
    m_radioBtnGroup[1].addSelectionListener( new SelectionListener()
    {
      ...
      public void widgetSelected( SelectionEvent e )
      {
        m_selectedType = TRANSITION_TYPE.TYPE2D1D;
      }
    } );
  ...
  public TRANSITION_TYPE getSelectedType( )
  {
