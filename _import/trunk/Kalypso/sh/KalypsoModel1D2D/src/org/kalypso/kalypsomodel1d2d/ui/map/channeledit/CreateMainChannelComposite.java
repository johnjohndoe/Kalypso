...
import org.kalypso.contribs.eclipse.swt.custom.ScrolledCompositeCreator.SizeProvider;
...
public class CreateMainChannelComposite extends Composite
{
  ...
  /*********************************************************************************************************************
   * m_buttonList Following buttons are present in the Schlauchgenerator: Profile w‰hlen Uferlinie 1 w‰hlen Uferlinie 1
   * zeichnen Uferlinie 2 w‰hlen Uferlinie 2 zeichnen
   */
  ...
  private Control updateSegmentSwitchSection( )
  {
    ...
    buttonZoomToExtend.setToolTipText( "ermˆglicht das automatische Springen zum aktuellen Segment" );
