...
//      gridData.horizontalSpan = 1;
    ...
    private void createConfigSection(Section configSection)
    {
     ...
     lineColorFieldEditor[0]=
       new ColorFieldEditor(LINE_COLOR_0,"Farbe f¸r Linie 1",clientComposite);
     lineColorFieldEditor[1]=
       new ColorFieldEditor(LINE_COLOR_1,"Farbe f¸r Linie 2",clientComposite);
     lineColorFieldEditor[2]=
       new ColorFieldEditor(LINE_COLOR_2,"Farbe f¸r Linie 3",clientComposite);
     lineColorFieldEditor[3]=
       new ColorFieldEditor(LINE_COLOR_3,"Farbe f¸r Linie 4",clientComposite);
