      ...
      for( final ResultType.TYPE parameter : m_parameters )
      {
        ...
        switch( parameter )
        {
          case DEPTH:
            ...
            stepResultMeta.addDocument( "Fließtiefen", "TIN der Fließtiefen", IDocumentResultMeta.DOCUMENTTYPE.tinDepth, new Path( "Tin/tin_DEPTH.gml" ), Status.OK_STATUS );
          ...
          case VELOCITY:
            ...
            stepResultMeta.addDocument( "Geschwindigkeiten", "TIN der tiefengemittelten Fließgeschwindigkeiten", IDocumentResultMeta.DOCUMENTTYPE.tinVelo, new Path( "Tin/tin_VELOCITY.gml" ), Status.OK_STATUS );
