 ...
 *   
 *  ---------------------------------------------------------------------------*/
package org.kalypso.kalypsomodel1d2d.ui.featureinput;
 ...
 * 
 */
public class AddMetaDataToFeatureDialog extends Dialog
{
  ...
  protected Control createDialogArea( Composite parent )
  {
    ...
    Label desciptionLabel = new Label( comp, SWT.RIGHT );
    desciptionLabel.setText( "Description: " );

    descriptionField = new Text( comp, SWT.MULTI | SWT.WRAP |SWT.BORDER );
  ...
  protected void buttonPressed( int buttonId )
  {
    ...
    else
    {
      ...
      descStr = descriptionField.getText();
