 ...
 * 
 */
public interface IStepResultMeta
{
  enum STEPTYPE
  {
    steady,
  ...
  public static final QName QNAME_PROP_STEP_IS_RESTART = new QName( UrlCatalog1D2D.MODEL_1D2DResult_NS, "stepIsRestart" );

  public static final QName QNAME_PROP_STEP_TYPE = new QName( UrlCatalog1D2D.MODEL_1D2DResult_NS, "stepType" );

  public void setStepTime( final Date stepTime ) throws DatatypeConfigurationException;
