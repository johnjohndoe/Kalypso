...
/**
 * Command For deleting a continuity line element
 * 
 * @author Patrice Congo
 */
public class DeleteContinuityLineCmd implements IDiscrModel1d2dChangeCommand
{
  
  private IFEDiscretisationModel1d2d model1d2d;
  
  private IFE1D2DContinuityLine cLine;
  
  private GM_Point[] elementPoints;
  
  private IFE1D2DComplexElement[] complexElements;
  
  public DeleteContinuityLineCmd(
                      IFEDiscretisationModel1d2d model1d2d,
                      Feature cLineFeature)
  {
    this.model1d2d = model1d2d;
    this.cLine = 
        (IFE1D2DContinuityLine)cLineFeature.getAdapter( 
  ...
  {
    return "Delete element continuity line";
  }
  ...
  {
    String elementID=cLine.getGmlID();
    ...
    //TODO check whether this continuity line is in a junction element context
  ...
  private void deleteElement( String elementID, IFE1D2DEdge[] edges, IFE1D2DComplexElement[] complexElements )
  {
    ...
    model1d2d.getElements().remove( cLine );
    
  }
  
  private IFE1D2DEdge[] makeElementEdges( )
  {
    IFeatureWrapperCollection edges = cLine.getEdges();
  ...
  {
    IFeatureWrapperCollection containers = cLine.getContainers();
  ...
  {
    return new IFeatureWrapper2[]{cLine};
  }
  /**
