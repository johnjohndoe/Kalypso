...
class DeleteFEElementsWidgetFace
{
  ...
  public DeleteFEElementsWidgetFace( WidgetStrategyContext strategyContext )
  {
  ...
  public Control createControl( Composite parent )
  {
    ...
    Composite clientComposite = toolkit.createComposite( body, SWT.NONE );
...
//      }
    ...
    {
      final private FENetConceptSelectionWidget nodeSelectionWidget = new FENetConceptSelectionWidget( Kalypso1D2DSchemaConstants.WB1D2D_F_NODE, "Delete Node", "Delete node" );
    ...
    try
    {
      ...
      action.setImageDescriptor( getImageDescriptor( "/icons/viewmag1.png" ) );
      ActionContributionItem aci = new ActionContributionItem( action );
      aci.fill( toolBar, 0 );

      images.add( image );

      ActionContributionItem aciNodeSel = new ActionContributionItem( actionSelNode );
  ...
  private final void createHelp( Section helpSection )
  {
    ...
    Composite clientComposite = toolkit.createComposite( helpSection, SWT.FLAT );
