...
public class CalculationUnitPerformWidget implements IWidgetWithOptions, IWidget, IWidgetWithStrategy
{
  ...
  public void activate( final ICommandTarget commandPoster, final MapPanel mapPanel )
  {
    ...
    try
    {
      ...
      final String imageUrn = "urn:kalypso:map:theme:swtimage:calculationunittheme:defaul";
      final Model1d2dCalUnitTheme calcUnitTheme = new Model1d2dCalUnitTheme( Messages.getString( "CalculationUnitPerformWidget.2" ), mapModell, imageUrn, null ); //$NON-NLS-1$
