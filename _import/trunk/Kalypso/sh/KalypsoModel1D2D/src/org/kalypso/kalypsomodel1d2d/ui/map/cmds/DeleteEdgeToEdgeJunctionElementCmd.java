 ...
 */
public class DeleteEdgeToEdgeJunctionElementCmd implements IDiscrModel1d2dChangeCommand
{
  
  private IFEDiscretisationModel1d2d model1d2d;
  private IFEEdgeToEdgeJunction1D2D junction;
...
//  private IFE1D2DEdge edges[]
  ...
  public DeleteEdgeToEdgeJunctionElementCmd(
                      IFEDiscretisationModel1d2d model1d2d,
                      Feature junctionFeature)
  {
    this.model1d2d = model1d2d;
    this.junction = 
        (IFEEdgeToEdgeJunction1D2D)junctionFeature.getAdapter( IFEEdgeToEdgeJunction1D2D.class );
  }
  /**
  ...
  public void process( ) throws Exception
  {
    ...
    nodes.addAll( junction.get1DEdge().getNodes() );
    nodes.addAll( junction.get2DEdge().getNodes() );
  ...
  private IFE1D2DEdge[] makeElementEdges( )
  {
    ...
    IFE1D2DEdge[] edgeArray =
        new IFE1D2DEdge[]{junction.get1DEdge(), junction.get2DEdge()};
    return edgeArray;
  }
  ...
  {
    return new IFeatureWrapper2[]{junction};
  }
  /**
