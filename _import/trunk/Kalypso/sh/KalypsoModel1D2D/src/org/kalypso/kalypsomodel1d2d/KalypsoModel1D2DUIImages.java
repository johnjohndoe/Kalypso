...
public class KalypsoModel1D2DUIImages
{
  ...
  public static final ImageDescriptor ID_HYDROGRAPH_ADD = id( "icons/elcl16/hydrograph_create.gif" ); //$NON-NLS-1$
  ...
  public static ImageDescriptor id( final String iconPath )
  {
