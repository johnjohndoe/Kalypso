 ...
 *   
 *  ---------------------------------------------------------------------------*/
package org.kalypso.kalypsomodel1d2d.ui.wizard.utils;
...
public class ImportTrippleHelper
{
   ...
   */
  public static List<IProfil> importTrippelData( final File trippleFile )
  {
    if( trippleFile == null )
    ...
    try
    {
        ...
        if( tokenizer.countTokens() == 4 )
        {
          ...
          if( station != currentStation )
          {
            if( !Double.isNaN( currentStation ) )
            {
              ...
              ImportTrippleHelper.storeProfile( profilPointList, currentStation, profiles );
      ...
      ImportTrippleHelper.storeProfile( profilPointList, station, profiles );
      profilPointList.clear();
      numStations = numStations + 1;
   ...
   */
  private static void storeProfile( final List<IProfilPoint> profilPointList, final double station, final List<IProfil> profiles )
  {
