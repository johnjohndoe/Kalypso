...
{
  protected static final Image IMG = new Image( null, KalypsoFloodWelcomePageFrame.class.getResourceAsStream( "icons/flood_no.gif" ) );

  protected static final Image IMG_HOVER = new Image( null, KalypsoFloodWelcomePageFrame.class.getResourceAsStream( "icons/flood_hover.gif" ) );
