...
public class FloodModel extends AbstractFeatureBinder implements IFloodModel
{
  ...
  public FloodModel( Feature featureToBind )
  {
    super( featureToBind, QNAME );

    m_polygones = new FeatureWrapperCollection<IFloodPolygon>( featureToBind, IFloodPolygon.QNAME, QNAME_PROP_POLYGONE_MEMBER, IFloodPolygon.class );
    m_events = new FeatureWrapperCollection<IRunoffEvent>( featureToBind, IRunoffEvent.QNAME, QNAME_PROP_EVENT_MEMBER, IRunoffEvent.class );
