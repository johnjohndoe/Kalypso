...
public class RestorePrespectivePageAction extends Action implements IWorkbenchWindowActionDelegate
{
  ...
  public void run( IAction action )
  {
    ...
    try
    {
      ...
      XMLMemento originalMemento = XMLMemento.createReadRoot( new FileReader( sourceFile ) );
      final UrlResolver resolver = new UrlResolver();
      final IMemento memento = MementoUtils.createMementoWithUrlResolver( originalMemento, new IUrlResolver2()
      {

        public URL resolveURL( String relative ) throws MalformedURLException
        {
          return resolver.resolveURL( sourceFile.toURL(), relative );
        }
      } );
