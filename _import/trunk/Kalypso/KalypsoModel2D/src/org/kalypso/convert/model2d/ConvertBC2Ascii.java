...
public class ConvertBC2Ascii
{
  ...
  // c:/Programme/eclipse/workspace/Kalypso2d/data/schema/bc_gml2.xsd";
   ...
   * @param exeDir
   */
  public ConvertBC2Ascii( final File exeDir )
  {
    this.exeDir = exeDir;
  }
  ...
  public void convertBC2Ascii( URL gmlURL, URL schemaUrl, URL modelGML, URL modelSchema )
  {
    try
    {
      ...
      AsciiFactory fac = new AsciiFactory( exeDir );
      fac.createBCAsciiFile( generalSB, general2SB, bcGeomSB, iterationSB, viscSB, lineSB, sbDis, sbDyn );
  ...
  // URL schemaUrl = new URL("http://elbe.wb.tu-harburg.de/2dModel
  // C:\\Programme\\eclipse\\workspace\\Kalypso2d\\data\\schema\\bc_gml2.xsd");
  // System.out.println(gmlURL+", "+ schemaUrl);
  ...
  private static void usage( int n )
  {
    ...
    {
      case 0:
        System.out.println( "usage: java ConvertBC2Ascii [-s XMLSchema -i inputFile]\n" + "                      [--help]\n" + "\n"
            + "    -i          inputFile-directory, containing absolut paths and filenames\n" + "    -s          schemaLocation\n" + "    --help      shows this help.\n" );
        break;
      case 1:
        System.out.println( "Try 'java ConvertBC2Ascii --help' for more information." );
        break;
      default:
        System.out.println( "Unknown usage: Try 'java ConvertBC2Ascii --help' for more information." );
        break;
    }
  }
