...
/**
 * @author Katharina Lupp <a href="mailto:k.lupp@web.de>Katharina Lupp </a> Preferences - Java - Code Style - Code
 *         Templates
 */
public class ConvertBC2GML
{
  ...
  // private static String gml2dSchema = "http://elbe.wb.tu-harburg.de/2dModel
  ...
  public static void createGML( String outFile )
  {
    ...
    try
    {
      ...
      // FirstParamGroup
      Element generalElement = setGMLParamGroups( e, doc, "generalCollectionMember", "generalCollection", "generalMember", "general" );
      create1PGNode( doc, generalElement );

      // new param group
      if( exists == true )
      {
        Element general2Element = setGMLParamGroups( e, doc, "genCollectionMember", "genCollection", "genMember", "gen" );
        create1bPGNode( doc, general2Element );
      }

      // SecondParamGroup
      Element geomElement = setGMLParamGroups( e, doc, "geomCollectionMember", "geomCollection", "geomMember", "geom" );
      create2PGNode( doc, geomElement );

      // ThirdParamGroup
      Element iterationElement = setGMLParamGroups( e, doc, "iterationCollectionMember", "iterationCollection", "iterationMember", "iteration" );
      ...
      // SixthParamGroup
      Element dischargeElement = setGMLParamGroups( e, doc, "dischargeCollectionMember", "dischargeCollection", "dischargeMember", "discharge" );
   ...
   */
  private static Element setGMLParamGroups( Element e, Document doc, String collMem, String coll, String member, String fe )
  {
  ...
  private static void set7GMLParamGroup( Element e, Document doc )
  {
    ...
    int i = 8;
    if( thirdParamGroup[1][12].equalsIgnoreCase( "0" ) )
      i = 7;
  ...
  private static void create7PGNode( Document doc, Element element, int k )
  {
    ...
    if( valueNCYC[k][7] == null || valueNCYC[k][7].indexOf( "null" ) > -1 )
    {
      ...
      ncflwElement.appendChild( XMLHelper.createTextNode( doc, valueNCYC[k][7] ) );
  ...
  /**
   * sets the first three blocks of parameters. All three blocks have the same architecture with simple parameter/value
   * pairs.
   * 
   * @param paramBlock
   * @param c
  ...
  /**
   * sets the fifth block of parameters. This is just a list of id of the points building a line.
   * 
   * @param paramsBlock
   */
  ...
  /**
   * sets the sixths block. It is divided in two parts. The first one is for IQGEN and the second one for IHGEN
   * parameters.
   * 
   * @param paramsBlock
   */
  ...
  /**
   * sets the seventh param block. This one is divided in two parts. The first one is similar to the first three blocks
   * but there should be kept in mind optional parameters. The second block is similar to the sixth block.
   * 
   * @param paramsBlock
   */
   ...
   * @throws SAXException
   */
  private static StringBuffer readBCAsciFile( HashMap argsmap ) throws MalformedURLException, FileNotFoundException, IOException, UnsupportedEncodingException, SAXException
  {
  ...
  private static void usage( int n )
  {
    ...
    {
      case 0:
        System.out.println( "usage: java ConvertBC2XML [-s XMLSchema -i inputFile -o outputFileDirectory]\n" + "                      [ -d outputdir]\n" + "                      [--help]\n" + "\n"
        ...
        break;
      case 1:
        System.out.println( "Try 'java ConvertBC2XML --help' for more information." );
        break;
      default:
        System.out.println( "Unknown usage: Try 'java ConvertBC2GML --help' for more information." );
        break;
    }
  }
