...
public class DynamicBC
{
  ...
  {
    final IRelationType linkPT = (IRelationType) rootFeature.getFeatureType().getProperty( "dynamicBC_CollectionMember" );
    Feature dynamicCollectionFE = ws.resolveLink( rootFeature, linkPT );
    ...
    for( int i = 0; i < list.size(); i++ )
    {
      ...
      {
        o = new Object[] { new Integer( (int) Double.parseDouble( "" + dynamicFE.getProperty( "nbx" ) ) ), new Integer( (int) Double.parseDouble( "" + dynamicFE.getProperty( "nsid" ) ) ),
            new Double( Double.parseDouble( "" + dynamicFE.getProperty( "delt" ) ) ), new Integer( (int) Double.parseDouble( "" + dynamicFE.getProperty( "iqgen" ) ) ),
            new Integer( (int) Double.parseDouble( "" + dynamicFE.getProperty( "ihgen" ) ) ), new Integer( (int) Double.parseDouble( "" + dynamicFE.getProperty( "istgen" ) ) ),
            new Integer( (int) Double.parseDouble( "" + dynamicFE.getProperty( "ncflw" ) ) ), new Integer( (int) Double.parseDouble( "" + dynamicFE.getProperty( "idenIwindIbgen" ) ) ), };
