...
public class KalypsoNAAcidTest extends TestCase
{
  ...
  public void testRun() throws Exception
  {
    ...
    final CalcJobDataBean modelBean = new CalcJobDataBean( NaModelConstants.MODELL_ID,
  ...
  private boolean run( File inputDir, String rootNode, boolean deleteOnSuccess ) throws Exception
  {
    ...
    final CalcJobDataBean controlBean = CalcJobHelper.getBeanForId( NaModelInnerCalcJob.CONTROL_ID,
        beans );
