...
public class ViewManager extends JFrame implements WindowListener,
        ...
        MouseMotionListener
{
    ...
    public ViewManager()
    {
        ...
        } catch (Exception e)
        {
            ...
            System.out
                    .println("could not connect to time series data base, check configuration");
    ...
    public void showObjectTableView(Version version)
    {
         ...
         * waitDialog.setVisible(true); waitDialog.setSize(150, 150);
         * desktop.add(waitDialog); waitDialog.moveToFront(); repaint();
         */

        //GisTableView gisTableView = new
        // GisTableView("TestVersion",version.getGisTableModels(),null,0,null,GisTableView.IS_GISELEMENTLIST);
        ...
        String title = beginTitle + version.getVersionProject() + "/"
                + version.getThemeKey() + "/" + version.getVersionState() + "/"
                + version.getVersionName() + " (#" + version.getVersionId()
                + ")";
        boolean open = isViewOpen(title);
        if (!open)
        {
            GisTableView gisTableView = new GisTableView(title, version
                    .getGisObjectTableModels());
            //System.out.println("Version: "+version.getVersionId());
            //System.out.println("Table:
            // "+I18n.get("windowTitleTV")+version.getLabel()+" ge?ffnet");
    ...
    public void showRelationTableView(Version version)
    {
        ...
        // 	GisTableView gisTableView = new
        // GisTableView("TestVersion",version.getGisTableModels(),null,0,null,GisTableView.IS_GISELEMENTLIST);
        String title = I18n.get("windowTitleTV_Relations")
                + version.getVersionProject() + "/" + version.getThemeKey()
    ...
    public void showNetView(Version version)
    {
        ...
        String title = I18n.get("windowTitleNV") + version.getVersionProject()
                + "/" + version.getThemeKey() + "/" + version.getVersionState()
        ...
        if (!open)
        {
            GisNetView gisNetView = new GisNetView(title, version
                    .getGisNetModel());
    ...
    public void showProjectView()
    {
        ...
        /*
         * System.out.println("New ProjectView."); String title =
         * I18n.get("windowTitlePV"); boolean open = isViewOpen(title); if
         * (!open) { projectView = new ProjectView(title);
         * projectView.setVisible(true); projectView.setSize(400, 300);
         * desktop.add(projectView); projectView.moveToFront(); }
         */
    ...
    /**
     * private void selectionBar(Vector objectClassNames) { JToolBar
     * selectionBar=new JToolBar("SelectionBar"); selectionBar.setLayout(new
     * GridLayout (objectClassNames.size(),1)); for(int i=0;i
     * <objectClassNames.size();i++) { selectionBar.add(new
     * JCheckBox(objectClassNames.elementAt(i).toString(),true)); }
     * selectionBar.addSeparator(); selectionBar.setVisible(true); //
     * add(selectionBar); }
     */
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if ("openGraficTool".equals(e.getActionCommand()))
        {
            ...
            File kalypsoTemplate = new File(Main.props
                    .getProperty("template_simulation"));
            File myWorkingDir = new File(kalypsoTemplate, "tools");
            String commandLine = myWorkingDir.getPath()
                    + System.getProperty("file.separator") + myCommand;
            String dummy[] = { "" };
            try
            {
                Process process_SCE = (Runtime.getRuntime()).exec(commandLine,
                        dummy, myWorkingDir);
        ...
        if ("comboBoxChanged".equals(e.getActionCommand()))
        {
            if (processingFlag)
            {
                ...
                if (index > 0)
                {
                    JInternalFrame frame = (JInternalFrame) comboBox
                            .getSelectedItem();
    ...
    private void jbInit() throws Exception
    {
        ...
        jMenuItem_openConfView
                .addActionListener(new java.awt.event.ActionListener() {
                    public void actionPerformed(ActionEvent event)
                    {
                        ...
                        {
                            confView = new ConfigurationView(I18n
                                    .get("CV_Title"), true);
                            confView.show();
                        }
                    }
        ...
        jMenuItem_Exit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(ActionEvent e)
            {
                ...
                {
                    //       n = JOptionPane.showConfirmDialog(frame, "Do You really
                    // want to quit the program?");
                    Object[] options = { I18n.get("Dia_Yes"),
                            I18n.get("Dia_No"), I18n.get("Dia_Cancel") };
                    n = JOptionPane.showOptionDialog(null, I18n
                            .get("ExitDia_Question"),
            ...
            public void actionPerformed(ActionEvent e)
            {
                if ("about".equals(e.getActionCommand()))
                    JOptionPane
                            .showMessageDialog(
                                    null,
                                    "KALYPSO-NA Version 2.0.1 \n"
                                            + "TUHH Arbeitsbereich Wasserbau \n"
         ...
         * createVButton.setIcon( (new
         * ImageIcon(cl.getResource("symbols/CreateV24.gif"))));
         ...
         * ImageIcon(cl.getResource("symbols/Copy24.gif"))));
         * tableButton.addActionListener(new java.awt.event.ActionListener() {
         * public void actionPerformed(ActionEvent e) {
         * tableButton_actionPerformed(e); } }); tableButton.setMaximumSize(new
         * Dimension(35, 110)); tableButton.setPreferredSize(new Dimension(35,
         * 35)); tableButton.setToolTipText(I18n.get("ButtonTableTT"));
         ...
         * renameButton.setIcon( (new
         * ImageIcon(cl.getResource("symbols/Rename24.gif"))));
         ...
         * ImageIcon(cl.getResource("symbols/Delete24.gif"))));
         ...
         * xmlEDataButton.setIcon( (new
         * ImageIcon(cl.getResource("symbols/Export24.gif"))));
         ...
         * xmlIButton.setIcon( (new
         * ImageIcon(cl.getResource("symbols/Import24.gif"))));
         */
        ...
        calibrationButton.setIcon((new ImageIcon(resource)));
        ...
        /*
         * toolBar.add(createVButton, null); toolBar.add(copyButton, null);
         * toolBar.add(tableButton, null); toolBar.add(netButton, null);
         * toolBar.add(renameButton, null); toolBar.add(removeButton, null);
         * toolBar.add(xmlEDataButton, null); toolBar.add(xmlIButton, null);
         */
    ...
    /*
     * //File | Exit action performed public void
     * jMenuFileExit_actionPerformed(ActionEvent e) {
     * VersionClass.freeResources(); System.exit(0); }
     */
    ...
    public static void removeViewFromList(InternalFrameEvent e)
    {
        ...
        for (int i = 0; i < comboBox.getItemCount(); i++)
        {
            ...
            /*
             * String comboItemString = ((JInternalFrame)
             * comboItemObject).getTitle();
             */
        ...
        if (index > -1)
        {
            ...
            //System.out.println("Number of items (remove):
    ...
    public static boolean isViewOpen(String title)
    {
        ...
        {
            Object comboItemObject = comboBox.getItemAt(i);
            String comboItemString = ((JInternalFrame) comboItemObject)
                    .getTitle();
            //System.out.println("Actual Title: "+comboItemString);
