 ...
 *   
 *  ---------------------------------------------------------------------------*/
package org.kalypso.floodrisk.statisticAnalysis.test;
...
import org.kalypso.floodrisk.statisticAnalysis.CalculateStatisticJob;
...
public class CalculateStatisticJobTest extends TestCase
{
  ...
  {
    final CalculateStatisticJob job = new CalculateStatisticJob();
