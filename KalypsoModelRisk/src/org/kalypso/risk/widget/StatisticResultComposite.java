        ...
        for( final IComponent component : components )
        {
          ...
          if( phenName.equals( "TotalDamage" ) )//$NON-NLS-1$
          {
            ...
            if( valueTypeName.equals( XmlTypes.XS_DECIMAL ) )
              myMap.put( count, new ComponentUiDecimalHandler( count, false, true, false, headerName, SWT.RIGHT, 170, 10, "%,.02f â‚¬", "", "%.00f" ) ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
            count++;
          }
          // Flooded Area
          if( phenName.equals( "FloodedArea" ) )//$NON-NLS-1$
          {
            ...
            final QName valueTypeName = component.getValueTypeName();
            if( valueTypeName.equals( XmlTypes.XS_DECIMAL ) )
              myMap.put( count, new ComponentUiDecimalHandler( count, false, true, false, headerName, SWT.RIGHT, 170, 10, "%,.02f mÂ²", "", "%.00f" ) ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
            count++;
          }
          // Averaged Damage
          if( phenName.equals( "AveragedDamage" ) )//$NON-NLS-1$
          {
            ...
            final QName valueTypeName = component.getValueTypeName();
            if( valueTypeName.equals( XmlTypes.XS_DECIMAL ) )
              myMap.put( count, new ComponentUiDecimalHandler( count, false, true, false, headerName, SWT.RIGHT, 170, 10, "%,.02f â‚¬/mÂ²", "", "%.02f" ) ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
            count++;
          }
          if( phenName.equals( "AnnualValue" ) )//$NON-NLS-1$
          {
            ...
            if( valueTypeName.equals( XmlTypes.XS_DOUBLE ) )
              myMap.put( count, new ComponentUiDoubleHandler( count, false, true, false, headerName, SWT.RIGHT, 190, 10, "%,.02f â‚¬/mÂ²/a", "", "%.02f" ) ); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
            count++;
          }
