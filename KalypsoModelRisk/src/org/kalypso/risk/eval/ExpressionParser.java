...
{
  private final List<IEvalFunctionMember> m_evalFunctionMembers = new ArrayList<>();

  private final List<RPNEntry> m_postfixExpression = new ArrayList<>();
  ...
  {
    final Stack<RPNEntry> stack = new Stack<>();
