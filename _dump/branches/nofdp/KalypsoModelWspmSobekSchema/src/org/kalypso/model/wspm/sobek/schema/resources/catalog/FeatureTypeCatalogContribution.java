 ...
 *   
 *  ---------------------------------------------------------------------------*/
package org.kalypso.model.wspm.sobek.schema.resources.catalog;
 ...
 * @author thuel2
 */
public class FeatureTypeCatalogContribution implements ICatalogContribution
{
  // TODO move to UI plugin later on
  /**
