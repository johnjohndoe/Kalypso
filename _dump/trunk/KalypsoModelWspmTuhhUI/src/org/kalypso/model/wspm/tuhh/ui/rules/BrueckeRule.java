    ...
    try
    {
      ...
      for( final IRecord point : points )
      {
        ...
        if( (Double) uk - (Double) ok > delta )
          collector.createProfilMarker( IMarker.SEVERITY_ERROR, "Brückenkanten schneiden sich", "", profil.indexOfPoint( point ), IWspmConstants.POINT_PROPERTY_BREITE, pluginId, null );
        ...
        if( (Double) h - (Double) ok > delta || (Double) h - (Double) uk > delta )
          collector.createProfilMarker( IMarker.SEVERITY_ERROR, "Brückenkanten unter Geländehöhe", "", profil.indexOfPoint( point ), IWspmConstants.POINT_PROPERTY_BREITE, pluginId, null );
        lastPoint = point;
        ...
        if( ok_h_l != null && ok_h_r == null && bewuchs != null && (Double) bewuchs != 0.0 )
          collector.createProfilMarker( IMarker.SEVERITY_ERROR, "Bewuchsparameter im Brückenbereich", "", profil.indexOfPoint( point ), IWspmConstants.POINT_PROPERTY_BREITE, pluginId, null );
      }
      // Brückenparameter
      ...
      if( ok_h_l == null || uk_h_l == null || ok_h_r == null || uk_h_r == null )
        collector.createProfilMarker( IMarker.SEVERITY_ERROR, "Brücke unvollständig", "", 0, IWspmTuhhConstants.POINT_PROPERTY_OBERKANTEBRUECKE, pluginId, null );
      else
      {
        ...
        if( marker.length > 1 )
        {
          if( profil.indexOfPoint( marker[0].getPoint() ) > 0 )
            collector.createProfilMarker( IMarker.SEVERITY_ERROR, "Der durchströmte Bereich muß das gesamte Profil einschließen", "", 0, IWspmConstants.POINT_PROPERTY_BREITE, pluginId, null );// new
                                                                                                                                                                                              // IMarkerResolution2[]
                                                                                                                                                                                              // {
                                                                                                                                                                                              // new
          ...
          if( profil.indexOfPoint( marker[marker.length - 1].getPoint() ) < points.length - 1 )
            collector.createProfilMarker( IMarker.SEVERITY_ERROR, "Der durchströmte Bereich muß das gesamte Profil einschließen", "", points.length - 1, IWspmConstants.POINT_PROPERTY_BREITE, pluginId, null );// new
                                                                                                                                                                                                              // IMarkerResolution2[]
                                                                                                                                                                                                              // {
                                                                                                                                                                                                              // new
                                                                                                                                                                                                              // MoveDeviderResolution(
        ...
        if( trenner.length > 1 )
        {
          if( trenner[0].getPoint() != uk_h_l )
            ...
            collector.createProfilMarker( IMarker.SEVERITY_ERROR, "Trennfläche nicht auf Schnittpunkt Gelände-UK-Brücke", "", profil.indexOfPoint( trenner[0].getPoint() ), IWspmConstants.POINT_PROPERTY_BREITE, pluginId, null );// new
                                                                                                                                                                                                                                  // IMarkerResolution2[]
                                                                                                                                                                                                                                  // {
                                                                                                                                                                                                                                  // new
                                                                                                                                                                                                                                  // MoveDeviderResolution(
          ...
          if( trenner[trenner.length - 1].getPoint() != uk_h_r )
            ...
            collector.createProfilMarker( IMarker.SEVERITY_ERROR, "Trennfläche nicht auf Schnittpunkt Gelände-UK-Brücke", "", profil.indexOfPoint( trenner[trenner.length - 1].getPoint() ), IWspmConstants.POINT_PROPERTY_BREITE, pluginId, null );// new
                                                                                                                                                                                                                                                    // IMarkerResolution2[]
                                                                                                                                                                                                                                                    // {
                                                                                                                                                                                                                                                    // new
                                                                                                                                                                                                                                                    // MoveDeviderResolution(
...
// collector.createProfilMarker( true, "Schnittpunkt Oberkante-Gelände falsch", "", ArrayUtils.indexOf( points, uk_h_l
// ), IWspmTuhhConstants.POINT_PROPERTY_OBERKANTEBRUECKE, pluginId, null );
// if( ArrayUtils.indexOf( points, ok_h_r ) <= ArrayUtils.indexOf( points, uk_h_r ) )
// collector.createProfilMarker( true, "Schnittpunkt Oberkante-Gelände falsch", "", ArrayUtils.indexOf( points, uk_h_r
// ), IWspmTuhhConstants.POINT_PROPERTY_OBERKANTEBRUECKE, pluginId, null );
      }
    }
