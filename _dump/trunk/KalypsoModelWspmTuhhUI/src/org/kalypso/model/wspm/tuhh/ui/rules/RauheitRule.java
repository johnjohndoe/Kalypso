  ...
  public void validate( final IProfil profil, final IValidatorMarkerCollector collector ) throws CoreException
  {
    ...
    for( final IRecord point : points )
    {
      try
      {
        ...
        if( rh <= 0.0 )
        {
          collector.createProfilMarker( IMarker.SEVERITY_ERROR, "unzul‰ssiger Rauheitswert [" + rh + "]", "km "+Double.toString( profil.getStation()), profil.indexOfPoint( point ), pointProp.getId(), pluginId, null );
          break;
        }
      }
