...
public class RauheitRule extends AbstractValidatorRule
{
  public void validate( final IProfil profil, final IValidatorMarkerCollector collector ) throws CoreException
  {
    ...
    if( pointPropKS != null && pointPropKST != null )
    {
      collector.createProfilMarker( IMarker.SEVERITY_ERROR, "nur ein Rauheitstyp zul‰ssig", stationId, 0, "", pluginId ,new DelRoughnessResolution(pointPropKST.getId())); //$NON-NLS-2$
      return;
    }
