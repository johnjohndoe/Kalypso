...
public class GelaendeLayer extends AbstractPolyLineLayer
{
  ...
  {
    super( IWspmTuhhConstants.LAYER_GELAENDE, "Gel‰nde", pcv, pcv.getDomainRange(), pcv.getValueRangeLeft(), ProfilObsHelper.getPropertyFromId( pcv.getProfil(), new String[] { IWspmTuhhConstants.POINT_PROPERTY_HOEHE } ), true, true, true );
