...
public class GelaendeLayer extends AbstractPolyLineLayer
{
  ...
  {
    super( IWspmTuhhConstants.LAYER_GELAENDE, "Gel‰nde", pcv, pcv.getDomainRange(), pcv.getValueRangeLeft(), new String[] { IWspmTuhhConstants.POINT_PROPERTY_HOEHE }, true, true, true );
