...
public class TuhhBuildingHelper
{
  ...
  public static IProfileObject createProfileObject( final IProfil profil, final IObservation<TupleResult> observation )
  {
    ...
    if( BuildingBruecke.ID.equals( id ) )
      ...
      return new BuildingWehr( profil, observation );
    else if( BuildingEi.ID.equals( id ) )
      return new BuildingEi( profil, observation );
    else if( BuildingKreis.ID.equals( id ) )
      return new BuildingKreis( profil, observation );
    else if( BuildingMaul.ID.equals( id ) )
      return new BuildingMaul( profil, observation );
    else if( BuildingTrapez.ID.equals( id ) )
      return new BuildingTrapez( profil, observation );
