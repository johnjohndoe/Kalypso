 ...
 */
public class PolnishBridgesWPRofContentProvider implements IWProfContentProvider, IWspmTuhhConstants
{
  /**
  ...
  {
    final String stationString = ObjectUtils.toString( feature.getProperty( "P_NAM" ), "0000-999999" ); //$NON-NLS-1$ //$NON-NLS-2$
    final String[] split = stationString.replaceAll( "\"", "" ).trim().split( "-" );
    final String stationStr = split[1];
    final BigInteger stationInt = new BigInteger( stationStr );
    final BigDecimal bigDecimal = new BigDecimal( stationInt );
  ...
  {
    return ObjectUtils.toString( feature.getProperty( "P_KOMM" ), "" ); //$NON-NLS-1$ //$NON-NLS-2$
//    return ""; //$NON-NLS-1$
  }
  ...
  {
    final String distanceString = ObjectUtils.toString( feature.getProperty( "S" ), "NaN" ); //$NON-NLS-1$ //$NON-NLS-2$
  ...
  {
    final String distanceString = ObjectUtils.toString( feature.getProperty( "ZCOOR" ), "NaN" ); //$NON-NLS-1$ //$NON-NLS-2$
  ...
  {
    final String typeString = ObjectUtils.toString( feature.getProperty( "OBJCODE" ), "-1" ); //$NON-NLS-1$ //$NON-NLS-2$
//    final String typeString = ObjectUtils.toString( feature.getProperty( "PUNKTATTRI" ), "-1" ); //$NON-NLS-1$ //$NON-NLS-2$
  ...
  {
    final String typeString = ObjectUtils.toString( feature.getProperty( "PROF_TYP" ), "-1" ); //$NON-NLS-1$ //$NON-NLS-2$
    return Integer.parseInt( typeString );
  }
...
//    return imagesString.split( ";" ); //$NON-NLS-1$
  ...
  {
    final String string = ObjectUtils.toString( feature.getProperty( "N_ID" ), "-1" ); //$NON-NLS-1$ //$NON-NLS-2$
