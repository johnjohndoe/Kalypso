...
public class BuildingMaul extends AbstractProfilDurchlass
{
  ...
  public BuildingMaul( )
  {
    super( IWspmTuhhConstants.BUILDING_TYP_MAUL,"Maul", Arrays.asList(  IWspmTuhhConstants.BUILDING_PROPERTY_BEZUGSPUNKT_X,
        ...
        IWspmTuhhConstants.BUILDING_PROPERTY_RAUHEIT ) );
  }
