 ...
 * @author thuel2
 */
public class WspWinExportProjectFeatV implements FeatureVisitor
{
  ...
  private MultiStatus m_status = new MultiStatus( PluginUtilities.id( KalypsoUIModelWspmPlugin.getDefault() ), 0, "", null );
  ...
  public boolean visit( Feature f )
  {
    ...
    //
    if( QNameUtilities.equals( featureName, IWspmConstants.NS_WSPM_TUHH, "CalculationWspmTuhhSteadyState" ) )
    {
      return true;
    }

    //
    if( QNameUtilities.equals( featureName, IWspmConstants.NS_WSPM_TUHH, "ReachWspmTuhhSteadyState" ) )
