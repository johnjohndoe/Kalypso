...
public class ValidateProfilesWizard extends Wizard
{
  ...
  public void addPages( )
  {
    ...
    m_validatorChooserPage = new ArrayChooserPage( rules, new IValidatorRule[0], new IValidatorRule[0], 1, "validatorChooserPage", Messages.PropertyEditWizard_6, null ); //$NON-NLS-1$
    m_validatorChooserPage.setLabelProvider( new LabelProvider() );
    m_validatorChooserPage.setMessage( Messages.PropertyEditWizard_7 );
    m_quickFixChoosePage = new ArrayChooserPage( rules, new IValidatorRule[0], new IValidatorRule[0], 1, "validatorChooserPage", Messages.PropertyEditWizard_6, null ); //$NON-NLS-1$
