...
/**
 * Helper for thinning a profile with the Douglas Peucker algorythm.
 * 
...
public class DouglasPeuckerHelper
{
   ...
   */
  private static IRecord[] reducePoints( IRecord[] points, IRecord[] pointsToKeep, double allowedDistance )
  {
    /* Reduce segment wise. */
  ...
  private static double calcDistance( IRecord beginPoint, IRecord endPoint, IRecord middlePoint )
  {
