...
public class FlipProfileWizard extends Wizard
{
  ...
  public FlipProfileWizard( CommandableWorkspace workspace, final List<Feature> profiles, final List<Feature> selection )
  {
    ...
    m_profileChooserPage.setMessage( "Bitte w‰hlen Sie aus, welche Profile gespiegelt werden sollen." );
  }
