...
public class WeirTimeSeriesHandler extends ResultTimeSeriesHandler
{
  private final WEIR_NODE_RESULT m_type;

  public WeirTimeSeriesHandler( final WEIR_NODE_RESULT type, final Feature feature, final INode node )
  {
    super( feature, node );
    m_type = type;
  }
