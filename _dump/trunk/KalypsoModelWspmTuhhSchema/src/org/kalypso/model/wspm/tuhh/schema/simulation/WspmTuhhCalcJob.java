        ...
        case WATERLEVEL:
        {
          ...
          if( lenSecFile.exists() )
          {
            ...
            if( lengthSectionObsFile.exists() )
            {
              ...
              // Geometrie ausd¸nnen, (welche) Parameter aus ANT?
              // WST an Punkte dranh‰ngen und neue Geometrie machen

              // @Monika: auskommentiert, weils zur Zeit ne exception gibt, dass
              // die datei zeichen falschen encodings enth‰lt.
              // vermutlich problem der header/footer dateien
              // das gml wird mit dem encoding gelesen, welches in der 1.Zeile angegeben ist.
              
              // P.S.: Du musst ¸brigends den header footer gar nicht aus dem zip entpacken, sondern
              // kˆnntest auch bequem direkt per
...
//              }
        ...
        case BF_NON_UNIFORM:
        {
          ...
          // *.tab (Ergebnislisten f¸r jeden Abfluss -> Verzeichnis)
