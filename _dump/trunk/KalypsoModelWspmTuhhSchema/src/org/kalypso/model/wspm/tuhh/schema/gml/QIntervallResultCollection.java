...
public class QIntervallResultCollection extends AbstractFeatureBinder
{
  ...
  {
    // final IRelationType qresultParentRelation = (IRelationType)
    // qresultCollectionFeature.getFeatureType().getProperty(
    // IWspmTuhhQIntervallConstants.QNAME_P_QIntervallResultCollection_resultMember );
