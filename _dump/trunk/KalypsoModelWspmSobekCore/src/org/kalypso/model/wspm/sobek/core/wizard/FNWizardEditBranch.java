 ...
 * @author kuch
 */
public class FNWizardEditBranch extends Wizard implements INewWizard
{
  ...
  public FNWizardEditBranch( final Feature branch )
  {
    m_branch = branch;
  }
  ...
  {
    m_pageEditBranch = new PageEditBranch( m_branch );
    addPage( m_pageEditBranch );
  }
  ...
  public boolean performFinish( )
  {
    try
    {
      final String name = m_pageEditBranch.getBranchName();
      final String description = m_pageEditBranch.getBranchDescription();
