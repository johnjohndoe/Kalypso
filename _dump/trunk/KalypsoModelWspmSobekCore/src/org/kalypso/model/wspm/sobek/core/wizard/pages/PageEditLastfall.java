...
public class PageEditLastfall extends WizardPage
{
  ...
  public void createControl( final Composite parent )
  {
    ...
    /* begin date */
    new WizardFeatureLabel( m_lastfall.getFeature(), ILastfall.QN_SIMULATION_BEGIN, group );
    ...
    /* end date */
    new WizardFeatureLabel( m_lastfall.getFeature(), ILastfall.QN_SIMULATION_END, group );
    ...
    /* pre simulation time */
    new WizardFeatureLabel( m_lastfall.getFeature(), ILastfall.QN_SIMULATION_PRE_TIME, group );

    m_pre = new WizardFeatureTextBox( m_lastfall.getFeature(), ILastfall.QN_SIMULATION_PRE_TIME );
    ...
    new WizardFeatureLabel( m_lastfall.getFeature(), ILastfall.QN_SIMULATION_TIMESTEP, group );

    m_timeStep = new WizardFeatureTextBox( m_lastfall.getFeature(), ILastfall.QN_SIMULATION_TIMESTEP );
    ...
    new WizardFeatureLabel( m_lastfall.getFeature(), ILastfall.QN_SIMULATION_TIMESTEP_MULTIPLIER, group );

    m_multiplier = new WizardFeatureTextBox( m_lastfall.getFeature(), ILastfall.QN_SIMULATION_TIMESTEP_MULTIPLIER );
