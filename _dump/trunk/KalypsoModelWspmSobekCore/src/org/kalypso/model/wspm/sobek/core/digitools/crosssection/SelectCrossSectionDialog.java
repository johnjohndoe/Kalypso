 ...
 * @author kuch
 */
public class SelectCrossSectionDialog extends TitleAreaDialog
{
  protected Feature m_selection = null;

  private final Feature[] m_crossSections;

  public SelectCrossSectionDialog( final Shell parentShell, final Feature[] crossSections )
  {
    super( parentShell );
  ...
  protected Control createDialogArea( final Composite parent )
  {
    ...
    viewer.addSelectionChangedListener( new ISelectionChangedListener()
    {
      ...
      public void selectionChanged( final SelectionChangedEvent event )
      {
        ...
        m_selection = (Feature) selection.getFirstElement();
      }
    } );
  ...
  public Feature getSelectedCrossSection( )
  {
    return m_selection;
  }
}
