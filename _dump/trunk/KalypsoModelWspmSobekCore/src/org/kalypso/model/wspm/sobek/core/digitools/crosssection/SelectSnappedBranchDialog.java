 ...
 * @author kuch
 */
public class SelectSnappedBranchDialog extends TitleAreaDialog
{
  protected SnappedBranch m_selection = null;

  private final SnappedBranch[] m_snapped;

  public SelectSnappedBranchDialog( final Shell parentShell, final SnappedBranch[] snapped )
  {
    super( parentShell );
    m_snapped = snapped;
    setBlockOnOpen( true );
  ...
  protected Control createDialogArea( final Composite parent )
  {
    ...
    viewer.setLabelProvider( new LabelProvider()
    {
      ...
      {
        if( element instanceof SnappedBranch )
        {
    ...
    viewer.addSelectionChangedListener( new ISelectionChangedListener()
    {
      ...
      public void selectionChanged( final SelectionChangedEvent event )
      {
        ...
        m_selection = (SnappedBranch) selection.getFirstElement();
      }
    } );
  ...
  public SnappedBranch getSelectedCrossSection( )
  {
    return m_selection;
  }
}
