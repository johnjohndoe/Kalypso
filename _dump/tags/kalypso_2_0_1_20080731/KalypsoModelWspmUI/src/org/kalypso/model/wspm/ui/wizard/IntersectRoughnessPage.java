...
public class IntersectRoughnessPage extends WizardPage implements IUpdateable, IKalypsoThemeFilter
{
  ...
  public void createControl( final Composite parent )
  {
    ...
    final KalypsoResourceSelectionDialog dialog = new KalypsoResourceSelectionDialog( getShell(), initialSelection, Messages.IntersectRoughnessPage_9, new String[] { "gml" }, root, new ResourceSelectionValidator() ); //$NON-NLS-2$ //$NON-NLS-1$ //$NON-NLS-1$
