...
public class IntersectRoughnessPage extends WizardPage implements IUpdateable, IKalypsoThemeFilter
{
  ...
  public IntersectRoughnessPage( final IMapModell modell )
  {
    ...
    setMessage( "Bitte w‰hlen Sie aus, wie die Rauheiten zugewiesen werden sollen." );
  ...
  private void createFilterGroup( final Composite composite )
  {
    ...
    /* theme chooser */
    new Label( group, SWT.NONE ).setText( "&W‰hlen Sie die anzuwendenden Filter:" );
  ...
  public void update( )
  {
    ...
    if( polygoneTheme == null )
      setErrorMessage( "Es sind keine Polygon-Themen in der Karte vorhanden. Zuweisung nicht mˆglich." );
    else if( polygoneValueProperty == null )
      setErrorMessage( "Das gew‰hlte Thema hat keine Wert-Eigenschaften. Zuweisung nicht mˆglich." );
