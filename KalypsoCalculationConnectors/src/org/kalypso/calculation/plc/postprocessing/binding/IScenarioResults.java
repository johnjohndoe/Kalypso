...
public interface IScenarioResults extends Feature
{
  ...
  ICoverageCollection getInundationCalcualtedCoverages( );

  ICoverageCollection getInundationDifferencesCoverages( );

  ICoverageCollection getRiskStatusQuoCoverages( );

  ICoverageCollection getRiskCalcualtedCoverages( );

  ICoverageCollection getRiskDifferencesCoverages( );
}
