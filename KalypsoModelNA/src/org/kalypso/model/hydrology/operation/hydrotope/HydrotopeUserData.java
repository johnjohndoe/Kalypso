 ...
 */
public class HydrotopeUserData
{
  private final Polygon[] m_polygons;

  private final Feature[] m_features;

  private String m_hydrotopeHash = null;
  ...
  private String buildHashNoHash( )
  {
  ...
  {
    final HydrotopePrototype prototype = getPrototype();
    prototype.copyAttributes( hydrotope, count );
  }

  private HydrotopePrototype getPrototype( ) throws CoreException
  {
    if( m_prototype == null )
      m_prototype = new HydrotopePrototype( m_features, m_polygons );
