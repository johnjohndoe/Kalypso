...
public class FeatureListGeometryIntersector
{
  ...
  public List<Polygon> intersect( final IProgressMonitor monitor )
  {
      ...
      for( final Object thisObject : sourcePolygons )
      {
        ...
        for( final Object candidateObject : candidates )
        {
          ...
          else if( relate.isIntersects() && !relate.isTouches( dim1, dim2 ) )
          {
            ...
            {
              m_log.add( StatusUtilities.createStatus( IStatus.WARNING, "Mˆgliches Problem bei der Verschneidung von \n" + featurePolygon + "\n" + candidatePolygon, e ) );
            }
    ...
    m_log.add( StatusUtilities.createStatus( IStatus.INFO, "Gesamter Fl‰chenfehler bei der Verschneidung: " + totalAreaDiscarded, null ) );
