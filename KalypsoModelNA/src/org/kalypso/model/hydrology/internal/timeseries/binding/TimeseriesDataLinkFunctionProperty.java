 ...
 * @author Dirk Kuch
 */
public class TimeseriesDataLinkFunctionProperty extends FeaturePropertyFunction
{
  ...
  public Object getValue( final Feature feature, final IPropertyType pt, final Object currentValue )
  {
    ...
    final ITimeseries timeseries = (Timeseries) feature;
    final IStation station = timeseries.getStation();

    final String stationFoldername = station.getTimeseriesFoldername();

    final String timeseriesFilename = formatTimeseriesFilename( timeseries.getParameterType(), timeseries.getQuality(), timeseries.getTimestep() );
