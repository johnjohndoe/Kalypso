...
// public static int addRHBinCatchment( final GMLWorkspace modelworkspace, final Feature catchment, final IFeatureType
// rhbFT, final Feature measureRhbFE )
// {
...
// final Iterator<Object> iterator = new ValueIterator( min, intervall, max );
...
// * @return
// */
// private static Double getDischarge( final double sumHeigth, final double mu, final double g, final double diameter,
// final double factorHecto )
// {
...
// * @return
// */
// private static Double getVolume( final double waterlevel, final double lenght, final double slope, final double
// depth, final double factorHecto )
// {
// final double value = (4 / 3 * Math.pow( slope, 2d ) * (Math.pow( waterlevel, 2d ) - 3 * depth * Math.pow( waterlevel,
// 2d ) + 3 * Math.pow( depth, 2d ) * waterlevel) + 2 * slope * lenght
