 ...
 * ---------------------------------------------------------------------------
 */
public class RemoveResultsVisitor extends NetElementVisitor
{
  private final List m_visited;

  /*
   * 
   * @author doemming
   */
  public RemoveResultsVisitor()
  {
  ...
  {
    if( m_visited.contains( netElement ) )
      return false;
    netElement.removeResult();
    m_visited.add( netElement );
    return true;
  }
}