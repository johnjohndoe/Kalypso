  ...
  public static GM_MultiSurface[] findCatchmentAreas( Feature[] catchmentFeatures, String catchmentAreaPath ) throws CoreException
  {
    ...
    for( int i = 0; i < catchmentFeatures.length; i++ )
    {
      ...
      if( object instanceof GM_Surface )
      {
        ...
        throw new CoreException( StatusUtilities.createStatus( IStatus.ERROR, String.format( "Ung¸ltiges Object in Zeitreihenlink: %s (Property: %s). Erwartet wird ein GM_Surface oder ein GM_MultiSurface.", object, catchmentAreaPath ), null ) );
    }
