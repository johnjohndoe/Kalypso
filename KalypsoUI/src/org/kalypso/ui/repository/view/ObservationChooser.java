...
/**
 * A view that allows the user to choose an observation within a tree of
 * repositories
 * 
 * created by
 * 
 ...
 */
public class ObservationChooser extends AbstractViewer implements
    IRepositoryContainerListener, ISelectionProvider
{
  ...
  /**
   * @return checks if given selection is a <code>IRepository</code>. Returns
   *         a repository or null if no repository is selected.
   */
