...
public class PolygonSymbolizerLayout extends SymbolizerLayout{
	...
	public PolygonSymbolizerLayout(Composite composite, Symbolizer symbolizer, KalypsoUserStyle userStyle)
	{
	...
	{		
		...
		ColorChooserPanel fillColorChooserPanel = new ColorChooserPanel(fillGroup, "Fill-Color:", polygonFill.getFill(null));
		...
		SliderPanel fillOpacityPanel = new SliderPanel(fillGroup, "Fill-Opacity", 0,1,1,SliderPanel.DECIMAL,polygonFill.getOpacity(null));		
		...
		ColorChooserPanel strokeColorChooserPanel = new ColorChooserPanel(strokeGroup, "Color:",polygonStroke.getStroke(null));
		...
		SliderPanel strokeWidthPanel = new SliderPanel(strokeGroup, "width:", 0,10,1,SliderPanel.INTEGER,polygonStroke.getWidth(null));
		...
		SliderPanel strokeOpacityPanel = new SliderPanel(strokeGroup, "Opacity:", 0,1,1,SliderPanel.DECIMAL,polygonStroke.getOpacity(null));
		...
		ComboPanel strokeLinejoinPanel = new StrokeLinejoinComboPanel(strokeGroup, "Linejoin",polygonStroke.getLineJoin(null));
		...
		ComboPanel strokeLinecapPanel = new StrokeLinecapComboPanel(strokeGroup, "Linecap", polygonStroke.getLineCap(null));
		...
		// Stroke DashOffset		
		StrokeDashoffsetPanel strokeDashoffsetPanel = new StrokeDashoffsetPanel(strokeGroup, "Dashoffset", polygonStroke.getDashOffset(null));
		...
		// Stroke DashArray
		StrokeDasharrayPanel strokeDasharrayPanel = new StrokeDasharrayPanel(strokeGroup, "Dasharray", polygonStroke.getDashArray(null));
