 ...
 * @author belger
 */
public class MoveThemeDownAction extends FullAction implements ISelectionChangedListener
{
  private final StructuredViewer m_viewer;
  private IListManipulator m_listManipulator;

  public MoveThemeDownAction( final String text, final ImageDescriptor image, final String tooltipText, final StructuredViewer structuredViewer, final IListManipulator listManip )
  {
