 ...
 * @author schlienger
 */
public class DiagramTemplate extends AbstractTemplateEventProvider implements IDiagramTemplate
{
  ...
  public DiagramTemplate( final String title, final String legendName, final boolean showLegend )
  {
    m_title = title;
