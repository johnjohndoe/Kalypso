...
{
  public ComponentUiIntegerHandler( final IComponent component, final boolean editable, final boolean resizeable, final boolean moveable, final String columnLabel, final int columnStyle, final int columnWidth, final int columnWidthPercent, final String displayFormat, final String nullFormat, final String parseFormat )
  {
  ...
  public void setValue( final IRecord record, final Object value )
  {
    if( value == null )
      ...
      record.setValue( getComponent(), new BigInteger( value.toString() ) );
  }
