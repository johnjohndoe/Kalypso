...
public class MoveThemeDownAction extends MapModellViewActionDelegate
{
  ...
  protected void moveElementDown( final IKalypsoTheme theme, final Display display )
  {
    final IMapModellView view = getView();
    if( view == null )
      return;
  ...
  {
    final IKalypsoTheme[] selectedThemes = MapModellViewActionDelegate.getSelectedThemes( selection );
