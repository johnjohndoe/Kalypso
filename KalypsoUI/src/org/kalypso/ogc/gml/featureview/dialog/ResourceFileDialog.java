...
public class ResourceFileDialog implements IFeatureDialog
{
  ...
  public ResourceFileDialog( final GMLWorkspace workspace,
  ...
  {
    IFile gmlFile = ResourceUtilities
        .findFileFromURL( m_workspace.getContext() );
    ...
    KalypsoResourceSelectionDialog selectionDialog = new KalypsoResourceSelectionDialog(
        shell, resultFile, "", null, workspaceRoot );
    final int open;
    ...
    if( result != null )
    {
      ...
      m_change = new FeatureChange( m_feature, m_ftp.getName(),
          ResourceUtilities.findFileFromPath( resultPath ) );
      open = Window.OK;
    }
    else
    {
  ...
  private IFile getResourceFile() throws MalformedURLException
  {
    if( m_change != null )
    {
