 ...
 * @author Belger
 */
public class BooleanFeatureCellEditor extends AbstractFeatureCellEditor
{
  public BooleanFeatureCellEditor()
  {
    setCellEditor( new TextCellEditor() );
    setValidator( DefaultCellValidators.BOOLEAN_VALIDATOR );
  }
  ...
  protected Map doGetValues()
  {
    ...
    map.put( getPropertyName(), value == null ? null : new Boolean( value.toString() ) );
    return map;
  }
