...
!***********************************************************************************************
      ...
      integer function ju0nch(string)

!*  die funktion ju0nch erhaelt als funktionswert die nummer des nicht
!*  leeren (blank) letzten characters eines strings.

      character string*(*)

ilen  =len(string)
ju0nch=index(string(1:ilen),' ')-1
return 
end
