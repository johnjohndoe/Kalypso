...
IMPLICIT NONE
PUBLIC
INTEGER, parameter :: ikdim=300
INTEGER, parameter :: idim=2880
INTEGER, parameter :: jdim=410
INTEGER, parameter :: maxlay=10
INTEGER, parameter :: idimtgw=2880
INTEGER, parameter :: igwdim=6
INTEGER, parameter :: idimkap=10
INTEGER, parameter :: idimt=2880
INTEGER, parameter :: idimanf=100
INTEGER, parameter :: idimnutz=5000
INTEGER, parameter :: idimnutz2=100
INTEGER, parameter :: idimnutz3=100
INTEGER, parameter :: idimhyd=15000
INTEGER, parameter :: ndim=5
INTEGER, parameter :: idimp=5700
END MODULE generic_PARAM
