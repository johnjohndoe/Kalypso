!     Last change:  JH   31 Jul 2006    7:20 am
MODULE generic_NAConstants
!**************************************LICENSE**************************************************
!
...
PUBLIC
LOGICAL :: DEBUG = .TRUE.
INTEGER, PARAMETER :: NORMAL_HYDTYP  = 0
INTEGER, PARAMETER :: HYDTYP_MRS_KEY = 1
INTEGER, PARAMETER :: HYDTYP_GD_KEY = 2
INTEGER, PARAMETER :: GD_INTO_MRS_KEY = 21
INTEGER, PARAMETER :: NO_MR_ELEMENT = -1
END MODULE generic_NAConstants

MODULE generic_PHYSICAL_CONS
IMPLICIT NONE
PUBLIC
REAL, PARAMETER :: pi=3.141592654
REAL, PARAMETER :: g=9.81
END MODULE generic_PHYSICAL_CONS
