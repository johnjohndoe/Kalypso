...
{
  protected static final Image IMG = new Image( null, KalypsoRrmWelcomePageFrame.class.getResourceAsStream( "icons/hydrology_no.gif" ) );

  protected static final Image IMG_HOVER = new Image( null, KalypsoRrmWelcomePageFrame.class.getResourceAsStream( "icons/hydrology_hover.gif" ) );
