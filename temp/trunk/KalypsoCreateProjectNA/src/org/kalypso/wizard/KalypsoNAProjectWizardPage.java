...
import org.deegree_impl.gml.schema.SpecialPropertyMapper;
...
public class KalypsoNAProjectWizardPage extends WizardPage
{
  ...
  public KalypsoNAProjectWizardPage( String pageName, FeatureType featureType )
  {
    ...
    setDescription( "Dieser Dialog liest eine ESRI Shape-Datei ein. Der Benutzer muss jedes Attribut in "
        + "der Shape-Datei einem NA-Modell Attribute zuordnen (Mapping). Bitte die Auswahl mit OK best‰tigen." );
      ...
      FeatureType featureType )
  {
    ...
    setDescription( "Dieser Dialog liest eine ESRI Shape-Datei ein. Der Benutzer muss jedes Attribut in "
        + "der Shape-Datei einem NA-Modell Attribute zuordnen. Bitte die Auswahl mit OK best‰tigen." );
    targetFT = featureType;
    setPageComplete( false );
