...
public class Raster2ZML
{
  ...
  public boolean createZML( Feature[] fe ) throws Exception
  {
    ...
    final DWDRaster bbox_4326_Raster = (DWDRaster)m_store.get( new Integer( KEY_GEO_BBOX_4326 ) );
    Object o = m_store.get( new Integer( KEY_GEO_Point_4326 ) );
    final DWDRaster point_4326_Raster = (DWDRaster)o;
    final GeoTransformer transformer = new GeoTransformer( fe[0].getDefaultGeometryProperty()
        .getCoordinateSystem() );
