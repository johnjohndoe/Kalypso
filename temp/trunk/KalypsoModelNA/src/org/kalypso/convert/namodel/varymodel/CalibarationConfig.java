...
public class CalibarationConfig
{
  ...
  public void addFromNAControl( Feature rootFeature )
  {
    ...
    {
        new String[]
        { queryBaseCatchment + "/bianf" // TODO ist es korrekt, direkt bianf zu setzen ??
//        , queryBaseCatchment + "/@fid" // TEST auf Attribute
  ...
  private CalContext[] read( Document doc ) throws TransformerException
  {
    ...
    //        Node flowLevel = xmlServiceTools.getXPath_singleNode( queryPeakFlowLevel,
    // doc );
     ...
     */
    String queryUpBound = "/autoCalibration/parameterlist/parameter/upperBound";
    String queryLoBound = "/autoCalibration/parameterlist/parameter/lowerBound";
    String querySynValues = "/autoCalibration/parameterlist/parameter/synteticValue";
    String queryInitialValues = "/autoCalibration/parameterlist/parameter/initialValue";
    ...
    for( int i = 0; i < anzParam; i++ )
    {
      ...
      String xPathquery = "/autoCalibration/parameterlist/parameter[@ID=\"" + id + "\"]/xpath";
      ...
      calContexts[i] = new CalContext( initial, synthetic, lowerBound, upperbound, mode, xPaths );
    }
    return calContexts;
  }
}
