...
public class NaModelCalcJob implements ISimulation
{
  ...
  // */
  // private ISimulationDataProvider getDataProviderFromMeasure( final Logger logger, final ISimulationDataProvider
  // originalDataProvider, final File tmpDir )
  // {
  // final CalcDataProviderDecorater result = new CalcDataProviderDecorater( originalDataProvider );
  // if( !(originalDataProvider.hasID( NaModelConstants.IN_MEASURE_ID ) && originalDataProvider.hasID(
  // NaModelConstants.IN_HYDROTOP_ID ) && originalDataProvider.hasID( NaModelConstants.IN_MODELL_ID )) )
  // {
  ...
  // * @throws Exception
  // */
  // private void insertSealingChangeMeasure( GMLWorkspace measureWorkspace, ISimulationDataProvider
  // originalDataProvider, CalcDataProviderDecorater result, Logger logger, File tmpDir ) throws SimulationException,
  ...
  // final FeatureList hydroList = (FeatureList) hydroWorkspace.getFeatureFromPath(
  // "HydrotopCollectionMember/HydrotopMember" );
  //
  ...
  // * @throws Exception
  // */
  // private void insertStorageChannelMeasure( GMLWorkspace measureWorkspace, ISimulationDataProvider
  // originalDataProvider, CalcDataProviderDecorater result, Logger logger, File tmpDir ) throws SimulationException,
  // IOException, Exception
  // {
  // final URL measureURL = (URL) originalDataProvider.getInputForID( NaModelConstants.IN_MEASURE_ID );
  ...
  // {
  // logger.info( "measure " + MEASURE_RETENSION_BASIN_FEATURE + " is empty, continue normal simulation without this
  // measure" );
  // return;
  // }
  // final GMLWorkspace modelworkspace = GmlSerializer.createGMLWorkspace( modelURL );
  // final FeatureList rbList = (FeatureList) modelworkspace.getFeatureFromPath(
  // "ChannelCollectionMember/channelMember[StorageChannel]" );
  // final FeatureList catchementList = (FeatureList) modelworkspace.getFeatureFromPath(
  // "CatchmentCollectionMember/catchmentMember" );
