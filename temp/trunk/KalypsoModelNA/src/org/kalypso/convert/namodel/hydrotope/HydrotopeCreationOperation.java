...
public class HydrotopeCreationOperation implements IRunnableWithProgress
{
  ...
  public void run( final IProgressMonitor monitor ) throws InvocationTargetException
  {
    ...
    try
    {
      ...
      int count = 0;
      int ordinalNr = 0;
      final String nameFormat = "H_%1$0" + String.valueOf( intersectionList.size() ).length() + "d";
      final String featureDescription = String.format( "Generated by Kalypso on %1$td.%1$tm.%1$tY, %1$tH:%1$tM", new GregorianCalendar() );
      for( final Geometry geometry : intersectionList )
      {
        ...
        feature.setName( String.format( nameFormat, ++ordinalNr ) );
