...
public class CatchmentManager extends AbstractManager
{
    ...
    public Feature[] parseFile(URL url) throws Exception
    {
        ...
        LineNumberReader reader = new LineNumberReader(new InputStreamReader(
                url.openConnection().getInputStream()));// new FileReader( file
        // ) );
        Feature fe = null;
    ...
    private Feature readNextFeature(LineNumberReader reader) throws Exception
    {
        ...
        FeatureProperty bodenkorrekturProperty = FeatureFactory
                .createFeatureProperty("bodenkorrekturmember", list);
        propCollector.put(bodenkorrekturProperty.getName(),
                bodenkorrekturProperty);
        // 9
        ...
        FeatureProperty property = FeatureFactory.createFeatureProperty(
                "grundwasserabflussMember", gwList);
        ...
        if (igwzu > 0)
        {
            ...
            for (int i = 0; i < igwzu; i++)
            {
                ...
                FeatureProperty ngwzuProp = FeatureFactory
                        .createFeatureProperty("ngwzu", ngwzuStringID);
                fe.setProperty(ngwzuProp);
                FeatureProperty fp2 = (FeatureProperty) col2.get("gwwi" + i);
                FeatureProperty nwwiProp = FeatureFactory
                        .createFeatureProperty("gwwi", fp2.getValue());
            ...
            throws Exception
    {
        ...
        Feature col = (Feature) rootFeature
    ...
    private void writeFeature(Writer writer, GMLWorkspace workSpace,
            Feature feature) throws Exception
    {
        ...
        for (Iterator iterator = gwList.iterator(); iterator.hasNext();)
        {
            ...
            //      if(linkedFE==null)
            //          throw new Exception("broken NA-Modell: grundwasserabfluss in
            // unbekanntes Teilgebiet: #"+fe.getProperty("ngwzu").toString());
            if (linkedFE == null)
                line13
