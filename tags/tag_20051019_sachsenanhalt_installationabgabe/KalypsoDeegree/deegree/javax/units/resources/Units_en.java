...
/**
 * Noms d'unités en langue anglaise. Les unités qui n'apparaissent pas dans cette ressources ne seront pas localisées.
 * 
 * @version 1.0
...
{
  /**
   * Liste des unités en anglais. Les clés sont les symboles standards (sauf exception) des unités. Les valeurs sont les
   * noms en anglais de ces unités.
   */
  static final String[] contents =
  {
      ...
      "astronomical unit",
      "inch",
      "inch", // Symbole non-standard
      "foot",
      "foot", // Symbole non-standard
      "yard",
      "yard", // Symbole non-standard
      "fathom",
      "English fathom", // Symbole non-standard
      "brasse",
      "French fathom", // Symbole non-standard
      "mile",
      "mile", // Symbole non-standard
      "nmile",
      "nautical mile", // Symbole non-standard
      "knot",
      "knot", // Symbole non-standard
      "are",
      "are",
      "ha",
      "hectare",
      ...
      // non-standard
      "onze",
      "onze", // Symbole non-standard
      "°C",
      "Celcius degree",
      "°F",
      "fahrenheit" // Symbole non-standard
  };
