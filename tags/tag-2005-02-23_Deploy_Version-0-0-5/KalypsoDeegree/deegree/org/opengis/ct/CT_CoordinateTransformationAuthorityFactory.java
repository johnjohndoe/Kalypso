...
/**
 * Creates coordinate transformation objects from codes. The codes are
 * maintained by an external authority. A commonly used authority is EPSG, which
 * is also used in the GeoTIFF standard.
 * 
 * @version 1.01
 * @since 1.00
 * @author Martin Daly
...
public interface CT_CoordinateTransformationAuthorityFactory extends Remote
{
  ...
  /**
   * Creates a transformation from a single transformation code. The 'Authority'
   * and 'AuthorityCode' values of the created object will be set to the
   * authority of this object, and the code specified by the client,
