...
/**
 * AddObservationCommand2: this does not add the theme, it is supposed to be
 * used when the theme is already added.
 * 
 * @author schlienger
 */
public class AddThemeCommand2 implements ICommand
{
  private final AbstractViewTemplate m_template;

  private final AbstractObservationTheme m_theme;

  public AddThemeCommand2( AbstractViewTemplate template,
