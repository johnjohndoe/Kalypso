...
/**
 * Wraps an {@link org.kalypso.metadoc.ui.ExportWizard}into a {@link org.eclipse.jface.wizard.IWizardNode}.
 * 
 * @author schlienger
 */
  ...
  public IWizard getWizard()
  {
    if( m_wizard == null )
    {
      ...
      catch( final CoreException e )
      {
        ...
        ErrorDialog.openError( m_shell, "Export", "Export-Wizard konnte nicht erzeugt werden", e.getStatus() );
      }
    }
