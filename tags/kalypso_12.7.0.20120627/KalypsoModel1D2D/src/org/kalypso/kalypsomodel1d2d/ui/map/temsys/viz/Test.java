...
public class Test
{
  ...
  public static void main( final String[] args )
  {
    ...
    final double[] centerCo_1 = new double[3];
    centerCo_1[0] = 1.0;
    centerCo_1[1] = 0.5;
    centerCo_1[2] = 5.0;

    final double[] centerCo_2 = new double[3];
    centerCo_2[0] = 1.0;
    centerCo_2[1] = 1.0;
    centerCo_2[2] = 8.0;

    final double[] centerCo_3 = new double[3];
    centerCo_3[0] = 1.0;
    centerCo_3[1] = 0.0;
    centerCo_3[2] = 10.0;
//    centerCo_1[0] = 1.0;
...
//    centerCo_3[2] = 1.0;
 //   centerCo[2] = computeZOfTrianglePlanePoint( coords, centerCo[0], centerCo[1] );
    ...
    final String aa = "ABVSS"; //$NON-NLS-1$
  ...
  public boolean furtherDivisionNeeded( final GM_Position[] coOrds )
  {
    ...
    final GM_Position _center = calculateCenterCoOrdinate( coOrds );
    ...
    final double specA = convertToTwoDecimals(((_inX_1 * _inX_2)+
                                         (_inY_1 * _inY_2)+
                                         (_inZ_1 * _inZ_2))
                                       *((_inX_1 * _inX_2)+
                                         (_inY_1 * _inY_2)+
    ...
    final double specB = convertToTwoDecimals(    ((_inX_1 * _inX_1)+(_inY_1 * _inY_1)+(_inZ_1 * _inZ_1)) *
...
//      return false;
  ...
  private GM_Position calculateCenterCoOrdinate( final GM_Position[] coords )
  {
 ...
 //   centerCo[2] = computeZOfTrianglePlanePoint( coords, centerCo[0], centerCo[1] );
  ...
  private double convertToTwoDecimals( final double r )
  {
