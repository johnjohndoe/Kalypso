 ...
 */
public class SimulationDescriptionFeatureControlFactory implements IExtensionsFeatureControlFactory2
{
  @Override
  ...
  {
    return new SimulationDescriptionFeatureControl( feature, pt );
  }
}