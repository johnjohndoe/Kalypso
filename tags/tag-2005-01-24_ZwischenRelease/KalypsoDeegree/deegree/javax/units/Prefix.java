...
/* public */final class Prefix implements Comparable, Serializable
{
   ...
   * 
   * @param name
   *          Nom du préfix (par exemple "centi" comme dans "centimètres").
   * @param symbol
   *          Symbole du préfix (par exemple "c" pour "centimètres").
   * @param amount
   *          Quantité représenté par ce préfix (par exemple 0.01 pour "c").
   */
