...
// timeLogger.printCurrentInterim( "Start-Read LS: " );
    ...
    final String strStationierung = "urn:ogc:gml:dict:kalypso:model:wspm:components#LengthSectionStation"; //$NON-NLS-1$
    final String strWsp = "urn:ogc:gml:dict:kalypso:model:wspm:components#LengthSectionWaterlevel"; //$NON-NLS-1$
