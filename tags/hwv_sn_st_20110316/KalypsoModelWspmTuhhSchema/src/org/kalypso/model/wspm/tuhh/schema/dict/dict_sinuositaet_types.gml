...
<gml:Dictionary xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
 ...
 <gml:description>Dictionary for sinuositaet types.</gml:description>
 <gml:name>Profile Sinuositaet Type Dictionary</gml:name>

 <gml:dictionaryEntry>
    <swe:Phenomenon gml:id="SINUOSITAET">
     <gml:description>%sinuositaet.description</gml:description>
     <gml:name>%sinuositaet.name</gml:name>
    </swe:Phenomenon>
 </gml:dictionaryEntry>
