 ...
 * equivalent to C/C++'s <code>realloc</code>.
 * 
 * @version 1.0
...
public final class XArray
{
  ...
  /**
   * Renvoie un nouveau tableau qui contiendra les mêmes éléments que <code>array</code> mais avec la longueur
   * <code>length</code> spécifiée. Si la longueur désirée <code>length</code> est plus grande que la longueur
   * initiale du tableau <code>array</code>, alors le tableau retourné contiendra tous les éléments de
   * <code>array</code> avec en plus des éléments initialisés à <code>null</code> à la fin du tableau. Si au
   * contraire la longueur désirée <code>length</code> est plus courte que la longueur initiale du tableau
   * <code>array</code>, alors le tableau sera tronqué (c'est à dire que les éléments en trop de <code>array</code>
   * seront oubliés). Si la longueur de <code>array</code> est égale à <code>length</code>, alors
   * <code>array</code> sera retourné tel quel.
   * 
   * @param array
   *          Tableau à copier.
   * @param length
   *          Longueur du tableau désiré.
   * @return Tableau du même type que <code>array</code>, de longueur <code>length</code> et contenant les données
   *         de <code>array</code>.
   */
   ...
   * <code>length</code> spécifiée. Si la longueur désirée <code>length</code> est plus grande que la longueur
   * initiale du tableau <code>array</code>, alors le tableau retourné contiendra tous les éléments de
   * <code>array</code> avec en plus des éléments initialisés à 0 à la fin du tableau. Si au contraire la longueur
   * désirée <code>length</code> est plus courte que la longueur initiale du tableau <code>array</code>, alors le
   * tableau sera tronqué (c'est à dire que les éléments en trop de <code>array</code> seront oubliés). Si la longueur
   * de <code>array</code> est égale à <code>length</code>, alors <code>array</code> sera retourné tel quel.
   * 
   * @param array
   *          Tableau à copier.
   * @param length
   ...
   * <code>length</code> spécifiée. Si la longueur désirée <code>length</code> est plus grande que la longueur
   * initiale du tableau <code>array</code>, alors le tableau retourné contiendra tous les éléments de
   * <code>array</code> avec en plus des éléments initialisés à <code>false</code> à la fin du tableau. Si au
   * contraire la longueur désirée <code>length</code> est plus courte que la longueur initiale du tableau
   * <code>array</code>, alors le tableau sera tronqué (c'est à dire que les éléments en trop de <code>array</code>
   * seront oubliés). Si la longueur de <code>array</code> est égale à <code>length</code>, alors
   * <code>array</code> sera retourné tel quel.
   ...
   * 
   * @param array
   *          Tableau dans lequel retirer des éléments.
   * @param index
   *          Index dans <code>array</code> du premier élément à retirer. Tous les éléments de <code>array</code>
   *          qui suivent cet index peuvent être décalés.
   * @param length
   *          Nombre d'éléments à retirer.
   * @return Tableau qui contient la données de <code>array</code> avec des éléments retirés. Cette méthode peut
   *         retourner directement <code>dst</code>, mais la plupart du temps elle retournera un tableau nouvellement
   *         créé.
   */
   ...
   * 
   * @param array
   *          Tableau dans lequel insérer des espaces.
   * @param index
   *          Index de <code>array</code> où insérer les espaces. Tous les éléments de <code>array</code> dont
   *          l'index est égal ou supérieur à <code>index</code> seront décalés.
   * @param length
   *          Nombre d'espaces à insérer.
   * @return Tableau qui contient la données de <code>array</code> avec l'espace suplémentaire. Cette méthode peut
   *         retourner directement <code>dst</code>, mais la plupart du temps elle retournera un tableau nouvellement
   *         créé.
   */
   ...
   *          Tableau dans lequel insérer des espaces.
   * @param index
   *          Index de <code>array</code> où insérer les espaces. Tous les éléments de <code>array</code> qui
  ...
  /**
   * Insère des espaces au milieu d'un tableau. Ces "espaces" seront constitués de <code>false</code>.
   * 
   * @param array
   *          Tableau dans lequel insérer des espaces.
   * @param index
  ...
  /**
   * Insère une portion de tableau dans un autre tableau. Le tableau <code>src</code> sera inséré en totalité ou en
   * partie dans le tableau <code>dst</code>.
   * 
   * @param src
   *          Tableau à insérer dans <code>dst</code>.
   * @param src_pos
   *          Index de la première donnée de <code>src</code> à insérer dans <code>dst</code>.
   * @param dst
   *          Tableau dans lequel insérer des données de <code>src</code>.
   * @param dst_pos
   *          Index de <code>dst</code> où insérer les données de <code>src</code>. Tous les éléments de
   *          <code>dst</code> dont l'index est égal ou supérieur à <code>dst_pos</code> seront décalés.
   * @param length
   *          Nombre de données de <code>src</code> à insérer.
   * @return Tableau qui contient la combinaison de <code>src</code> et <code>dst</code>. Cette méthode peut
   *         retourner directement <code>dst</code>, mais jamais <code>src</code>. La plupart du temps, elle
   *         retournera un tableau nouvellement créé.
   */
  private static Object doInsert( final Object src, final int src_pos, final Object dst, final int dst_pos,
      final int length )
  {
    if( length == 0 )
      return dst;
   ...
   *         retournera un tableau nouvellement créé.
   */
  public static Object[] insert( final Object[] src, final int src_pos, final Object[] dst, final int dst_pos,
      final int length )
  {
   ...
   *         retournera un tableau nouvellement créé.
   */
  public static double[] insert( final double[] src, final int src_pos, final double[] dst, final int dst_pos,
      final int length )
  {
   ...
   *         retournera un tableau nouvellement créé.
   */
  public static float[] insert( final float[] src, final int src_pos, final float[] dst, final int dst_pos,
      final int length )
  {
   ...
   *         retournera un tableau nouvellement créé.
   */
  public static long[] insert( final long[] src, final int src_pos, final long[] dst, final int dst_pos,
      final int length )
  {
   ...
   *         retournera un tableau nouvellement créé.
   */
  public static short[] insert( final short[] src, final int src_pos, final short[] dst, final int dst_pos,
      final int length )
  {
   ...
   *         retournera un tableau nouvellement créé.
   */
  public static byte[] insert( final byte[] src, final int src_pos, final byte[] dst, final int dst_pos,
      final int length )
  {
   ...
   *         retournera un tableau nouvellement créé.
   */
  public static char[] insert( final char[] src, final int src_pos, final char[] dst, final int dst_pos,
      final int length )
  {
   ...
   *         retournera un tableau nouvellement créé.
   */
  public static boolean[] insert( final boolean[] src, final int src_pos, final boolean[] dst, final int dst_pos,
      final int length )
  {
