 ...
 * @author doemming
 */
public class XSDDoubleTypeHandler extends AbstractXSDSimpleTypeHandler
{

  public XSDDoubleTypeHandler( )
  {
    super( Double.class, new QName[] { new QName( XMLHelper.XMLSCHEMA_NS, "double" ), new QName( XMLHelper.XMLSCHEMA_NS, "decimal" ) } );
  }
