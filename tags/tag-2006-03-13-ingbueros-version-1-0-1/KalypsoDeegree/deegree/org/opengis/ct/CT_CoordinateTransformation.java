...
/**
 * Describes a coordinate transformation. This interface only describes a coordinate transformation, it does not
 * actually perform the transform operation on points. To transform points you must use a math transform.
 * 
 * The math transform will transform positions in the source coordinate system into positions in the target coordinate
 * system.
 * 
 * @version 1.01
 * @since 1.00
...
public interface CT_CoordinateTransformation extends Remote
{
  ...
  /**
   * Code used by authority to identify transformation. The AuthorityCode is a compact string defined by an Authority to
