 ...
 */
public interface IFlowRelation2D extends IFlowRelationship
{
  public static final QName QNAME = new QName( UrlCatalog1D2D.MODEL_1D2D_NS, "_FlowRelation2D" ); //$NON-NLS-1$
