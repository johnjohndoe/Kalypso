...
public interface ExternalGraphic
{
  ...
  /**
   * the Format sub-element identifies the expected document MIME type of a
   * successful fetch. This method sets the format of an ExternalGraphic.
   * 
   * @param format
  ...
  /**
   * The OnlineResource gives the URL of the external graphic This method sets
   * the OnlineRessource of an ExternalGraphic.
   * 
