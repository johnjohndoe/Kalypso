...
/**
 * Defines the operations for the WFS. For example from the
 * FeatureTypeList-interface.
 * 
 * <p>
 * -----------------------------------------------------
 * </p>
...
{
  /**
   * The &lt;InsertFeature&gt; element is used to indicate that the WFS is
 ...
 * empty log message *** Revision 1.2 2003/04/23 07:23:15 poth no message
 * 
