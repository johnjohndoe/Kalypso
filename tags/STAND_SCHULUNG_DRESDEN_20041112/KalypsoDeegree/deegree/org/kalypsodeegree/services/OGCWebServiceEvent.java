...
/**
 * This is the defining interface for event objects that contains a request, a
 * response, a message or an exception the should be made available for a
 * service.
 * <p>
 * </p>
...
public interface OGCWebServiceEvent
{
  ...
  /**
   * returns the client where to write the result/response or an error message
   * to
   */
