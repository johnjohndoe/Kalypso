...
public interface OGCWebServiceCapabilities
{
   ...
   * value can be an integer, a timestamp in [ISO 8601:1988(E)] format , or any
   * other number or string. The server may include an UpdateSequence value in
   * its Capabilities XML. If present, this value should be increased when
