...
public class PostgisDBAccess extends DBAccess
{
   ...
   * 
   * @param con
   *          connection to a postgis database with spatial extension.
   */
   ...
   *          jdbc driver
   * @param logon
   *          address of the database (additional parameters)
   * @param user
   * @param password
   * @throws SQLException
   * @throws Exception
   */
  public PostgisDBAccess( String driver, String logon, String user, String password )
   ...
   * @throws Exception
   */
  public PostgisDBAccess( String driver, String logon, Properties properties ) throws SQLException,
      Exception
  {
   ...
   * @throws Exception
   */
  public PostgisDBAccess( String driver, String logon, Properties properties, boolean autoCommit )
      throws SQLException, Exception
  {
   ...
   * @param startFeature
   *          index of the first feature (row) to return
   * @param maxFeatures
   *          maximum number of returned features (rows)
   * 
   * @return @throws
   *         SQLException
