...
public class ContactInformation_Impl implements ContactInformation, Marshallable
{
  ...
  public ContactInformation_Impl( String contactPosition, String contactVoiceTelephone,
      String contactFacsimileTelephone, String contactElectronicMailAddress,
      ContactPersonPrimary contactPersonPrimary, ContactAddress contactAddress )
  {
  ...
  /**
   * sets a datastructure that contains the name of the contact person and the
  ...
  public String exportAsXML()
  {
    ...
    {
      sb.append( "<ContactPosition>" ).append( XMLTools.validateCDATA( contactPosition ) ).append(
          "</ContactPosition>" );
    }
    ...
    if( contactVoiceTelephone != null )
    {
      sb.append( "<ContactVoiceTelephone>" )
          .append( XMLTools.validateCDATA( contactVoiceTelephone ) ).append(
              "</ContactVoiceTelephone>" );
    }

    if( contactFacsimileTelephone != null )
    {
      sb.append( "<ContactFacsimileTelephone>" ).append(
          XMLTools.validateCDATA( contactFacsimileTelephone ) ).append(
          "</ContactFacsimileTelephone>" );
    }

    if( contactElectronicMailAddress != null )
    {
      sb.append( "<ContactElectronicMailAddress>" ).append(
          XMLTools.validateCDATA( contactElectronicMailAddress ) ).append(
