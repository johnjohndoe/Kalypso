 ...
 * 
 * 
 * The class listens to the get request against iso 19115 formated metadata here
 * the result shall be returned in full format
 * 
  ...
  protected Object validateResult( HashMap result ) throws CatalogClientException
  {
    ...
    try
    {
      ...
      while( iterator.hasNext() )
      {
        ...
        {
          BaseMetadata mdMetadata = MetadataFactory.createISO19115Brief( (Element)nl.item( i ),
              null );
