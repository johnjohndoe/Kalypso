 ...
 * each of the encapsulated parameters: <p/>feature info formats <p/>pan factors (%
 * of the map size) <p/>zoom factors (% of the map factors) <p/>minimum
 * displayable scale (WMS scale definition) <p/>maximum displayable scale (WMS
 * scale definition) <p/>
 * 
 * @version $Revision$
...
public class MapParameter
{
  ...
  /**
   * sets the minimum map scale as defined at the OGC WMS specs that is offered
   * by the map context
   * 
   * @param minScale
   */
  ...
  /**
   * sets the maximum map scale as defined at the OGC WMS specs that is offered
   * by the map context
   * 
   * @param maxScale
   */
