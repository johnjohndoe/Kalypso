 ...
 * the general elements inherited from AbstractFrontend three additional
 * elements are offered:
 * <ul>
 * <li>commonJS: a list of javascript files containing objects and methods to
 * be used by more than one module of the GUI
...
public class JSPFrontend extends AbstractFrontend
{
   ...
   * @param buttons
   *          name of the js-file containing a llist (Map) of the used buttons
   *          (images)
   * @param commonJS
   ...
   */
  public JSPFrontend( String controller, GUIArea west, GUIArea east, GUIArea south, GUIArea north,
      GUIArea center, String style, String buttons, String[] commonJS, String header, String footer )
  {
  ...
  /**
   * returns a list of javascript files containing objects and methods to be
   * used by more than one module of the GUI
   * 
   * @return
   */
  ...
  /**
   * sets the name of a javascript file containing a associative array (Map) for
   * the used buttons (images). If this is <tt>null</tt> HTML standard buttons
   * shall be used in the gui
   * 
   * @param buttons
   */
  ...
  /**
   * sets a list of javascript files containing objects and methods to be used
   * by more than one module of the GUI
   * 
   * @param commonJS
   */
  ...
  /**
   * adds the name of a javascript file containing objects and methods to be
   * used by more than one module of the GUI
   * 
   * @param commonJS
   */
  ...
  /**
   * removes the name of a javascript file containing objects and methods to be
   * used by more than one module of the GUI
   * 
   * @param commonJS
   */
