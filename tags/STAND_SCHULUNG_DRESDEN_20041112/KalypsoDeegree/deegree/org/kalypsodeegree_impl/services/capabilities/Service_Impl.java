 ...
 * Contact Information, Fees, and Access Constraints may be provided. The
 * meaning of most of these elements is defined in [ISO 19115]. The Service Name
 * shall be "OGC:WMS" in the case of a Web Map Service.
 * <p>
 * ----------------------------------------------------------------------
 * </p>
 * 
...
public class Service_Impl implements Service, Marshallable
{
   ...
   * The Service Title is at the discretion of the provider, and should be brief
   * yet descriptive enough to identify this server in a menu with other
   * servers.
   * 
   * @see #getName()
   */
   ...
   * Service Title is at the discretion of the provider, and should be brief yet
  ...
  /**
   * Sets access constraints assigned to the service. If no access constraints
   * are defined "none" will be returned.
   */
  ...
  public String exportAsXML()
  {
    ...
    sb.append( "<Service>" ).append( "<Name>" ).append( XMLTools.validateCDATA( name ) ).append(
    ...
    if( fees != null )
    {
      sb.append( "<Fees>" ).append( XMLTools.validateCDATA( fees ) ).append( "</Fees>" );
    }

    if( accessConstraints != null )
    {
      sb.append( "<AccessConstraints>" ).append( XMLTools.validateCDATA( accessConstraints ) )
