...
/**
 * 
 * This is the OGC conform web feature server class within the deegree
 * framework. A <tt>WFSService_Impl</tt> extends the <tt>WFSService</tt>
 * interface to act like a OGC web service. This means that a WFS is callable
 * through the <tt>doService</tt> -method inherited from
 * <tt>OGCWebService</tt>.
 * 
 * <p>
 * -------------------------------------------------------------------------
...
public class WFSService_Impl extends OGCWebService_Impl implements Handler
{
   ...
   * assaciation between services, feature types and responsible classes. The
   * second parameter is an instance of the (a) WFSDispatcher that handles the
   * requests and calls the responsible data store classes (e.g.
   * OracleDataStore).
   */
  ...
  public Object clone()
  {
    WFSService_Impl tmp = new WFSService_Impl( (WFSCapabilities)capabilities );
    tmp.registerHandler( dispatcher );
    return tmp;
  }
  ...
  /**
   * @see org.deegree_impl.services.wfs.WFSService_Impl#registerHandler(Handler)
   */
  ...
  public synchronized void doService( OGCWebServiceEvent event ) throws WebServiceException
  {
    ...
    event = new OGCWebServiceEvent_Impl( this, request, "Request sent by " + "the WFSService.",
        null );
    handleRequest( event );
  ...
  public synchronized void handleResponse( OGCWebServiceEvent event )
  {
    ...
    try
    {
      ...
      if( response instanceof WFSGetCapabilitiesResponse )
      {
        if( exce != null )
        {
          OGCWebServiceResponse res = WFSProtocolFactory.createWFSGetCapabilitiesResponse( request,
              exce, null );
      ...
      else if( response instanceof WFSGetFeatureResponse )
      {
        if( exce != null )
        {
          OGCWebServiceResponse res = WFSProtocolFactory.createWFSGetFeatureResponse( request,
              null, exce, null );
          OGCWebServiceEvent event_ = new OGCWebServiceEvent_Impl( this, res, "" );
          client.write( event_ );
        }
      ...
      else if( response instanceof WFSDescribeFeatureTypeResponse )
      {
        if( exce != null )
        {
          OGCWebServiceResponse res = WFSProtocolFactory.createWFSDescribeFeatureTypeResponse(
              request, null, exce, null );
          OGCWebServiceEvent event_ = new OGCWebServiceEvent_Impl( this, res, "" );
          client.write( event_ );
        }
        else
      ...
      else if( response instanceof WFSTransactionResponse )
      {
        if( exce != null )
        {
          OGCWebServiceResponse res = WFSProtocolFactory.createWFSTransactionResponse( request,
              null, exce, null, null, "" );
          OGCWebServiceEvent event_ = new OGCWebServiceEvent_Impl( this, res, "" );
          client.write( event_ );
        }
    ...
    {
      Debug.debugException( ex, null );
      OGCWebServiceException exce = new OGCWebServiceException_Impl( "WFSService_Impl", ex
          .toString() );
      Document doc = null;
      try
      {
      ...
      OGCWebServiceResponse res = new OGCWebServiceResponse_Impl( request, doc );
      OGCWebServiceEvent event_ = new OGCWebServiceEvent_Impl( this, res, "" );
      client.write( event_ );
    }
  ...
  private void handleGetCapabilitiesResponse( OGCWebServiceRequest request ) throws Exception
  {
    ...
    OGCWebServiceResponse resp = WFSProtocolFactory.createWFSGetCapabilitiesResponse( request,
        null, (WFSCapabilities)capabilities );
