/*----------------    FILE HEADER  ------------------------------------------
 ...
 Jens Fitzke
 Department of GeographyUniversity of Bonn
    ...
    try
    {
      ...
      for( int i = 0; i < queries.length; i++ )
      {
        if( parent.isKnownFeatureType( queries[i].getTypeName() ) )
        {
          ...
          GMLDBDataStoreOutputFC form = new GMLDBDataStoreOutputFC();
          FeatureCollection fc = (FeatureCollection)form.format( hm, pl, null );
