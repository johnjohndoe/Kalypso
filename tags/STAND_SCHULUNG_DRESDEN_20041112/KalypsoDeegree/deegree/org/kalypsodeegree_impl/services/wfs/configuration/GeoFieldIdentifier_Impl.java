...
public class GeoFieldIdentifier_Impl implements GeoFieldIdentifier
{
  ...
  /**
   * returns the root of the geo field name(s). example: if a POINTDB is used
   * where the x- and y-value are stored in columns named col_x and col_y the
   * base name will be 'col'.
   */
  ...
  /**
   * returns the dimension of the geomtries stored. supported are two- and
