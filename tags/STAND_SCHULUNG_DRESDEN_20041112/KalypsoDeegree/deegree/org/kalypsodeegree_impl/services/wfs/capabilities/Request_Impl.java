 ...
 * value shall be the name of one of the operations offered by the OGC Web
 * Service Instance.
 * 
 * <p>
 * -----------------------------------------------------
...
class Request_Impl implements Request
{
   ...
   */
  Request_Impl( GetCapabilities getCapabilities, DescribeFeatureType describeFeatureType,
      Transaction transaction, GetFeature getFeature, GetFeatureWithLock getFeatureWithLock,
 ...
 * empty log message *** Revision 1.1.1.1 2002/09/25 16:01:21 poth no message
 * 
 * Revision 1.8 2002/08/19 15:58:51 ap no message
 * 
 * Revision 1.7 2002/08/15 10:01:40 ap no message
 * 
 * Revision 1.6 2002/08/09 15:36:30 ap no message
 * 
 * Revision 1.5 2002/05/16 15:52:13 ap no message
 * 
