...
public class SunPosition
{
   ...
   * 
   * @param latitue
   *          latitue of the the viewers position
   * @param year
   *          year of the observation (leap year?)
   * @param month
   *          1..12!
   * @param hour
   *          0..23
   ...
   *          0..59
   */
  public static synchronized double calcVerticalSunposition( double latitue, int year, int month,
  ...
  /**
   * calculates the horizontal angle of the sun depending only on hour and
   * minute! the date isn't required.
   * 
   * @param hour
   *          0..23
   * @param minute
