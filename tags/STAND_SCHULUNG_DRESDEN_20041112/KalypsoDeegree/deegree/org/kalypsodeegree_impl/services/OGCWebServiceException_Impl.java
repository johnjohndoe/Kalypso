...
/**
 * <p>
 * A web XXX server has to handle two classes of errors; exceptions that are
 * generated during the processing of a request (such as parsing the request)
 * and exceptions that are generated during the execution of a request (such as
 * a transaction failure). This section deals with exceptions generated during
 ...
 * error has occurred.
 * <p>
 * The &lt;OGCWebServiceException&gt; tag can delimit one or more
 * exception.details. Individual exceptions are delimited using the
 * &lt;Exception&gt; tag.
 * <p>
 ...
 * handle attribute does not exist or is not defined, then the web XXX server
 * can attempt to locate the error using other means such as line numbers,
 * etc...
 * <p>
...
public class OGCWebServiceException_Impl implements OGCWebServiceException, Marshallable
{
  ...
  /**
   * export the exception message and locator as OGC WFS conform XML document.
   */
 ...
 * 
 * Revision 1.8 2003/07/21 07:50:47 poth no message
 * 
 * Revision 1.7 2003/06/10 07:52:11 poth no message
 * 
 * Revision 1.6 2003/05/26 07:17:17 poth no message
 * 
 * Revision 1.5 2003/01/27 12:01:20 poth no message
 * 
 * Revision 1.4 2002/12/12 13:11:15 poth no message
 * 
 * Revision 1.3 2002/11/11 10:42:22 poth no message
 * 
 * Revision 1.2 2002/10/29 10:50:27 poth no message
 * 
 * Revision 1.1.1.1 2002/09/25 16:01:06 poth no message
 * 
 * Revision 1.2 2002/08/15 10:01:06 ap no message
 * 
 * Revision 1.1 2002/05/17 15:58:30 ap no message
 * 
