...
/**
 * DoubleExtent implements the ISO extended time format The syntax for
 * expressing Time constraints and date / time values is specified in WMS 1.1
 * Annexes C
 * 
...
public class DoubleExtent_Impl implements DoubleExtent
{
  ...
  public String toString()
  {
    ...
    {
      sb.append( "PERIODIC, " ).append( _lower ).append( "-->" ).append( _higher ).append( " P " )
          .append( _period );
    }
