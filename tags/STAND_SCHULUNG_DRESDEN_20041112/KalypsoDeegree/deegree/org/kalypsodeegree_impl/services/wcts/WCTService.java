 ...
 * framework. A <tt>WCTService_Impl</tt> extends the <tt>WCTService</tt>
 * interface to act like a OGC web service. This means that a WCTS is callable
  ...
  public void write( Object result )
  {
    ...
    try
    {
      ...
      else if( event.getResponse() instanceof TransformResponse )
      {
        ...
        {
          s = DOMPrinter.nodeToString( ( (TransformResponse_Impl)res ).exportAsXML(), "iso-8859-1" );
        }
      }
