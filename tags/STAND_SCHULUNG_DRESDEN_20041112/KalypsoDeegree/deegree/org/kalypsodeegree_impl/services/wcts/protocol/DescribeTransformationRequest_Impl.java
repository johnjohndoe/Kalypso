...
/**
 * The only request not defined as mandatory supplies the description of the
 * transformation of coordinates from a spatial reference system to another. The
 * structure of the requests essentially corresponds to that of the
 * IsTransformable Requests. The transformation steps, which are necessary, are
 * inquired in order to transform a coordinate from the SourceCRS into the
 * TargetCRS.
 * <p>
 * ----------------------------------------------------------------------
 * </p>
 ...
 * @version 2002-07-10
 */
public class DescribeTransformationRequest_Impl extends OGCWebServiceRequest_Impl implements
    DescribeTransformationRequest
{
  ...
  DescribeTransformationRequest_Impl( String version, String id, HashMap verndorSpecificParameter,
      String format, CS_CoordinateSystem sourceCRS, CS_CoordinateSystem destinationCRS )
  {
