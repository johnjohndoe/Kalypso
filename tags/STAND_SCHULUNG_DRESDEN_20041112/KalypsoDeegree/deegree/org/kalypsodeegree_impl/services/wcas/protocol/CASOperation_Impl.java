 ...
 * @version 2002-04-16
 */
abstract public class CASOperation_Impl implements CASOperation
{
   ...
   * @param handle
   */
  CASOperation_Impl( String handle )
  {
    setHandle( handle );
  }

  /**
   * handle is an useful variable to submit additional informations to the
   * catalog (service).
   */
