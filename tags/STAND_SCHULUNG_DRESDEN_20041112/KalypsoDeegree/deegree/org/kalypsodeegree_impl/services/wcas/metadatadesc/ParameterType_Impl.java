...
/**
 * ParameterType_Impl.java
 * 
 * Created on 16. September 2002, 10:29
 * <p>
 * ----------------------------------------------------------------------
 * </p>
 * 
 ...
 */
public class ParameterType_Impl implements org.deegree.services.wcas.metadatadesc.ParameterType
{

  private String type = null;

  /** Creates a new instance of ParameterType_Impl */
  public ParameterType_Impl( String type )
  {
    setType( type );
  }

  /**
   * returns the type-attribute. Possible values are:
   * <ul>
   * <li>string
   * <li>number
   * </ul>
