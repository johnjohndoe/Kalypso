...
public final class RangeParamList_Impl implements RangeParamList
{
  ...
  /**
   * Builds a ParameterList from the given model request, fetching time,
   * elevation and all other declared ranges.
   * 
  ...
  /**
   * Builds a ParameterList from the given URL request, fetching time, elevation
   * and all other declared ranges.
   * 
