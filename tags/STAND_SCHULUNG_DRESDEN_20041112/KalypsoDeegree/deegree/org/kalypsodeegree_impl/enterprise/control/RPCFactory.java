...
public class RPCFactory
{
  ...
  /**
   * creates an instance of <tt>RPCMethodCall</tt> from the XML document
   * passed
   * 
   * @param doc
  ...
  /**
   * creates an instance of <tt>RPCMethodResponse</tt> from an XML document
   * that can be accessed through the passed <tt>Reader</tt>
   * 
   * @param reader
   *          reader to access an XML document
  ...
  /**
   * creates an instance of <tt>RPCMethodResponse</tt> from the XML document
   * passed
   * 
   * @param doc
   *          XML document containing a RPC method call
