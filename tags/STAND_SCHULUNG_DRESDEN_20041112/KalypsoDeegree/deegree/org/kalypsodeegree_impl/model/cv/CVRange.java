...
/**
 * A CVRange declares a Level valid for a certain dimension range. A CVRange may
 * contain other range axis.
 * 
 * @author ETj
 */
public abstract class CVRange
{
  ...
  //	public static CVange newInstance( String name, String value, Level level,
  // ArrayList subranges )
  //	{
  //		return newInstanceAux(name, value, level, subranges);
  //	}
  //
  //	protected abstract CVRange newInstanceAux( String name, String value, Level
  // level, ArrayList subranges );
