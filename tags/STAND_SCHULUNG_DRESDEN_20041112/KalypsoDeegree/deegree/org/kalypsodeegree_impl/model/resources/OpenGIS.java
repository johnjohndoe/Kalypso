...
public final class OpenGIS
{
      ...
      throws TransformException
  {
    ...
    loop: do
    {
      ...
      // be seen as a number in base 3 where the number of digits is equals to
      // the
      // number of dimensions. For example, a 4-D space would have numbers
      // ranging
      // from "0000" to "2222". The digits are then translated into minimal,
      // central
