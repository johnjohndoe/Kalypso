...
public final class XArray
{
   ...
   * longueur initiale du tableau <code>array</code>, alors le tableau
   * retourné contiendra tous les éléments de <code>array</code> avec en plus
   * des éléments initialisés à 0 à la fin du tableau. Si au contraire la
   * longueur désirée <code>length</code> est plus courte que la longueur
   * initiale du tableau <code>array</code>, alors le tableau sera tronqué
   * (c'est à dire que les éléments en trop de <code>array</code> seront
   * oubliés). Si la longueur de <code>array</code> est égale à
   * <code>length</code>, alors <code>array</code> sera retourné tel quel.
   * 
   * @param array
   *          Tableau à copier.
   ...
   * longueur initiale du tableau <code>array</code>, alors le tableau
   * retourné contiendra tous les éléments de <code>array</code> avec en plus
   * des éléments initialisés à <code>false</code> à la fin du tableau. Si au
   * contraire la longueur désirée <code>length</code> est plus courte que la
   * longueur initiale du tableau <code>array</code>, alors le tableau sera
   * tronqué (c'est à dire que les éléments en trop de <code>array</code>
   * seront oubliés). Si la longueur de <code>array</code> est égale à
   ...
   * @param index
   *          Index dans <code>array</code> du premier élément à retirer. Tous
   *          les éléments de <code>array</code> qui suivent cet index peuvent
   *          être décalés.
   * @param length
   *          Nombre d'éléments à retirer.
   * @return Tableau qui contient la données de <code>array</code> avec des
   *         éléments retirés. Cette méthode peut retourner directement
   *         <code>dst</code>, mais la plupart du temps elle retournera un
   *         tableau nouvellement créé.
   */
  ...
  /**
   * Insère des espaces au milieu d'un tableau. Ces "espaces" seront constitués
   * d'élements nuls.
   * 
   * @param array
   *          Tableau dans lequel insérer des espaces.
   * @param index
   *          Index de <code>array</code> où insérer les espaces. Tous les
   *          éléments de <code>array</code> dont l'index est égal ou
   *          supérieur à <code>index</code> seront décalés.
   * @param length
   *          Nombre d'espaces à insérer.
   * @return Tableau qui contient la données de <code>array</code> avec
   *         l'espace suplémentaire. Cette méthode peut retourner directement
   *         <code>dst</code>, mais la plupart du temps elle retournera un
   *         tableau nouvellement créé.
   */
  private static Object doInsert( final Object array, final int index, final int length )
  {
    ...
    final Object newArray = Array.newInstance( array.getClass().getComponentType(), array_length
        + length );
    System.arraycopy( array, 0, newArray, 0, index );
   ...
   * @param index
   *          Index de <code>array</code> où insérer les espaces. Tous les
   *          éléments de <code>array</code> qui suivent cet index peuvent
   *          être décalés.
   * @param length
   *          Nombre d'espaces à insérer.
   * @return Tableau qui contient la données de <code>array</code> avec
   ...
   * @param src_pos
   *          Index de la première donnée de <code>src</code> à insérer dans
   *          <code>dst</code>.
   * @param dst
   *          Tableau dans lequel insérer des données de <code>src</code>.
   * @param dst_pos
   *          Index de <code>dst</code> où insérer les données de
   *          <code>src</code>. Tous les éléments de <code>dst</code> dont
   *          l'index est égal ou supérieur à <code>dst_pos</code> seront
   *          décalés.
   * @param length
   ...
   *         <code>dst</code>, mais jamais <code>src</code>. La plupart du
   *         temps, elle retournera un tableau nouvellement créé.
   */
