 ...
 */
public class ColorModelApplyAction extends Action
{
  private final Canvas m_windowCanvas;

  private final ApplyElevationWidgetDataModel m_dataModel;

  public ColorModelApplyAction( final Canvas windowCanvas, final ApplyElevationWidgetDataModel dataModel )
  {
