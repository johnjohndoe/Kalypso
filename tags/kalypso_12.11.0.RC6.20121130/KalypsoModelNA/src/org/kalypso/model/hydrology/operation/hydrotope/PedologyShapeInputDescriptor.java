...
public class PedologyShapeInputDescriptor extends AbstractShapeInputDescriptor<GM_MultiSurface> implements InputDescriptor
{
  private final String m_soilTypeColumn;

  public PedologyShapeInputDescriptor( final File shapeFile, final String soilTypeColumn, final String crs, final Charset charset )
  {
