 ...
 */
public class TimestepViewerFilter extends ViewerFilter
{
  private String m_searchText;

  public TimestepViewerFilter( )
  {
    m_searchText = null;
  }
  ...
  public boolean select( final Viewer viewer, final Object parentElement, final Object element )
  {
    ...
    if( element instanceof FactorizedTimeseriesBean )
    {
      ...
      final String timestepText = bean.getTimestepText();
      if( timestepText == null || !timestepText.toLowerCase().contains( m_searchText.toLowerCase() ) )
        return false;
