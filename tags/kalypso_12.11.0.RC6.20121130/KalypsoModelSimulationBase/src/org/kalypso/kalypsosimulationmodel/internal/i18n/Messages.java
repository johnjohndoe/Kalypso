 ...
 * 
 *  ---------------------------------------------------------------------------*/
package org.kalypso.kalypsosimulationmodel.internal.i18n;
...
{
  private static final String BUNDLE_NAME = "org.kalypso.kalypsosimulationmodel.internal.i18n.messages"; //$NON-NLS-1$
