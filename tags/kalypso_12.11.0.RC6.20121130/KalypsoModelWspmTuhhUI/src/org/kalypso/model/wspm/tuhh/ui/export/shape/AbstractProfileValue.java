...
{
  public AbstractProfileValue( final String label, final IDBFField field )
  {
    super( label, field );
  }
  ...
  {
    return getProfileValue( (IProfileFeature) element );
  }

  protected abstract Object getProfileValue( IProfileFeature profile ) throws ShapeDataException;
}
