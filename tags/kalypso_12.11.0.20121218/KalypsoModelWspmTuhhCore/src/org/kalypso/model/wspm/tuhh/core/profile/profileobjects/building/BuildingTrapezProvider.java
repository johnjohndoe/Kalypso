...
{
  @Override
  public BuildingTrapez createProfileObject( final IProfile profile )
  {
  ...
  public IProfileObject buildProfileObject( final IProfile profile, final Feature profileObjectFeature )
  {
    ...
    final BuildingTrapez profileObject = createProfileObject( profile );
  ...
  private void fillMetadata( final IObservation<TupleResult> profileObjectObservation, final BuildingTrapez profileObject )
  {
    ...
    final IComponent steigungComponent = ProfileUtil.getFeatureComponent( BuildingsCompatibilityConstants.BUILDING_PROPERTY_STEIGUNG );
