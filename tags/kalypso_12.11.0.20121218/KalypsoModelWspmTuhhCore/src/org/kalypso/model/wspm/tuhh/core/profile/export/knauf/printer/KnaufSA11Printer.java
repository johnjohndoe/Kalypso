 ...
 * @author Dirk Kuch
 */
public class KnaufSA11Printer extends AbstractKnaufPrinter
{

  public KnaufSA11Printer( final KnaufSA11Bean bean )
  {
    super( bean );
  }

  @Override
  protected KnaufSA11Bean getBean( )
  {
    return (KnaufSA11Bean) super.getBean();
  }
