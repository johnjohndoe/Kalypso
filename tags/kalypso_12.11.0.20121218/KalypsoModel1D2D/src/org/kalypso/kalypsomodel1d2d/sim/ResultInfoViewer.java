...
//  private final Font fTextNormal = new Font( Display.getDefault(), "Tahoma", 8, SWT.NONE ); //$NON-NLS-1$
  ...
  private final DateFormat m_timestepFormat;

  public ResultInfoViewer( final Composite parent, final int style, final DateFormat timestepFormat )
  {
    m_timestepFormat = timestepFormat;
...
//    m_textPanel.setFont( "text", fTextNormal ); //$NON-NLS-1$
  ...
  private String getInformationText( final Date resultDate )
  {
    if( resultDate == null )
    ...
    buf.append( Messages.getString( "org.kalypso.kalypsomodel1d2d.sim.ResultInfoViewer.0" ) ); //$NON-NLS-1$
    buf.append( m_timestepFormat.format( resultDate ) );
