...
/** 
*
* Defining the surface geometry of the iso geometry model. a surface
* is made of 1..n surface patches. for convention it is defined that 
* GM_Surface is a closed geometry. that means each surface patch a surface
* is made of must touch at least one other surface patch if a surface
* is made of more then one surface patch
*
* <p>-----------------------------------------------------</p>
*
* @author Andreas Poth 
