 ...
 * description. The reference is an xlink allowing both human readable
 * labels and definitive identifiers. A gazetteer response may optionally
 * include a block for such definitions
 *
 * @version $Revision$
 * @author $author$
 */
public interface SI_LocationType {
	...
	/**
	 * name of parent location type (a location type of which this location type is a subdivision)
	 */
