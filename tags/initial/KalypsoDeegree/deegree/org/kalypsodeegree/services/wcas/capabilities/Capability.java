...
/**
 * The capabilities section specifies the list of requests that the WCAS
...
public interface Capability {
    ...
    /**
     * A basic catalog would include the GetCapabilities, DescribeRecordType
     * and the GetRecord interfaces. A transactional catalog would also include
     * the Transaction interface, possibly the LockRecord interface and/or
     * the GetRecordWithLock interface.
 ...
 * no message
 *
 * Revision 1.1  2001/10/25 13:14:21  ap
 * no message
 *
 * Revision 1.1  2001/10/16 07:01:30  ap
 * no message
 *
 * Revision 1.1  2001/10/05 05:59:45  ap
 * no message
 *
 * Revision 1.3  2001/09/06 15:08:34  ap
 * no message
 *
 * Revision 1.2  2001/08/15 10:43:58  axel
 * as: see Open GIS Web Feature Server Specification (01-023r1)
 *     Version 0.0.13 (10-MAR-2001), p. 50ff for more details
 *
 */
