...
public class SI_LocationInstance_Impl extends Feature_Impl implements SI_LocationInstance {
    ...
    SI_LocationInstance_Impl( String geographicIdentifier, String alternativeGeographicIdentifier, 
                              String identifier, Date begin, Date end, GM_Point[] position, 
                              GM_Object[] geographicExtent, CitedResponsibleParty administrator, 
                              SI_LocationInstance[] parents, SI_LocationInstance[] child, 
        ...
        if ( identifier == null ) identifier = geographicIdentifier;
    ...
    public void setAlternativeGeographicIdentifier( String name ) {
        FeatureProperty prop = 
            FeatureFactory.createFeatureProperty( "alternativeGeographicIdentifier", name );
        setProperty( prop );
    }
    ...
    public void setIdentifier(String identifier) {
        FeatureProperty prop = 
            FeatureFactory.createFeatureProperty( "identifier", identifier );
        setProperty( prop );
    }
    ...
    public void addChildren( SI_LocationInstance child ) {
        ...
        FeatureProperty prop = 
            FeatureFactory.createFeatureProperty( "children", nagi );
        setProperty( prop );
    }
    ...
    public void setChildren( SI_LocationInstance[] children ) {
        FeatureProperty prop = 
            FeatureFactory.createFeatureProperty( "children", children );
        setProperty( prop );
    }
    ...
    public void setEnd( Date end ) {
        FeatureProperty prop = 
            FeatureFactory.createFeatureProperty( "end", end );
        setProperty( prop );
    }
    ...
    public void setAdministrator( CitedResponsibleParty administrator ) {
        FeatureProperty prop = 
            FeatureFactory.createFeatureProperty( "administrator", administrator );
        setProperty( prop );
    }
    ...
    public void addGeographicExtent( GM_Object geographicExtent ) {
        ...
        FeatureProperty prop = 
            FeatureFactory.createFeatureProperty( "geographicExtent", nagi );
        setProperty( prop );
    }
    ...
    public void setGeographicExtent( GM_Object[] geographicExtent ) {
        FeatureProperty prop = 
            FeatureFactory.createFeatureProperty( "geographicExtent", geographicExtent );
        setProperty( prop );
    }
    ...
    public void setGeographicIdentifier( String geographicIdentifier ) {
        FeatureProperty prop = 
            FeatureFactory.createFeatureProperty( "geographicIdentifier", geographicIdentifier );
        setProperty( prop );
    }
    ...
    public void setLocationType( SI_LocationType type ) {
        FeatureProperty prop = 
            FeatureFactory.createFeatureProperty( "locationType", type );
        setProperty( prop );
    }
    ...
    public void addParents( SI_LocationInstance parent ) {
        ...
        FeatureProperty prop = 
            FeatureFactory.createFeatureProperty( "parents", nagi );
        setProperty( prop );
    }
    ...
    public void setParents( SI_LocationInstance[] parents ) {
        FeatureProperty prop = 
            FeatureFactory.createFeatureProperty( "parents", parents );
        setProperty( prop );
    }
    ...
    public void addPosition( GM_Point position ) {
        ...
        FeatureProperty prop = 
            FeatureFactory.createFeatureProperty( "position", nagi );
        setProperty( prop );        
    }
    ...
    public void setPosition( GM_Point[] position ) {
        FeatureProperty prop = 
            FeatureFactory.createFeatureProperty( "position", position );
        setProperty( prop );        
    }
    ...
    public void setSourceFeature(URL sourceFeature) {
        FeatureProperty prop = 
            FeatureFactory.createFeatureProperty( "sourceFeature", sourceFeature );
        setProperty( prop );
    }
    
    private static FeatureType initLIFeatureType() {
        FeatureTypeProperty[] ftp = new FeatureTypeProperty[12]; 
        ftp[0] = FeatureFactory.createFeatureTypeProperty( "geographicIdentifier", 
        ...
        ftp[11] = FeatureFactory.createFeatureTypeProperty( "sourceFeature", 
                                                            "java.net.URL", true );
    ...
    private static FeatureProperty[] initLIFeatureProperties() throws Exception {
        ...
        fp[5] = FeatureFactory.createFeatureProperty( "position", GeometryFactory.createGM_Point( -9E99, -9E99, null ) );
        GM_Envelope env = GeometryFactory.createGM_Envelope( -9E9, -9E9, 9E9, 9E9 );
        fp[6] = FeatureFactory.createFeatureProperty( "position", GeometryFactory.createGM_Surface( env, null ) );
...
/* ********************************************************************
   ...
   Revision 1.8  2004/03/26 16:42:18  poth
   no message

   Revision 1.7  2004/03/24 08:12:20  poth
   no message

   Revision 1.6  2004/03/15 16:55:29  poth
   no message

   Revision 1.5  2004/03/15 07:34:39  poth
   no message
