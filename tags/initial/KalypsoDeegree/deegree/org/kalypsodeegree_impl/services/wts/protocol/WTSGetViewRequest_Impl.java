...
/**
 * This class implements the access to the parameters of a GetView request.<p></p>
...
final class WTSGetViewRequest_Impl extends OGCWebServiceRequest_Impl implements WTSGetViewRequest {
    ...
    WTSGetViewRequest_Impl(String version, String id, HashMap vendorSpecificParameter, 
                           String format, Layer[] layers, String crs, int width, int height, 
                           Color bgColor, double aov, double distance, double pitch, 
                           GM_Position poi, double yaw, String exceptions, Calendar date, 
