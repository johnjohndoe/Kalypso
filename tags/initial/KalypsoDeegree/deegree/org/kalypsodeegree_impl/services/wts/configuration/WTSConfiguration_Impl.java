...
import org.deegree.services.wts.configuration.*;
...
public class WTSConfiguration_Impl implements WTSConfiguration {
    ...
    protected WTSConfiguration_Impl(HashMap sourceTypes, HashMap formatNames, 
                                    HashMap featureTextures, HashMap responsibleServices,
                                    HashMap backgrounds) {
    ...
    /** returns the source for submitted DEM. Using the method <tt>getSourceType>/tt>
    ...
    /** returns the source for submitted texture. Using the method <tt>getSourceType>/tt>
     * it can be determined if the source is a:
     * <ul>
     *  <li>LOCALWCS</li>
     *  <li>LOCALWMS</li>
     ...
     * @param featureId id of the feature (will be converted into uppercase)
     * @return
     */
