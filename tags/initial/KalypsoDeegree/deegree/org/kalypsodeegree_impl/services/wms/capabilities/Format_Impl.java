 ...
 * requests. Each request describes its own list of possible formats.
 *
 * @version $Revision$
...
class Format_Impl implements Format {
     ...
     * Creates a new Format_Impl object.
     * @param name name of the format
     * @param url <tt>URL</tt> from where the filter for transforming a 
     ...
     * GetFeatureInfo request can be accessed. For any other formats then those
     * of a GetFeatureInfo response the method returns null.
     *
     * @return
     *
     */
