...
import org.deegree.services.wcs.protocol.*;
 ...
 * filterServiceClassName element identifies the filter servive that's responsible 
...
public class DataSource_Impl implements DataSource, Marshallable {
     ...
     * Creates a new DataSource_Impl object.
     *
     * @param name name of the featuretype to access
     * @param type type of the data source (LOCALWFS, REMOTEWFS)
     * @param ows <tt>OGCWebService</tt> instance for accessing the data source
     * @param scaleHint 
    ...
    /**
     * Creates a new DataSource_Impl object. Because only a REMOTEWMS can handle
     * a <tt>WMSGetMapRequest</tt> no type must be submitted.
     *
     * @param name name of the featuretype to access     
     * @param ows <tt>OGCWebService</tt> instance for accessing the data source
     * @param scaleHint 
     * @param getMap filter condition 
     */
    DataSource_Impl( String name, String geometryProperty, OGCWebService ows,
                     URL capabilitiesURL, ScaleHint scaleHint, 
                     WMSGetMapRequest getMap ) {
        this(name, DataSource.REMOTEWMS, geometryProperty, ows,
             capabilitiesURL, scaleHint );
        this.getMap = getMap;
    }
     ...
     *
     * @param name name of the featuretype to access
     * @param type type of the data source (REMOTEWCS, LOCALWCS)
     * @param ows <tt>OGCWebService</tt> instance for accessing the data source
     * @param scaleHint 
     * @param getCoverage filter condition 
     */
    DataSource_Impl( String name, int type, String geometryProperty, OGCWebService ows, 
    ...
    public String exportAsXML() {
        ...
        sb.append( "<DataSource>" ).append( "<Name>" ).append( XMLTools.validateCDATA( name ) )
          .append( "</Name>" ).append( "<GeometryProperty>" )
          .append( XMLTools.validateCDATA( geometryProperty ) ).append( "</GeometryProperty>" )
          .append( "<Type>" );
        ...
        sb.append ("<OWSCapabilities>")
          .append ("<OnlineResource ")
          .append ("xmlns:xlink=\"http://www.w3.org/1999/xlink\" ")
          .append ("xlink:type=\"simple\" xlink:href=\"")
          .append (NetWorker.url2String (capabilitiesURL))
          .append ("\"/>")
          .append ("</OWSCapabilities>");
