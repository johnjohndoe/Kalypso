...
/**
 * This class handles the Transform-request and creates the response
 * which contains the transformed data.
 * If this failed, an exception is included in the response.
 *
 * <p>--------------------------------------------------------------------</p>
    ...
    public void handleRequest( OGCWebServiceEvent request ) {
        ...
        if ( !req.getVersion().equals( "1.0.0" ) ) {
            ...
            try {
                ...
                CS_CoordinateSystem t_srs_cs = ( (TransformRequest)request.getRequest() ).getDestinationCRS();
