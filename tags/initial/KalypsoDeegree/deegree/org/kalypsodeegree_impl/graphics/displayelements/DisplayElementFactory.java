...
public class DisplayElementFactory {
     ...
     * @param symbolizer contains the drawing (style) information and selects
     *        the geometry property of the <tt>Feature</tt> to be drawn
     * @throws IncompatibleGeometryTypeException if the selected geometry of
     *         the <tt>Feature</tt> is not compatible with the
     *         <tt>Symbolizer</tt>
    ...
    public static DisplayElement buildDisplayElement( Object o, Symbolizer symbolizer )
        ...
        if ( o instanceof Feature ) {
            ...
            if ( symbolizer instanceof PointSymbolizer ) {
                ...
                displayElement = buildLabelDisplayElement( feature, geoProperty, 
    ...
    public static DisplayElement buildDisplayElement( Object o )
		...
		System.out.println("no displayelement, cause geoProperty of feature is null");
            ...
            else if ( geoProperty instanceof GM_Surface || 
                          geoProperty instanceof GM_MultiSurface ) {
    ...
    /**
     * Creates a <tt>PointDisplayElement</tt> using the given geometry and
     * style information.
     * <p>
    ...
    public static PointDisplayElement buildPointDisplayElement( Feature feature, GM_Object geom, 
        ...
        if ( geom instanceof GM_Point ) {
            ...
            try {
                displayElement = new PointDisplayElement_Impl( feature, 
                                                               GeometryFactory.createGM_MultiPoint( 
                                                               centroids ), sym );
            } catch ( GM_Exception e ) {
                System.out.println( 
                        "GM_Exception caught in DisplayElementFactory.buildPointDisplayElement: " + e );
                e.printStackTrace();
            }
        } else {
    ...
    public static PolygonDisplayElement buildPolygonDisplayElement( Feature feature, 
        ...
        if ( gmObject instanceof GM_Surface ) {
            ...
            displayElement = new PolygonDisplayElement_Impl( feature, (GM_MultiSurface)gmObject, 
                                                             sym );
        } else {
            throw new IncompatibleGeometryTypeException( 
                    "Tried to create a LineStringDisplayElement from a geometry with " + 
    ...
    /**
     * Creates a <tt>LabelDisplayElement</tt> using the given geometry and
     * style information.
     * <p>
     * 
     ...
     * @param sym style information
     * @throws IncompatibleGeometryTypeException if the geometry property is not
     *         a <tt>GM_Point</tt>, a <tt>GM_Surface</tt> or
    ...
    public static LabelDisplayElement buildLabelDisplayElement( Feature feature, GM_Object gmObject, 
        ...
        if ( gmObject instanceof GM_Point || 
             gmObject instanceof GM_Surface ||
             gmObject instanceof GM_MultiSurface ||
			 gmObject instanceof GM_Curve ||
