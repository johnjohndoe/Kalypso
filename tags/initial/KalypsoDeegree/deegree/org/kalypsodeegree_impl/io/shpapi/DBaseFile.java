 ...
 *  memo                "M"             String
 *  date                "D"             Date
 *  binary              "B"             ByteArrayOutputStream
 *
 *
 * <!---------------------------------------------------------------------------->
 * @version 12.12.2000
...
public class DBaseFile {
    ...
    /**
     * method: initDBaseFile();
     * inits a DBF file. This is based on Pratap Pereira's
...
//System.out.println(col_name + " len: " + flen + " dec: " + fdec);
	...
	ftp[ftp.length - 1] = FeatureFactory.createFeatureTypeProperty( "GEOM",
								     getGeometryType(),
								     true );
    ...
    /**
     * returns a row of the dBase-file as Feature containing a place holder
     * (field name = "GEOM") for a geometry.
     */
            ...
            if ( value != null ) {
                ...
                if ( column.type.equalsIgnoreCase( "C" ) ) {
                    ...
                    if (value.equals(""))
                      ...
                      fp[i] = TimeTools.createCalendar( value.substring(0,4) + "-" + 
                                                        value.substring(4,6) + "-" + 
    ...
    /**
     * method: public void writeAllToFile()
     * creates the dbase file and writes all data to it
     * if the file specified by fname (s.o.) exists it
     * will be deleted!
     */
