...
abstract class AbstractMapListener extends AbstractListener {
    ...
    /**
     * The default listeners (s.o.) are calling this method
     * within the actionPerformed method. A user can extend a
     * predefined listener and the override this method to modify
     * the LegendModel. If the method will be overwritten at first
     * <tt>super.modifyLegendModel(..)</tt> shall be called.
     */

    //    protected LegendModel modifyLegendModel( LegendModel lm, MapRequestModel mrm ) {
    //        return lm;
    //    }
