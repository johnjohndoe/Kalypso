...
public class ConfigurationFactory {
    ...
    */
    public static CSWClientConfiguration createConfiguration( Reader reader ) throws SAXException, 
        ...
        CSWClientConfiguration conf = new CSWClientConfiguration( ccatalog, mapping, maxInactiveInterval, wmsCConfig, 
                                                thes, download, textComponent, maxRecords, 
                                                filterIDs );
    ...
    */
    ...
    private static WMSClientConfiguration createWMSClientConfiguration( Element elem )
        ...
        org.deegree_impl.clients.wmsclient.control.MapApplicationHandler.setDefaultClientConfiguration( 
                conf );
    ...
    /**
     * creates an object that encapsulates the required informations for downloading
    ...
    private static Download createDownload( Element elem ) throws Exception {
        ...
        Download download = new Download( cleanerInterval, lifeTime, storageDirectory, 
                                          onlineResource, mailFrom, mailSubject, mailHost );
...
/* ********************************************************************
   ...
   Revision 1.7  2004/03/15 07:34:37  poth
   no message
