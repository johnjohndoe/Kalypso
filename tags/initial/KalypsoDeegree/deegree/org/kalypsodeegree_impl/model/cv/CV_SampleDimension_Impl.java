...
{    
    ...
    public CV_SampleDimension_Impl(String[] categoryNames, 
                                   String description, 
                                   double minimumValue, 
                                   double maximumValue,
                                   ...
                                   CV_SampleDimensionType sampleDimensionType)
    {
        ...
        if ( colorInterpretation == null ) {
            this.colorInterpretation = 
                new CV_ColorInterpretation( CV_ColorInterpretation.CV_Undefined );
        } else {
            this.colorInterpretation = colorInterpretation;
        }
        if ( paletteInterpretation == null ) {
            this.paletteInterpretation = 
                new CV_PaletteInterpretation( CV_PaletteInterpretation.CV_Gray );
        } else {
