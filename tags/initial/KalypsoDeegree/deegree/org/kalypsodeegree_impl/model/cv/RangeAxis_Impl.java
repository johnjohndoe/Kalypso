...
class RangeAxis_Impl extends Observable_Impl implements RangeAxis {
    ...
    private RangeExtent rangeExtent = null;
    
    RangeAxis_Impl(String name, String description, URL docURL, 
                   Object referenceSystem, RangeExtent rangeExtent)
    {
        super( name, description, docURL, referenceSystem );
