...
public class ConvenienceCSFactory {
	...
	private static ParameterListDescriptor pld = 
        getDescriptor(new Object[] { "semi_major", Double.class, ParameterListDescriptor.NO_PARAMETER_DEFAULT, null, 
                                     "semi_minor", Double.class, ParameterListDescriptor.NO_PARAMETER_DEFAULT, null, 
                                     "central_meridian", Double.class, new Double(0), null, 
                                     "latitude_of_origin", Double.class, new Double(0), null, 
                                     "false_easting", Double.class, new Double(0), null, 
                                     "false_northing", Double.class, new Double(0), null, 
                                     "scale_factor", Double.class, new Double(1), null, 
                                     "longitudeOfFalseOrigin", Double.class, new Double(0), null, 
                                     "latitudeofFalseOrigin", Double.class, new Double(90), null, 
                                     "standard_parallel1", Double.class, new Double(30), null, 
                                     "standard_parallel2", Double.class, new Double(40), null ,
                                     "hemisphere", Integer.class, new Integer(1), null });
...
//        } else 
        if ( name.equalsIgnoreCase( "EPSG:20790" ) ) {
            ...
            addEPSG25884();
        } else if ( name.equalsIgnoreCase( "EPSG:25828" ) || 
                        name.equalsIgnoreCase( "EPSG:25829" ) || 
            ...
            addEPSG28462();
                        ...
                        name.equalsIgnoreCase( "EPSG:28463" ) || 
            ...
            addEPSG31286();
        } else if ( name.equalsIgnoreCase( "EPSG:31466" ) || 
                        name.equalsIgnoreCase( "EPSG:31467" ) || 
                        name.equalsIgnoreCase( "EPSG:31468" ) || 
                        name.equalsIgnoreCase( "EPSG:31469" ) ) {
            String s = name.substring( 9 );
            int code = Integer.parseInt( s );
            addEPSG3146X( code );
        } else if ( name.equalsIgnoreCase( "EPSG:31491" ) || 
                        name.equalsIgnoreCase( "EPSG:31492" ) || 
            ...
            int code = Integer.parseInt( s );
            addEPSG3149X( code );
        } else if ( name.equalsIgnoreCase( "EPSG:32201" ) || 
                        name.equalsIgnoreCase( "EPSG:32202" ) || 
            ...
            int code = Integer.parseInt( s );
            addEPSG322XX( code );
        } else if ( name.equalsIgnoreCase( "EPSG:32401" ) || 
                        name.equalsIgnoreCase( "EPSG:32402" ) || 
            ...
            int code = Integer.parseInt( s );
            addEPSG324XX( code );
        } else if ( name.equalsIgnoreCase( "EPSG:32601" ) || 
                        name.equalsIgnoreCase( "EPSG:32602" ) || 
    ...
    private void addEPSG4817() {
        Ellipsoid ellipsoid = csFactory.createFlattenedSphere( "NGO 1948 (Oslo)", 6377492.018, 299.1528128, 
                                                               Unit.METRE );
    ...
    private void addEPSG4274() {
        Ellipsoid ellipsoid = Ellipsoid.createFlattenedSphere( "Datum 73", 6378388, 
                                                               297, Unit.METRE );
        ...
        HorizontalDatum horDatum = new HorizontalDatum( "Datum 73", DatumType.CLASSIC, 
                                                        ellipsoid, convInfo );
    ...
    private void addEPSG4313() {
        Ellipsoid ellipsoid = 
            Ellipsoid.createFlattenedSphere( "International 1924", 6378388.0, 297.0, Unit.METRE );
    ...
    private void addEPSG21781() {
        ...
        ProjectedCoordinateSystem cs = csFactory.createProjectedCoordinateSystem( "EPSG:21781", 
                                                                                  geoCS, projection, 
                                                                                  Unit.METRE, 
                                                                                  AxisInfo.X, 
                                                                                  AxisInfo.Y );
    ...
    private void addEPSG258XX( int code ) {
        ...
        ProjectedCoordinateSystem cs = csFactory.createProjectedCoordinateSystem( "EPSG:258" + 
                                                                                  code, geoCS, 
                                                                                  projection, 
                                                                                  Unit.METRE, 
                                                                                  AxisInfo.X, 
