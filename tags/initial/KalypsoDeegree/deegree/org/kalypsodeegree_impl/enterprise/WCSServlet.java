...
public class WCSServlet extends AbstractOGCServlet {
    ...
    /**
     * initializes a descriptor object for each coverage layer defined at the
     * WCS capabilities
     */
    private void initDescriptors() throws IOException, SAXException, 
                                          InvalidAxisDefinitionException, Exception {
        Debug.debugMethodBegin();
    ...
    private HashMap toModel( HttpServletRequest request ) {
        ...
        while ( enum.hasMoreElements() ) {
            ...
            if ( name.equals( "RANGE" ) ) {
                ...
                //TODO
            } else if ( name.equals( "WIDTH" ) || name.equals( "HEIGHT" ) || 
                            name.equals( "DEPTH" ) ) {
    ...
    private class WCS implements OGCWebServiceClient {
        ...
        public void perform() {
            ...
            try {
                ...
                if ( ( version == null ) || ( version.compareTo( "0.7.0" ) < 0 ) || 
                    ...
                    OGCWebServiceException oe = new OGCWebServiceException_Impl( "WCS", 
                                                                                 "not supported service version " + 
                                                                                 "must be between 0.7.0 and 1.0.0" );
                    response.setContentType( "application/vnd.ogc.se_xml" );
                ...
                try {
                    OGCWebServiceException oe = 
                        new OGCWebServiceException_Impl( "WCS", e.toString() );
                    response.setContentType( "application/vnd.ogc.se_xml" );
        ...
        /**
         * recieves the response from the WCService and sends it to the 
         * requesting client. 
         */
